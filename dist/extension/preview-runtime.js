...
`)} { display: none !important; }`:""}function ni(){let e=Array.from(F()),t=JSON.stringify(e);try{typeof GM_setValue=="function"?GM_setValue(j,t):localStorage.setItem(j,t)}catch{try{localStorage.setItem(j,t)}catch{}}Ce()}function ri(){let e=!1;try{if(typeof GM_getValue=="function")return e=GM_getValue(re,!1),e===!0||e===1||e==="true"}catch{}try{e=localStorage.getItem(re)}catch{}return e===!0||e===1||e==="true"}function Gi(e){try{if(typeof GM_setValue=="function"){GM_setValue(re,e);return}}catch{}try{localStorage.setItem(re,String(e))}catch{}}function oi(e){return W().some(t=>t.url===e)}function rt(){let e=null;try{typeof GM_getValue=="function"&&(e=GM_getValue(ie,null))}catch{}if(e===null)try{e=localStorage.getItem(ie)}catch{}try{let t=typeof e=="string"?JSON.parse(e):e;if(t&&Number.isFinite(t.left)&&Number.isFinite(t.top))return t}catch{}return null}function me(e){let t=JSON.stringify(e);try{if(typeof GM_setValue=="function"){GM_setValue(ie,t);return}}catch{}try{localStorage.setItem(ie,t)}catch{}}function ai(){let e=!1;try{if(typeof GM_getValue=="function")return e=GM_getValue(ne,!1),e===!0||e===1||e==="true"}catch{}try{e=localStorage.getItem(ne)}catch{}return e===!0||e===1||e==="true"}function si(e){try{if(typeof GM_setValue=="function"){GM_setValue(ne,e);return}}catch{}try{localStorage.setItem(ne,String(e))}catch{}}function li(e){let t=new Date(e),i=n=>n<10?"0"+n:""+n;return`${t.getFullYear()}-${i(t.getMonth()+1)}-${i(t.getDate())} ${i(t.getHours())}:${i(t.getMinutes())}`}function ge(){de=!0,O&&clearTimeout(O),O=setTimeout(()=>{de=!1,O=null},500)}function ci(e){if(!e)return null;let t=String(e.dataset.topicId||"").trim(),i=e.querySelector("a.raw-topic-link[href]"),n=i&&i.closest(".link-top-line");if(!t||!i||!n)return null;let r="";try{let o=new URL(i.getAttribute("href"),location.origin);r=`${o.origin}${o.pathname}`}catch{return null}return{topicId:t,url:r,title:(i.textContent||"").trim()||r,titleLine:n}}function di(){if(!N||!/(^|\.)linux\.do$/i.test(location.hostname))return;let e=new Set(W().map(t=>t.url));document.querySelectorAll(".agy-linux-topic-actions").forEach(t=>{let i=t.querySelector(".agy-linux-topic-up");if(!i)return;let n=e.has(t.dataset.topicUrl||"");i.classList.toggle("agy-is-bookmarked",n),i.setAttribute("aria-pressed",String(n)),i.title=n?"\u53D6\u6D88\u6536\u85CF\u6B64\u5E16\u5B50":"\u6536\u85CF\u6B64\u5E16\u5B50",i.setAttribute("aria-label",i.title)})}function ui(e,t,i){let n=ci(e);if(!n)return;let r=i.has(n.topicId);if(e.classList.toggle("agy-linux-topic-hidden",r),r)return;let o=e.querySelector(".agy-linux-topic-actions");if(o&&o.dataset.agyTopicId!==n.topicId&&(o.remove(),o=null),!o){o=document.createElement("span"),o.className="agy-linux-topic-actions";let s=document.createElement("button");s.type="button",s.className="agy-linux-topic-action agy-linux-topic-up",s.dataset.action="bookmark",s.innerHTML=Jt;let d=document.createElement("button");d.type="button",d.className="agy-linux-topic-action agy-linux-topic-down",d.dataset.action="hide",d.title="\u9690\u85CF\u6B64\u5E16\u5B50\uFF0C\u5237\u65B0\u540E\u4ECD\u4E0D\u663E\u793A",d.setAttribute("aria-label",d.title),d.innerHTML=Qt,o.appendChild(s),o.appendChild(d),n.titleLine.prepend(o)}o.dataset.agyTopicId!==n.topicId&&(o.dataset.agyTopicId=n.topicId),o.dataset.topicUrl!==n.url&&(o.dataset.topicUrl=n.url),o.dataset.topicTitle!==n.title&&(o.dataset.topicTitle=n.title);let a=o.querySelector(".agy-linux-topic-up"),c=t.has(n.url);a.classList.toggle("agy-is-bookmarked",c),a.setAttribute("aria-pressed",String(c)),a.title=c?"\u53D6\u6D88\u6536\u85CF\u6B64\u5E16\u5B50":"\u6536\u85CF\u6B64\u5E16\u5B50",a.setAttribute("aria-label",a.title)}function Le(e){if(!e||e.nodeType!==1)return;e.matches(".topic-list-item[data-topic-id]")&&P.add(e);let t=e.closest(".topic-list-item[data-topic-id]");t&&P.add(t),e.querySelectorAll(".topic-list-item[data-topic-id]").forEach(i=>{P.add(i)})}function ot(){if(Ee=!1,!P.size)return;let e=new Set(W().map(n=>n.url)),t=F(),i=Array.from(P);P.clear(),i.forEach(n=>{n.isConnected&&ui(n,e,t)})}function Se(e){Le(e),P.size&&(Ee||(Ee=!0,typeof queueMicrotask=="function"?queueMicrotask(ot):Promise.resolve().then(ot)))}function Ui(){if(et)return;et=!0,F(),Ce(),document.addEventListener("pointerdown",function(r){!r.target.closest||!r.target.closest(".agy-linux-topic-action")||(r.preventDefault(),r.stopImmediatePropagation())},!0),document.addEventListener("click",function(r){let o=r.target.closest&&r.target.closest(".agy-linux-topic-action");if(!o)return;let a=o.closest(".topic-list-item[data-topic-id]"),c=o.closest(".agy-linux-topic-actions");if(!a||!c)return;r.preventDefault(),r.stopImmediatePropagation();let s=String(c.dataset.agyTopicId||""),d=c.dataset.topicUrl||"",g=c.dataset.topicTitle||d;if(o.dataset.action==="bookmark"){st(d,g);return}o.dataset.action==="hide"&&s&&(F().add(s),ni(),a.classList.add("agy-linux-topic-hidden"))},!0);function e(r){r.forEach(o=>{if(o.type==="attributes"){Le(o.target);return}let a=o.target.closest&&o.target.closest(".topic-list-item[data-topic-id]");a&&P.add(a),o.addedNodes.forEach(Le)}),i(),P.size&&Se()}function t(r){let o=F();r.forEach(a=>{let c=a.target.matches&&a.target.matches(".topic-list-item[data-topic-id]")?a.target:null;if(!c)return;let s=String(c.dataset.topicId||"").trim(),d=o.has(s),g=c.classList.contains("agy-linux-topic-hidden"),h=!d&&!c.querySelector(".agy-linux-topic-actions");(d!==g||h)&&P.add(c)}),P.size&&Se()}function i(){let r=document.querySelector(".topic-list");!r||r===Qe||(fe?fe.disconnect():fe=new MutationObserver(t),Qe=r,fe.observe(r,{subtree:!0,attributes:!0,attributeFilter:["class"]}))}function n(){!document.documentElement||ke||(ke=new MutationObserver(e),ke.observe(document.documentElement,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["data-topic-id","href"]}),Ce(),i(),Se(document.documentElement))}document.documentElement?n():document.addEventListener("readystatechange",n,{once:!0})}if(N){let e=document.createElement("style");e.textContent=`
        ...
        `;let t=document.head||document.documentElement;t?t.appendChild(e):document.addEventListener("readystatechange",function i(){let n=document.head||document.documentElement;n&&(document.removeEventListener("readystatechange",i),n.appendChild(e))})}N&&(window.addEventListener("pointerdown",function(e){if(e.target.closest&&e.target.closest(".agy-linux-topic-action"))return;let t=e.target.closest&&e.target.closest(".agy-close-btn");if(t&&l&&l.contains(t)){e.preventDefault(),e.stopImmediatePropagation(),V(),ge();return}let i=e.target.closest&&e.target.closest(".agy-preview-tab-close");if(i&&l&&l.contains(i)){e.preventDefault(),e.stopImmediatePropagation();let r=i.closest(".agy-preview-tab"),o=r&&Number(r.dataset.tabId);Number.isFinite(o)&&Mt(o),ge();return}let n=e.target.closest&&e.target.closest(".agy-preview-tab");if(e.button===0&&n&&l&&l.contains(n)){let r=Number(n.dataset.tabId);Number.isFinite(r)&&St(r)}if(E){(e.target===E||e.target.closest&&e.target.closest(".agy-viewer-close"))&&(Me(),ge());return}if(!(v&&v.contains(e.target))&&l&&!l.contains(e.target)){let r=e.target.closest&&e.target.closest("a");if(X(r))return;V(),ge()}},!0),window.addEventListener("pointerdown",function(e){if(!_()||e.detail!==2||e.button!==0||e.ctrlKey||e.shiftKey||e.altKey||e.metaKey||(I&&(clearTimeout(I),I=null),ce)||E)return;let t=e.target.closest&&e.target.closest("a");X(t)&&(ue=!0,dt(t))},!0),document.addEventListener("click",function(e){de&&(de=!1,O&&(clearTimeout(O),O=null),e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener("resize",function(){if(!l)return;if(C){qe(),L();return}let e=l.getBoundingClientRect(),t=q(e.left,e.top,l);$(l,t),me(t),L()}),window.addEventListener("message",function(e){let t=e.data;if(!t||!Number.isFinite(t.agyPreviewToken))return;let i=f.find(n=>n.iframe&&e.source===n.iframe.contentWindow&&n.loadToken===t.agyPreviewToken);i&&(typeof t.agyPreviewTitle=="string"&&t.agyPreviewTitle.trim()&&Tt(i,t.agyPreviewTitle),t.agyPreviewContentReady===!0&&De(i,i.loadToken,i.url),(t.agyPreviewHistoryDirection===-1||t.agyPreviewHistoryDirection===1)&&i.id===y&&It(i,t.agyPreviewHistoryDirection),t.agyPreviewRefresh===!0&&i.id===y&&Be(i),typeof t.agyPreviewNavigate=="string"&&/^https?:/i.test(t.agyPreviewNavigate)&&He(t.agyPreviewNavigate,i.id))}),document.addEventListener("visibilitychange",function(){l&&ht()})),document.addEventListener("click",ki,!0),document.addEventListener("dblclick",Ei,!0),N&&document.addEventListener("keydown",function(e){if(l&&je(e)){e.preventDefault(),e.stopImmediatePropagation(),e.repeat||Be(Q());return}if(e.key==="Escape"||e.keyCode===27){E?Me():v?L():l&&V();return}if(!l||e.key!=="ArrowLeft"&&e.key!=="ArrowRight"||e.ctrlKey||e.shiftKey||e.altKey||e.metaKey||e.isComposing||pi(e.target))return;let t=Q();t&&(e.preventDefault(),e.stopImmediatePropagation(),It(t,e.key==="ArrowLeft"?-1:1))},!0);function pi(e){return!!(e&&e.closest&&e.closest('input, textarea, select, [contenteditable="true"], [contenteditable=""], .CodeMirror, .monaco-editor'))}function X(e){if(!_()||!e||e.closest(".agy-preview-container"))return!1;let t=e.getAttribute("href");return!t||t.startsWith("javascript:")||t.startsWith("#")||t===""||!/^https?:/i.test(e.href)?!1:x.isPreviewableUrl?x.isPreviewableUrl(e.href,e):!0}function Z(e){try{return/\.(png|jpe?g|gif|webp|avif|bmp|ico|svg)$/i.test(new URL(e).pathname)}catch{return!1}}function at(e){return/content-type:\s*image\//i.test(e.responseHeaders||"")}function z(e){Me(),E=document.createElement("div"),E.className="agy-image-viewer";let t=document.createElement("img");t.src=e,t.alt="";let i=document.createElement("button");i.className="agy-viewer-close",i.innerHTML=xe,i.title="\u5173\u95ED\u56FE\u7247 (Esc)";let n=document.createElement("div");n.className="agy-viewer-tip",n.textContent="\u70B9\u51FB\u7A7A\u767D\u5904\u6216\u6309 Esc \u5173\u95ED",E.appendChild(t),E.appendChild(i),E.appendChild(n),document.body.appendChild(E)}function Me(){if(!E)return;let e=E;E=null,e.style.setProperty("visibility","hidden","important"),e.style.setProperty("display","none","important"),e.style.setProperty("pointer-events","none","important"),e.style.setProperty("transition","none","important"),ft(()=>{let t=e.querySelector("img");t&&t.removeAttribute("src"),e.parentNode&&e.parentNode.removeChild(e)})}function fi(){let e=Q();try{let t=e&&e.iframe&&e.iframe.contentDocument&&e.iframe.contentDocument.title;if(t&&t.trim())return t.trim()}catch{}try{let t=new URL(A);return t.hostname+t.pathname}catch{return A}}function st(e,t,i){if(!e)return;let n=W(),r=n.findIndex(o=>o.url===e);r>=0?(n.splice(r,1),Pe(n)):(n.unshift({url:e,title:t||e,time:Date.now()}),Pe(n),i&&(i.innerHTML=Ut,i.style.color="#34c759",setTimeout(()=>{i.style.color="",J()},700))),J(),v&&he()}function mi(e){A&&st(A,fi(),e)}function J(){if(!l)return;let e=l.querySelector(".agy-bm-add-btn");e&&(oi(A)?(e.innerHTML=Ft,e.classList.add("agy-bm-active"),e.title="\u53D6\u6D88\u6536\u85CF"):(e.innerHTML=Xe,e.classList.remove("agy-bm-active"),e.title="\u6536\u85CF\u5F53\u524D\u9875\u9762"))}function gi(e){let t=++Je;G(()=>{t!==Je||y!==e||J()})}function he(){if(!v)return;let e=v.querySelector(".agy-bm-list"),t=v.querySelector(".agy-bm-count"),i=v.querySelector(".agy-bm-search");if(!e)return;let n=W(),r=i?i.value.trim().toLocaleLowerCase():"",o=r?n.filter(a=>{let c=(a.title||"").toLocaleLowerCase(),s=(a.url||"").toLocaleLowerCase();return c.includes(r)||s.includes(r)}):n;if(t&&(t.textContent=r?`\u4E66\u7B7E (${o.length}/${n.length})`:`\u4E66\u7B7E (${n.length})`),e.textContent="",!o.length){let a=document.createElement("div");a.className="agy-bm-empty",a.textContent=n.length?"\u6CA1\u6709\u5339\u914D\u7684\u4E66\u7B7E":"\u6682\u65E0\u4E66\u7B7E",e.appendChild(a);return}o.forEach(a=>{let c=document.createElement("div");c.className="agy-bm-item",c.title=`\u6536\u85CF\u4E8E ${li(a.time)}
${a.url}`;let s=document.createElement("span");s.className="agy-bm-item-title",s.textContent=a.title||a.url;let d=document.createElement("button");d.className="agy-bm-item-del",d.innerHTML=Zt,d.title="\u5220\u9664\u6B64\u4E66\u7B7E",d.addEventListener("click",g=>{g.stopPropagation();let h=W().filter(B=>B.url!==a.url);Pe(h),he(),J()}),c.appendChild(s),c.appendChild(d),c.addEventListener("click",()=>{He(a.url,y,{keepBookmarkPanel:!0})}),e.appendChild(c)})}function hi(){if(v){L();return}if(!l)return;v=document.createElement("div"),v.className="agy-bookmark-panel";let e=document.createElement("div");e.className="agy-bm-header";let t=document.createElement("span");t.className="agy-bm-count";let i=document.createElement("input");i.className="agy-bm-search",i.type="search",i.placeholder="\u641C\u7D22\u6807\u9898\u6216\u7F51\u5740",i.setAttribute("aria-label","\u641C\u7D22\u4E66\u7B7E\u6807\u9898\u6216\u7F51\u5740"),i.addEventListener("input",he),i.addEventListener("click",a=>a.stopPropagation()),e.appendChild(t),e.appendChild(i);let n=document.createElement("div");n.className="agy-bm-list",v.appendChild(e),v.appendChild(n),document.body.appendChild(v);let r=l.getBoundingClientRect(),o=r.left-250-8;o<8&&(o=r.right+8),o+250>window.innerWidth-8&&(o=Math.max(8,window.innerWidth-258)),v.style.left=`${o}px`,v.style.top=`${r.top}px`,v.style.maxHeight=`${r.height}px`,he()}function L(){if(!v)return;let e=v;v=null,e.parentNode&&e.parentNode.removeChild(e)}function Ie(e,t){t.size=(t.html?t.html.length:0)+(t.rawHtml?t.rawHtml.length:0);let i=Date.now();for(let[r,o]of m)o.status!=="loading"&&i-o.time>Ge&&m.delete(r);m.has(e)&&m.delete(e),m.set(e,t);let n=0;for(let r of m.values())n+=r.size||0;for(;m.size>Vt||n>qt;){let r=new Set(f.map(c=>c.url));r.add(e);let o=Array.from(m.keys()).find(c=>!r.has(c));if(!o)break;let a=m.get(o);if(n-=a&&a.size||0,a&&a.xhr)try{a.xhr.abort()}catch{}m.delete(o)}}function _e(e,t){return!t||t.status!=="done"?null:(!t.html&&typeof t.rawHtml=="string"&&(t.html=Nt(t.rawHtml,e,be),t.rawHtml=null,t.size=t.html.length),t.html)}function yi(e,t){let i=()=>{m.get(e)===t&&_e(e,t)};typeof requestIdleCallback=="function"?requestIdleCallback(i,{timeout:2e3}):setTimeout(i,150)}function ji(e){if(!_())return;let t=e.target.closest("a");if(!X(t)||R===t)return;let i=Date.now();i-nt<ii||(nt=i,R&&lt(R.href),R=t,t.addEventListener("mouseleave",vi,{once:!0}),D=setTimeout(()=>{wi(t.href)},zt))}function vi(){D&&(clearTimeout(D),D=null),R&&(lt(R.href),R=null)}function wi(e){let t=m.get(e);if(t&&t.status==="loading"||t&&Date.now()-t.time<Ge||Ze(e)||Z(e))return;let i=GM_xmlhttpRequest({method:"GET",url:e,timeout:1e4,onload:function(n){if(n.status>=200&&n.status<400){let r=m.get(e);if(!r||r.xhr!==i)return;at(n)?(r.status="image",r.html="",r.rawHtml=null,r.size=0):(r.status="done",r.rawHtml=n.responseText,r.html=null,r.size=n.responseText.length),r.xhr=null,r.time=Date.now(),f.filter(a=>S(a,a.loadToken,e)&&a.loadState==="waiting-cache").forEach(a=>{if(r.status==="image")a.loadState="image",ye(a.loadingBar,a),a.id===y&&z(e);else{let c=_e(e,r);c&&ze(a,c,e,a.loadingBar,a.loadToken)}}),r.status==="done"&&!r.html&&yi(e,r)}},onerror:function(){let n=m.get(e);!n||n.xhr!==i||(f.filter(r=>S(r,r.loadToken,e)&&r.loadState==="waiting-cache").forEach(r=>Ve(r,"\u9884\u52A0\u8F7D\u7F51\u7EDC\u8BF7\u6C42\u51FA\u9519")),m.delete(e))}});Ie(e,{status:"loading",html:"",xhr:i,time:Date.now()})}function lt(e){let t=m.get(e),i=f.some(n=>n.url===e&&(n.loadState==="loading"||n.loadState==="waiting-cache"));t&&t.status==="loading"&&!i&&(t.xhr&&t.xhr.abort(),m.delete(e))}function ct(e){window.location.href=e}function bi(e){let t=e.getAttribute("target");l&&V(),N&&t==="_blank"?window.open(e.href,"_blank"):ct(e.href)}function dt(e){if(!N){ct(e.href);return}if(Z(e.href)){z(e.href);return}if(l){Lt(e.href);return}A=e.href,_t(e,e.href)}function ut(e,t){!e||!e.isConnected||(t?dt(e):bi(e))}function xi(e){if(!l||!e||!e.isConnected)return;let t=e.getBoundingClientRect(),i=l.getBoundingClientRect();if(!!(t.right<i.left||t.left>i.right||t.bottom<i.top||t.top>i.bottom))return;let r=l;r.style.pointerEvents="none",pe&&clearTimeout(pe),pe=setTimeout(()=>{pe=null,r===l&&(r.style.pointerEvents="")},500)}function ki(e){if(!_()||(We(),e.button!==0||e.ctrlKey||e.shiftKey||e.altKey||e.metaKey))return;let t=e.target.closest("a");if(!X(t)||t.closest(".agy-preview-container"))return;let i=t.getAttribute("href");if(!(!i||i.startsWith("javascript:")||i.startsWith("#")||i==="")){if(e.preventDefault(),e.stopPropagation(),e.detail<2){I&&clearTimeout(I);let n=ce;I=setTimeout(()=>{I=null,ut(t,n),n&&xi(t)},n&&N?Ot:Dt)}else if(e.detail>=2&&(I&&(clearTimeout(I),I=null),e.detail===2)){if(ue){ue=!1;return}ut(t,!ce)}}}function Ei(e){if(!_()||(ue=!1,e.button!==0||e.ctrlKey||e.shiftKey||e.altKey||e.metaKey))return;let t=e.target.closest("a");X(t)&&(e.preventDefault(),e.stopPropagation())}function G(e){if(ae.getNativeVisibilityState()!=="visible"){setTimeout(e,0);return}requestAnimationFrame(()=>{requestAnimationFrame(e)})}function pt(e){G(()=>{try{if(window.scheduler&&typeof window.scheduler.postTask=="function"){let t=window.scheduler.postTask(e,{priority:"background"});t&&typeof t.catch=="function"&&t.catch(()=>{});return}}catch{}setTimeout(e,0)})}function ft(e){G(()=>{typeof requestIdleCallback=="function"?requestIdleCallback(e,{timeout:250}):setTimeout(e,0)})}function Ti(){return!!(l&&se(location.href)?.powerSavePreview)}function Pi(){let e=Ti();e!==tt&&ae.setSuspended(e,{deferNotification:!0})&&(tt=e)}function mt(){let e=++it;pt(()=>{e===it&&Pi()})}function Ae(e,t){if(!(!e||!e.iframe||!e.iframe.contentWindow||e.closed))try{e.iframe.contentWindow.postMessage({agyPreviewActivity:!0,agyPreviewActive:!!t,agyPreviewToken:e.loadToken},"*")}catch{}}function gt(e){return!!(e&&e.id===y&&ae.getNativeVisibilityState()==="visible")}function ht(){f.forEach(e=>Ae(e,gt(e)))}function yt(){let e=++Te;pt(()=>{e===Te&&ht()})}function V(){if(!l)return;let e=l,t=f.slice(),i=new Map;t.forEach(n=>{n.closed=!0,n.loadToken=le++;let r=m.get(n.url);r&&r.status==="loading"&&i.set(n.url,r)}),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("display","none","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"),e.style.setProperty("transition","none","important"),l=null,A="",f=[],y=null,Te+=1,mt(),L(),G(()=>{t.forEach(n=>Et(n)),i.forEach((n,r)=>{if(!f.some(a=>a.url===r&&(a.loadState==="loading"||a.loadState==="waiting-cache"))){if(n.xhr)try{n.xhr.abort()}catch{}m.get(r)===n&&m.delete(r)}}),e.parentNode&&e.parentNode.removeChild(e)})}function Ne(e){!e||!e.contentReadyTimer||(clearTimeout(e.contentReadyTimer),e.contentReadyTimer=null)}function Ci(e){return e?.pane&&e.pane.setAttribute("aria-busy","false"),e&&(e.loadingBar=null),null}function Li(e,t){if(!e?.pane)return null;let i=document.createElement("div");i.className="agy-loading-overlay",i.setAttribute("role","status"),i.setAttribute("aria-live","polite"),i.innerHTML=`
            <div class="agy-loading-card">
                <div class="agy-loading-text"></div>
            </div>
        `;let n=i.querySelector(".agy-loading-text");return n&&(n.textContent=`\u52A0\u8F7D\u51FA\u9519: ${t}`,n.style.color="#ff3b30"),e.pane.appendChild(i),e.loadingBar=i,i}function ye(e,t){Ne(t),t&&t.pane&&t.pane.setAttribute("aria-busy","false");let i=e||t&&t.loadingBar;i&&(t&&t.loadingBar===i&&(t.loadingBar=null),i.style.opacity="0",setTimeout(()=>{i.parentNode&&i.parentNode.removeChild(i)},130))}function vt(e){try{let t=new URL(e),i=t.pathname==="/"?"":t.pathname;return`${t.hostname}${i}`}catch{return e}}function Q(){return f.find(e=>e.id===y)||null}function Si(e){return f.find(t=>t.id===e)||null}function wt(e){return{id:ti++,url:e,title:vt(e),pane:null,iframe:null,request:null,loadingBar:null,contentReadyTimer:null,loadToken:le++,loadState:"idle",historyEntries:[e],historyIndex:0,element:null,titleElement:null,closed:!1}}function bt(e){if(!l||!e||e.pane)return;let t=l.querySelector(".agy-preview-body");if(!t)return;let i=document.createElement("div");i.className="agy-preview-pane",i.dataset.tabId=String(e.id),i.setAttribute("role","tabpanel");let n=document.createElement("iframe");n.className="agy-preview-iframe",n.name=`${oe}${e.loadToken}`,n.setAttribute("sandbox","allow-scripts allow-same-origin allow-forms"),i.appendChild(n),t.appendChild(i),e.pane=i,e.iframe=n}function xt(e){if(!l||!e||e.element)return;let t=l.querySelector(".agy-preview-tabs");if(!t)return;let i=document.createElement("div");i.className="agy-preview-tab",i.dataset.tabId=String(e.id),i.setAttribute("role","tab");let n=document.createElement("span");n.className="agy-preview-tab-title";let r=document.createElement("button");r.type="button",r.className="agy-preview-tab-close",r.innerHTML=xe,r.title="\u5173\u95ED\u6B64\u6807\u7B7E\u9875",r.setAttribute("aria-label","\u5173\u95ED\u6B64\u6807\u7B7E\u9875"),r.addEventListener("click",o=>{o.stopPropagation(),Mt(e.id)}),i.appendChild(n),i.appendChild(r),i.addEventListener("click",()=>St(e.id)),t.appendChild(i),e.element=i,e.titleElement=n,Re(e)}function Re(e){!e||!e.element||(e.element.title=`${e.title}
${e.url}`,e.titleElement&&e.titleElement.textContent!==e.title&&(e.titleElement.textContent=e.title))}function Mi(e){!e||!e.element||requestAnimationFrame(()=>{if(!e.element||!e.element.isConnected)return;let t=e.element.parentElement;if(!t)return;let i=e.element.offsetLeft,n=i+e.element.offsetWidth;i<t.scrollLeft?t.scrollLeft=i:n>t.scrollLeft+t.clientWidth&&(t.scrollLeft=n-t.clientWidth)})}function S(e,t,i){return!!(e&&!e.closed&&f.includes(e)&&e.loadToken===t&&e.url===i&&e.iframe)}function kt(e){if(e){if(e.iframe&&Ae(e,!1),e.loadToken=le++,e.request){try{e.request.abort()}catch{}e.request=null}Ne(e),e.iframe&&(e.iframe.onload=null),e.loadingBar&&(e.loadingBar.remove(),e.loadingBar=null),e.pane&&e.pane.setAttribute("aria-busy","false")}}function Et(e){if(e){if(kt(e),e.iframe){try{e.iframe.src="about:blank"}catch{}try{e.iframe.removeAttribute("srcdoc")}catch{}}e.pane&&e.pane.parentNode&&e.pane.parentNode.removeChild(e.pane),e.element&&e.element.parentNode&&e.element.parentNode.removeChild(e.element),e.iframe=null,e.pane=null,e.element=null,e.titleElement=null,e.loadState="closed"}}function ee(e=!1){let t=Q();if(!l||!t)return;A=t.url;let i=l.querySelector(".agy-preview-tab.active");i&&i!==t.element&&(i.classList.remove("active"),i.setAttribute("aria-selected","false")),t.element&&(t.element.classList.add("active"),t.element.setAttribute("aria-selected","true"));let n=l.querySelector(".agy-preview-pane.active");n&&n!==t.pane&&(n.classList.remove("active"),n.setAttribute("aria-hidden","true")),t.pane&&(t.pane.classList.add("active"),t.pane.setAttribute("aria-hidden","false")),yt();let r=l.querySelector(".agy-open-btn");r&&(r.href=t.url),gi(t.id),e&&Mi(t)}function Tt(e,t){let i=t&&t.trim();!e||e.closed||!i||(e.title=i,Re(e))}function ve(e,t={}){if(!e||!l||!e.iframe||e.closed)return;kt(e),Oe(e.iframe,e.loadToken);let i=e.loadToken,n=e.url;e.loadState="loading",delete e.iframe.dataset.loaded,e.iframe.style.visibility="visible";let r=Ci(e),o={...t};delete o.deferStart;let a=()=>{S(e,i,n)&&Ii(e,n,r,i,o)};t.deferStart===!0?G(a):a()}function Pt(e){return!e||!e.body?!1:(typeof e.body.innerText=="string"?e.body.innerText:e.body.textContent||"").replace(/\s+/g,"").length>=12?!0:!!e.body.querySelector('img[src], video, canvas, svg, article, main > *, [role="main"] > *')}function Ct(e,t,i,n=0){if(!(!S(e,i,t)||e.loadState==="loaded")){try{if(Pt(e.iframe.contentDocument)){De(e,i,t);return}}catch{return}n>=100||(e.contentReadyTimer=setTimeout(()=>{e.contentReadyTimer=null,Ct(e,t,i,n+1)},100))}}function Lt(e){if(Z(e)){z(e);return}let t=wt(e);f.push(t),bt(t),xt(t),y=t.id,ee(!0),L(),ve(t,{deferStart:!0})}function St(e){e===y||!f.some(t=>t.id===e)||(y=e,ee(!0),L())}function Mt(e){let t=f.findIndex(r=>r.id===e);if(t<0)return;if(f.length===1){V();return}let i=f[t],n=y===e;i.closed=!0,i.loadToken=le++,i.pane&&(i.pane.style.visibility="hidden",i.pane.style.pointerEvents="none"),i.element&&(i.element.style.display="none"),f.splice(t,1),n?(y=f[Math.min(t,f.length-1)].id,ee(!0)):yt(),ft(()=>Et(i))}function He(e,t=y,i={}){if(Z(e)){z(e);return}let n=Si(t);n&&(i.fromHistory||(n.historyEntries=n.historyEntries.slice(0,n.historyIndex+1),n.historyEntries[n.historyEntries.length-1]!==e&&n.historyEntries.push(e),n.historyIndex=n.historyEntries.length-1),n.url=e,n.title=vt(e),n.id===y?(ee(),i.keepBookmarkPanel||L()):Re(n),ve(n))}function It(e,t){if(!e||e.closed||t!==-1&&t!==1)return!1;let i=e.historyIndex+t;return i<0||i>=e.historyEntries.length?!1:(e.historyIndex=i,He(e.historyEntries[i],e.id,{fromHistory:!0}),!0)}function Be(e){return!e||e.closed||e.id!==y?!1:(L(),ve(e,{forceReload:!0}),!0)}function Ii(e,t,i,n,r={}){if(!S(e,n,t))return;if(Ze(t)){Ai(e,t,i,n);return}if(r.forceReload){At(e,t,i,n,r);return}let o=m.get(t);if(o&&o.status==="image")e.loadState="image",e.id===y&&z(t),ye(i,e);else if(o&&o.status==="done"){let a=_e(t,o);a&&ze(e,a,t,i,n)}else o&&o.status==="loading"?e.loadState="waiting-cache":At(e,t,i,n)}function _t(e,t){l=document.createElement("div"),l.className="agy-preview-container";let i=l,n=document.createElement("div");n.className="agy-preview-header";let r=document.createElement("div");r.className="agy-preview-tabs",r.setAttribute("role","tablist");let o=document.createElement("div");o.className="agy-preview-actions";let a=document.createElement("button");a.className="agy-preview-btn agy-bm-list-btn",a.title="\u4E66\u7B7E\u5217\u8868",a.innerHTML=Gt,a.addEventListener("click",M=>{M.stopPropagation(),hi()});let c=document.createElement("button");c.className="agy-preview-btn agy-bm-add-btn",c.title="\u6536\u85CF\u5F53\u524D\u9875\u9762",c.innerHTML=Xe,c.addEventListener("click",M=>{M.stopPropagation(),mi(c)});let s=document.createElement("a");s.className="agy-preview-btn agy-open-btn",s.href=t,s.target="_blank",s.title="\u65B0\u7A97\u53E3\u6253\u5F00",s.innerHTML=Wt,s.addEventListener("click",()=>{setTimeout(V,0)});let d=document.createElement("button");d.type="button",d.className="agy-preview-btn agy-refresh-btn",d.title="\u5237\u65B0\u5F53\u524D\u9884\u89C8",d.setAttribute("aria-label",d.title),d.innerHTML=Xt,d.addEventListener("click",M=>{M.preventDefault(),M.stopPropagation(),Be(Q())});let g=document.createElement("button");g.type="button",g.className="agy-maximize-btn",g.addEventListener("click",M=>{M.preventDefault(),M.stopPropagation(),Ri()});let h=document.createElement("button");h.type="button",h.className="agy-close-btn",h.innerHTML=xe,h.title="\u5173\u95ED\u9884\u89C8 (Esc)",o.appendChild(a),o.appendChild(c),o.appendChild(s),o.appendChild(d),o.appendChild(g),o.appendChild(h),n.appendChild(r),n.appendChild(o);let B=document.createElement("div");B.className="agy-preview-body",l.appendChild(n),l.appendChild(B),document.body.appendChild(l),f=[wt(t)],y=f[0].id,bt(f[0]),xt(f[0]),ee(),Bi(e),qe(),Hi(n),i.classList.add("agy-instant-feedback"),i.classList.add("agy-preview-visible"),G(()=>{i===l&&i.classList.remove("agy-instant-feedback")}),ve(f[0],{deferStart:!0}),mt()}function At(e,t,i,n,r={}){let o=null,a={method:"GET",url:t,timeout:1e4,onload:function(c){if(!(!S(e,n,t)||e.request!==o))if(e.request=null,c.status>=200&&c.status<400){if(at(c)){Ie(t,{status:"image",html:"",xhr:null,time:Date.now()}),e.loadState="image",e.id===y&&z(t),ye(i,e);return}let s=Nt(c.responseText,t,be);Ie(t,{status:"done",html:s,xhr:null,time:Date.now()}),ze(e,s,t,i,n)}else Ve(e,c.statusText||"\u52A0\u8F7D\u5931\u8D25")},onerror:function(){!S(e,n,t)||e.request!==o||(e.request=null,Ve(e,"\u7F51\u7EDC\u8FDE\u63A5\u51FA\u9519"))}};r.forceReload&&(a.headers={"Cache-Control":"no-cache",Pragma:"no-cache"}),o=GM_xmlhttpRequest(a),e.request=o}function Nt(e,t,i){let n=new DOMParser().parseFromString(e,"text/html");n.querySelectorAll("base").forEach(c=>c.remove()),n.querySelectorAll("meta[http-equiv]").forEach(c=>{let s=(c.getAttribute("http-equiv")||"").toLowerCase();(s==="content-security-policy"||s==="refresh")&&c.remove()});let r=n.createElement("base");r.href=t,n.head.prepend(r);let o=n.createElement("script");o.textContent=`
            (function() {
        ...
        `,r.after(o);let a=se(t);if(a&&a.css){let c=n.createElement("style");c.textContent=a.css,n.head.appendChild(c)}return`<!doctype html>
`+n.documentElement.outerHTML}function Rt(e,t,i,n){if(!S(e,n,t))return;let r=!1,o=!1;try{let a=e.iframe.contentDocument;r=!!a,o=Pt(a),_i(a,t),a&&a.title&&Tt(e,a.title)}catch{}!r||o?De(e,n,t,i):Ct(e,t,n),e.id===y&&J(),Ae(e,gt(e))}function De(e,t,i,n){S(e,t,i)&&(e.loadState="loaded",e.iframe.style.visibility="visible",ye(n||e.loadingBar,e))}function _i(e,t){let i=se(t);if(!e||!i||!i.css)return;let n=e.getElementById("agy-site-rule-style");if(n){n.textContent!==i.css&&(n.textContent=i.css);return}let r=e.createElement("style");r.id="agy-site-rule-style",r.textContent=i.css,(e.head||e.documentElement).appendChild(r)}function Oe(e,t){let i=`${oe}${t}`;e.name=i;try{e.contentWindow.name=i}catch{}}function Ai(e,t,i,n){if(!S(e,n,t))return;let r=e.iframe;r.dataset.loaded="true",Oe(r,n),r.onload=()=>Rt(e,t,i,n),r.removeAttribute("srcdoc"),r.src=t}function ze(e,t,i,n,r){if(!S(e,r,i))return;let o=e.iframe;e.loadState="loading",o.dataset.loaded="true",Oe(o,r),o.onload=()=>Rt(e,i,n,r),o.srcdoc=t.replace(new RegExp(be,"g"),String(r))}function Ve(e,t){if(!l||!e||e.closed)return;Ne(e),e.loadState="error";let i=e.loadingBar;if(i||(i=Li(e,t)),!i)return;e.pane&&e.pane.setAttribute("aria-busy","false"),e.iframe&&(e.iframe.style.visibility="hidden");let n=i.querySelector(".agy-loading-text");n&&(n.textContent=`\u52A0\u8F7D\u51FA\u9519: ${t}`,n.style.color="#ff3b30");let r=i.querySelector(".agy-spinner");r&&(r.style.borderTopColor="#ff3b30",r.style.animationPlayState="paused")}function q(e,t,i){let n=i?i.offsetWidth:Math.min(Fe,window.innerWidth-b*2),r=i?i.offsetHeight:Math.min(we,window.innerHeight-b*2),o=Math.max(b,window.innerWidth-n-b),a=Math.max(b,window.innerHeight-r-b);return{left:Math.round(Math.min(Math.max(e,b),o)),top:Math.round(Math.min(Math.max(t,b),a))}}function $(e,t){e.style.left=`${t.left}px`,e.style.top=`${t.top}px`}function Ni(){if(!l)return;let e=l.querySelector(".agy-maximize-btn");e&&(e.innerHTML=C?Yt:jt,e.title=C?"\u8FD8\u539F\u9884\u89C8\u7A97\u53E3":"\u6700\u5927\u5316\u9884\u89C8\u7A97\u53E3",e.setAttribute("aria-label",e.title),e.setAttribute("aria-pressed",String(C)))}function qe(){l&&(l.classList.toggle("agy-maximized",C),Ni())}function Ri(){if(l){if(!C){let e=l.getBoundingClientRect(),t=q(e.left,e.top,l);$(l,t),me(t)}if(C=!C,si(C),qe(),!C){let e=rt(),t=q(e?e.left:l.offsetLeft,e?e.top:l.offsetTop,l);$(l,t),me(t)}L()}}function Hi(e){e.addEventListener("pointerdown",function(t){if(t.button!==0||C||t.target.closest(".agy-preview-actions, .agy-preview-tab"))return;let i=e.closest(".agy-preview-container");if(!i||i!==l)return;let n=i.getBoundingClientRect(),r=t.pointerId,o=t.clientX-n.left,a=t.clientY-n.top;t.preventDefault(),t.stopPropagation(),L(),i.classList.add("agy-preview-visible"),i.classList.remove("agy-animating"),i.classList.add("agy-dragging");try{e.setPointerCapture(r)}catch{}function c(d){if(d.pointerId!==r)return;let g=q(d.clientX-o,d.clientY-a,i);$(i,g)}function s(d){if(d.pointerId!==r)return;e.removeEventListener("pointermove",c),e.removeEventListener("pointerup",s),e.removeEventListener("pointercancel",s),i.classList.remove("agy-dragging");try{e.releasePointerCapture(r)}catch{}let g=i.getBoundingClientRect(),h=q(g.left,g.top,i);$(i,h),me(h)}e.addEventListener("pointermove",c),e.addEventListener("pointerup",s),e.addEventListener("pointercancel",s)})}function Bi(e){if(!l)return;let t=rt();if(t){$(l,q(t.left,t.top,l));return}let i=e.getBoundingClientRect(),n=i.bottom+8,r=i.left;n+l.offsetHeight>window.innerHeight-b&&(n=i.top-we-8),$(l,q(r,n,l))}function Di(e){try{return new URL(e).origin===window.location.origin}catch{return!1}}function Oi(e,t){if(!_()||!/^https?:/i.test(e)||x.isPreviewableUrl&&!x.isPreviewableUrl(e,null))return;if(Z(e)){z(e);return}if(l){Lt(e);return}A=e;let i=t||{left:b,top:b,bottom:b};_t({getBoundingClientRect:()=>i},e)}function zi(){V(),D&&clearTimeout(D),D=null,R=null,m.forEach(e=>{if(e&&e.xhr)try{e.xhr.abort()}catch{}}),m.clear()}return{openFromFrame:Oi,close:zi,syncClickMode:We}}export{Wi as installLinkHoverPreviewer};
