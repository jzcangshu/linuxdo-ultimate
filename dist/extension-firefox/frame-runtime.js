var U="linuxdo-ultimate-embedded-styles",W=`
...
${W}
`;function N(r=document){let o=r.getElementById(U);if(o instanceof HTMLStyleElement)return o;let i=r.createElement("style");return i.id=U,i.textContent=tt,(r.head??r.documentElement).append(i),i}function et(r){return r==="linux.do"||r.endsWith(".linux.do")?!0:globalThis.window?.__LDU_TEST_MODE__===!0&&(r==="localhost"||r==="127.0.0.1")}function h(r,o="https://linux.do/"){let i;try{i=new URL(r,o)}catch{return null}if(!et(i.hostname))return null;let l=i.pathname.split("/").filter(Boolean),d=l.findIndex(u=>u==="t"||u==="n");if(d<0)return null;let s=l.findIndex((u,f)=>f>d&&/^\d+$/.test(u));if(s<0)return null;let m=l[s+1]&&/^\d+$/.test(l[s+1])?Number(l[s+1]):void 0;return{url:i,topicId:l[s],...m?{postNumber:m}:{}}}function V(r,o){let i=h(r,o),l=h(o,o);return!!(i&&(!l||i.topicId!==l.topicId))}var K={ownerOnlyEnabled:!1,minimalHidePosters:!1,minimalHideNotices:!1,minimalHideCategoryBadges:!1,minimalHideTags:!1,lowEndOptimizationEnabled:!1};function Y(r){if(!(r instanceof HTMLElement))return null;let o=r.dataset.lduPageTools;if(!o)return null;try{let i=JSON.parse(o);return!i||typeof i!="object"?null:{ownerOnlyEnabled:i.ownerOnlyEnabled===!0,minimalHidePosters:i.minimalHidePosters===!0,minimalHideNotices:i.minimalHideNotices===!0,minimalHideCategoryBadges:i.minimalHideCategoryBadges===!0,minimalHideTags:i.minimalHideTags===!0,lowEndOptimizationEnabled:i.lowEndOptimizationEnabled===!0,base64Enabled:i.base64Enabled!==!1}}catch{return null}}function q(r,o,i){P(r,"lduHidePosters",i.minimalHidePosters),P(r,"lduHideNotices",i.minimalHideNotices),P(r,"lduHideCategoryBadges",i.minimalHideCategoryBadges),P(r,"lduHideTags",i.minimalHideTags),P(r,"lduLowEnd",i.lowEndOptimizationEnabled&&it(o))}function $(r,o){return r.ownerOnlyEnabled===o.ownerOnlyEnabled&&r.minimalHidePosters===o.minimalHidePosters&&r.minimalHideNotices===o.minimalHideNotices&&r.minimalHideCategoryBadges===o.minimalHideCategoryBadges&&r.minimalHideTags===o.minimalHideTags&&r.lowEndOptimizationEnabled===o.lowEndOptimizationEnabled&&r.base64Enabled!==!1==(o.base64Enabled!==!1)}function P(r,o,i){let l=String(i);r.dataset[o]!==l&&(r.dataset[o]=l)}function it(r){let o=r.hardwareConcurrency,i=r.deviceMemory;return Number.isFinite(o)&&o<=4||typeof i=="number"&&Number.isFinite(i)&&i<=4}var M=class{constructor(o={}){this.options=o;this.win=o.window??window,this.doc=o.document??document}config={...K};active=!0;stopped=!1;ownerInstaller=null;ownerController=null;ownerLoad=null;win;doc;setConfig(o){if(this.stopped)return;let i={...this.config,...o};$(this.config,i)||(this.config=i,this.applyStaticModes(),this.ownerController?.setConfig?.({ownerOnlyEnabled:i.ownerOnlyEnabled,base64Enabled:i.base64Enabled!==!1}),this.syncOwnerView())}setActive(o){this.stopped||this.active===o||(this.active=o,this.syncOwnerView())}stop(){this.stopped||(this.stopped=!0,this.ownerController?.stop(),this.ownerController=null,delete this.doc.documentElement.dataset.lduHidePosters,delete this.doc.documentElement.dataset.lduHideNotices,delete this.doc.documentElement.dataset.lduHideCategoryBadges,delete this.doc.documentElement.dataset.lduHideTags,delete this.doc.documentElement.dataset.lduLowEnd)}applyStaticModes(){q(this.doc.documentElement,this.win.navigator,this.config)}wantsOwnerView(){return this.active&&this.ownerViewConfigured()}ownerViewConfigured(){return this.options.allowOwnerView!==!1&&this.config.ownerOnlyEnabled&&typeof this.options.loadOwnerView=="function"}syncOwnerView(){if(!this.ownerViewConfigured()){this.ownerController?.stop(!0),this.ownerController=null;return}if(!this.active){this.ownerController?.setActive(!1);return}if(this.ownerController){this.ownerController.setActive(!0);return}if(this.ownerInstaller){this.installOwnerView(this.ownerInstaller);return}if(!this.ownerLoad)try{let o=this.options.loadOwnerView();if(!(o instanceof Promise)){this.ownerInstaller=o,this.installOwnerView(o);return}this.ownerLoad=o.then(i=>(this.ownerInstaller=i,this.wantsOwnerView()&&this.installOwnerView(i),i)).catch(i=>(console.error("[Linux Do Ultimate] Owner view runtime failed to load",i),null)).finally(()=>{this.ownerLoad=null})}catch(o){console.error("[Linux Do Ultimate] Owner view runtime failed to load",o)}}installOwnerView(o){!this.wantsOwnerView()||this.ownerController||(this.ownerController=o({window:this.win,document:this.doc,...this.options.isEmbedded!==void 0?{isEmbedded:this.options.isEmbedded}:{},...this.options.isSplitHost?{isSplitHost:this.options.isSplitHost}:{},base64Enabled:this.config.base64Enabled!==!1}),this.ownerController.setActive(!0))}};var X=300;function G(r={}){let o=window.name;if(o.startsWith("ldu-list:")){ot(o.slice(9),r);return}if(!o.startsWith("ldu-topic:"))return;let i=o.slice(10);document.documentElement.dataset.lduEmbeddedTopic="true",N(document);let l=new M({isEmbedded:!0,...r.loadOwnerView?{loadOwnerView:r.loadOwnerView}:{}});r.initialPageToolsConfig&&l.setConfig(r.initialPageToolsConfig);let d=null,s=null,m="",u=location.href,f=document.title,b=!1,x="double",k=!1,c=null,w=!1,p=t=>{w&&t==="ldu:frame-state"||(d!==null&&window.clearTimeout(d),s=t,d=window.setTimeout(()=>{if(d=null,s=null,w&&t==="ldu:frame-state")return;let e={type:t,tabId:i};(t==="ldu:frame-ready"||m!==location.href)&&(m=location.href,e.url=location.href,e.title=document.title),window.parent.postMessage(e,location.origin)},t==="ldu:frame-ready"?0:120))};window.addEventListener("scroll",()=>{m!==location.href&&p("ldu:frame-state")},{passive:!0}),window.addEventListener("load",()=>p("ldu:frame-ready"),{once:!0}),document.addEventListener("DOMContentLoaded",()=>p("ldu:frame-ready"),{once:!0}),window.addEventListener("popstate",()=>p("ldu:frame-state"));let E=new MutationObserver(()=>{if(w)return;let t=u!==location.href,e=f!==document.title;!t&&!e||(u=location.href,f=document.title,p("ldu:frame-state"))}),C=()=>E.observe(document.documentElement,{childList:!0,subtree:!0});C();let v=()=>{c!==null&&window.clearTimeout(c),c=null},H=new Set,T=new Set,I=()=>{for(let e of document.querySelectorAll("audio, video"))if(!(e.paused||e.ended)){H.add(e);try{e.pause()}catch{}}let t=document;for(let e of t.getAnimations?.()??[])if(e.playState==="running"){T.add(e);try{e.pause()}catch{}}},S=()=>{for(let t of H)if(t.isConnected)try{t.play().catch(()=>{})}catch{}H.clear();for(let t of T)try{t.play()}catch{}T.clear()},a=t=>{if(w!==t){if(w=t,l.setActive(!t),t){document.documentElement.dataset.lduSoftFrozen="true",d!==null&&s==="ldu:frame-state"&&(window.clearTimeout(d),d=null,s=null),v(),E.disconnect(),I();return}delete document.documentElement.dataset.lduSoftFrozen,u=location.href,f=document.title,C(),S(),p("ldu:frame-state")}},n=t=>{let e=t instanceof Element?t.closest("a[href]"):null;return!e||!/^https?:/i.test(e.href)||h(e.href)||new URL(e.href,location.href).origin===location.origin||t instanceof Element&&t.closest("img, picture, .lightbox-wrapper")||e.matches(".lightbox")||e.querySelector("img, picture")||e.closest("button, [role=button], .btn, .d-button, input, textarea, select")?null:e},g=t=>{let e=t instanceof Element?t.closest("a[href]"):null;return!e||!V(e.href,location.href)||e.closest("button, [role=button], .btn, .d-button, input, textarea, select")?null:e},L=t=>{let e=t instanceof Element?t.closest("a[href]"):null;return!e||!/^https?:/i.test(e.href)||new URL(e.href,location.href).origin!==location.origin||h(e.href)||e.closest("button, [role=button], .btn, .d-button, input, textarea, select")?null:e},B=t=>{let e=h(t.href,location.href);window.parent.postMessage({type:"ldu:topic-open",tabId:i,url:t.href,title:t.textContent?.trim()||(e?`\u4E3B\u9898 ${e.topicId}`:""),...e?.postNumber?{postNumber:e.postNumber}:{}},location.origin)},R=t=>{let e=t.getBoundingClientRect();window.parent.postMessage({type:"ldu:preview-open",tabId:i,url:t.href,anchorRect:{left:e.left,top:e.top,right:e.right,bottom:e.bottom,width:e.width,height:e.height}},location.origin)},F=t=>t.button===0&&!t.ctrlKey&&!t.metaKey&&!t.shiftKey&&!t.altKey;window.addEventListener("message",t=>{if(t.source!==window.parent||t.origin!==location.origin)return;let e=t.data;if(e?.type==="ldu:frame-lifecycle"){a(e.active!==!0);return}if(e?.type==="ldu:bookmark"){let z=typeof e.topicId=="string"&&/^\d+$/.test(e.topicId)?e.topicId:null,y=document.querySelector('meta[name="csrf-token"]')?.content;if(!z||!y){window.parent.postMessage({type:"ldu:bookmark-result",tabId:i,ok:!1,message:"\u6DFB\u52A0\u4E66\u7B7E\u5931\u8D25"},location.origin);return}let Z=new URLSearchParams({bookmarkable_type:"Topic",bookmarkable_id:z});fetch("/bookmarks.json",{method:"POST",credentials:"same-origin",headers:{Accept:"application/json","Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","X-CSRF-Token":y,"X-Requested-With":"XMLHttpRequest"},body:Z}).then(async O=>{if(!O.ok){let j="\u6DFB\u52A0\u4E66\u7B7E\u5931\u8D25";try{let _=await O.json();Array.isArray(_.errors)&&typeof _.errors[0]=="string"&&(j=_.errors[0])}catch{}throw new Error(j)}window.parent.postMessage({type:"ldu:bookmark-result",tabId:i,ok:!0,message:"\u5DF2\u6DFB\u52A0\u5230\u4E66\u7B7E"},location.origin)}).catch(O=>{window.parent.postMessage({type:"ldu:bookmark-result",tabId:i,ok:!1,message:O instanceof Error&&O.message?O.message:"\u6DFB\u52A0\u4E66\u7B7E\u5931\u8D25"},location.origin)});return}if(e?.type==="ldu:page-tools-config"){l.setConfig({ownerOnlyEnabled:e.ownerOnlyEnabled===!0,minimalHidePosters:e.minimalHidePosters===!0,minimalHideNotices:e.minimalHideNotices===!0,minimalHideCategoryBadges:e.minimalHideCategoryBadges===!0,minimalHideTags:e.minimalHideTags===!0,lowEndOptimizationEnabled:e.lowEndOptimizationEnabled===!0,base64Enabled:e.base64Enabled!==!1});return}e?.type==="ldu:preview-config"&&(b=e.enabled===!0,x=e.clickMode==="single"?"single":"double",b||v())}),document.addEventListener("pointerdown",t=>{window.parent.postMessage({type:"ldu:frame-interaction",tabId:i},location.origin),b&&x==="double"&&t.detail>=2&&v()},!0);let A=null,D=()=>{A===null&&(window.parent.postMessage({type:"ldu:frame-interaction",tabId:i},location.origin),A=window.setTimeout(()=>{A=null},120))};window.addEventListener("wheel",D,{passive:!0,capture:!0}),window.addEventListener("touchstart",D,{passive:!0,capture:!0}),document.addEventListener("keydown",t=>{["ArrowDown","ArrowUp","PageDown","PageUp","Home","End","Space"].includes(t.key)&&D()},!0),document.addEventListener("click",t=>{if(k||!F(t))return;let e=g(t.target);if(e){t.preventDefault(),t.stopImmediatePropagation(),B(e);return}let z=L(t.target);if(z){t.preventDefault(),t.stopImmediatePropagation(),window.parent.postMessage({type:"ldu:list-navigate",tabId:i,url:z.href},location.origin);return}if(!b)return;let y=n(t.target);if(y){if(t.preventDefault(),t.stopImmediatePropagation(),x==="single"){R(y);return}v(),!(t.detail>=2)&&(c=window.setTimeout(()=>{if(c=null,!!y.isConnected){k=!0;try{y.click()}finally{k=!1}}},X))}},!0),document.addEventListener("dblclick",t=>{if(!b||x!=="double"||!F(t))return;let e=n(t.target);e&&(v(),t.preventDefault(),t.stopImmediatePropagation(),R(e))},!0),document.addEventListener("keydown",t=>{!b||t.key!=="Escape"||window.parent.postMessage({type:"ldu:preview-dismiss",tabId:i},location.origin)},!0),p("ldu:frame-ready")}function ot(r,o){document.documentElement.dataset.lduEmbeddedList="true",N(document);let i=new M({isEmbedded:!0,allowOwnerView:!1,...o.loadOwnerView?{loadOwnerView:o.loadOwnerView}:{}});o.initialPageToolsConfig&&i.setConfig(o.initialPageToolsConfig);let l=null,d=null,s=!1,m=null,u=!1,f="double",b=!1,x="",k="",c=a=>{l!==null&&window.clearTimeout(l),l=window.setTimeout(()=>{l=null;let n={type:a,frameId:r,url:location.href,title:document.title,scrollY:window.scrollY};x=location.href,k=document.title,window.parent.postMessage(n,location.origin)},a==="ldu:list-ready"?0:100)},w=()=>{if(document.readyState==="loading")return!1;let a=document.querySelector("#main-outlet");return a?[...a.children].some(n=>!n.matches(".loading-container, .spinner, .spinner-container, .loading-indicator")):!1},p=()=>{s||m!==null||!w()||(m=window.setTimeout(()=>{m=null,!(s||!w())&&(s=!0,window.parent.postMessage({type:"ldu:list-visual-ready",frameId:r,url:location.href,title:document.title,scrollY:window.scrollY},location.origin))},0))},E=()=>{d!==null&&window.clearTimeout(d),d=null},C=a=>a.button===0&&!a.ctrlKey&&!a.metaKey&&!a.shiftKey&&!a.altKey,v=a=>{let n=a instanceof Element?a.closest("a[href]"):null;return!n||!V(n.href,location.href)||n.closest("button, [role=button], .btn, .d-button, input, textarea, select")?null:n},H=a=>{if(!(a instanceof Element)||a.closest("a[href], button, [role=button], [role=link], input, textarea, select, label, summary, [contenteditable=true]"))return null;let n=window.getSelection?.();if(n&&!n.isCollapsed)return null;let g=a.closest(".topic-list-item[data-topic-id]"),L=g?.querySelector("a.title.raw-topic-link[href], .main-link a.title[href], a.raw-topic-link[href]")??null;return!g||!L||!V(L.href,location.href)?null:h(L.href,location.href)?.topicId===g.dataset.topicId?L:null},T=a=>{let n=a instanceof Element?a.closest("a[href]"):null;return!n||!/^https?:/i.test(n.href)||h(n.href)||new URL(n.href,location.href).origin===location.origin||a instanceof Element&&a.closest("img, picture, .lightbox-wrapper")||n.matches(".lightbox")||n.querySelector("img, picture")||n.closest("button, [role=button], .btn, .d-button, input, textarea, select")?null:n},I=a=>{let n=h(a.href,location.href);window.parent.postMessage({type:"ldu:list-topic-open",frameId:r,url:a.href,topicId:n?.topicId,postNumber:n?.postNumber,topicTitle:a.textContent?.trim()||(n?`\u4E3B\u9898 ${n.topicId}`:"")},location.origin)},S=a=>{let n=a.getBoundingClientRect();window.parent.postMessage({type:"ldu:list-preview-open",frameId:r,url:a.href,anchorRect:{left:n.left,top:n.top,right:n.right,bottom:n.bottom,width:n.width,height:n.height}},location.origin)};window.addEventListener("message",a=>{if(a.source!==window.parent||a.origin!==location.origin)return;let n=a.data;if(n?.type==="ldu:page-tools-config"){i.setConfig({ownerOnlyEnabled:n.ownerOnlyEnabled===!0,minimalHidePosters:n.minimalHidePosters===!0,minimalHideNotices:n.minimalHideNotices===!0,minimalHideCategoryBadges:n.minimalHideCategoryBadges===!0,minimalHideTags:n.minimalHideTags===!0,lowEndOptimizationEnabled:n.lowEndOptimizationEnabled===!0,base64Enabled:n.base64Enabled!==!1});return}n?.type==="ldu:preview-config"&&(u=n.enabled===!0,f=n.clickMode==="single"?"single":"double",u||E())}),window.addEventListener("scroll",()=>c("ldu:list-state"),{passive:!0}),window.addEventListener("load",()=>{c("ldu:list-ready"),p()},{once:!0}),document.addEventListener("DOMContentLoaded",()=>{c("ldu:list-ready"),p()},{once:!0}),window.addEventListener("popstate",()=>c("ldu:list-state")),window.addEventListener("hashchange",()=>c("ldu:list-state")),document.addEventListener("pointerdown",()=>{window.parent.postMessage({type:"ldu:list-interaction",frameId:r},location.origin)},!0),new MutationObserver(()=>{p(),!(x===location.href&&k===document.title)&&c("ldu:list-state")}).observe(document.documentElement,{childList:!0,subtree:!0}),document.addEventListener("click",a=>{if(b||!C(a))return;let n=v(a.target)??H(a.target);if(n){a.preventDefault(),a.stopImmediatePropagation(),I(n);return}if(!u)return;let g=T(a.target);if(g){if(a.preventDefault(),a.stopImmediatePropagation(),f==="single"){S(g);return}E(),!(a.detail>=2)&&(d=window.setTimeout(()=>{if(d=null,!!g.isConnected){b=!0;try{g.click()}finally{b=!1}}},X))}},!0),document.addEventListener("dblclick",a=>{if(!u||f!=="double"||!C(a))return;let n=T(a.target);n&&(E(),a.preventDefault(),a.stopImmediatePropagation(),S(n))},!0),document.addEventListener("keydown",a=>{a.key==="Escape"&&window.parent.postMessage({type:"ldu:list-preview-dismiss",frameId:r},location.origin)},!0),c("ldu:list-ready"),p()}var J=window.name.startsWith("ldu-topic:")?import(chrome.runtime.getURL("topic-tools-runtime.js")):null,Q=Y(window.frameElement);G({...Q?{initialPageToolsConfig:Q}:{},...J?{loadOwnerView:()=>J.then(r=>r.installOwnerView)}:{}});document.getElementById("ldu-frame-bootstrap-style")?.remove();
