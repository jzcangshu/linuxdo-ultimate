"use strict";(()=>{var v={schemaVersion:5,enabled:!0,layoutPreference:"auto",tabsEnabled:!0,tabPresentation:"horizontal",verticalTabsAutoCollapse:!0,groupVerticalTabs:!1,restoreSession:!1,colorizeTabs:!0,cleanModeEnabled:!0,minimalHidePosters:!0,minimalHideNotices:!0,minimalHideCategoryBadges:!0,minimalHideTags:!0,lowEndOptimizationEnabled:!1,previewEnabled:!1,creditEnabled:!0,base64Enabled:!0,previewClickMode:"double",maxLiveFrames:3,maxOpenTabs:50,paneSizes:{sidebar:216,listRatio:.35},dualPaneSizes:{sidebar:216,listRatio:.35}},$=1,ue="linuxdo-ultimate:settings",N="linuxdo-ultimate:session:",G="linuxdo-ultimate:session-id",M="linuxdo-ultimate:session-owner:",pe="linuxdo-ultimate:session-index",Y="linuxdo-ultimate:latest-session",W="linuxdo-ultimate:latest-session-candidate";function R(n){if(!n||typeof n!="object")return structuredClone(v);let e=n,t=e.schemaVersion===2||e.schemaVersion===3||e.schemaVersion===4||e.schemaVersion===v.schemaVersion,i=e.schemaVersion===3||e.schemaVersion===4||e.schemaVersion===v.schemaVersion?e.cleanModeEnabled!==!1:e.cleanModeEnabled===!0||e.hidePosters!==!1,s=e.schemaVersion===4||e.schemaVersion===v.schemaVersion,a=e.paneSizes&&typeof e.paneSizes=="object"?e.paneSizes:{},r=e.dualPaneSizes&&typeof e.dualPaneSizes=="object"?e.dualPaneSizes:{};return{...v,enabled:!0,layoutPreference:e.layoutPreference==="two"||e.layoutPreference==="three"?e.layoutPreference:"auto",tabsEnabled:e.tabsEnabled!==!1,tabPresentation:e.tabPresentation==="vertical"?"vertical":"horizontal",verticalTabsAutoCollapse:e.verticalTabsAutoCollapse!==!1,groupVerticalTabs:e.groupVerticalTabs===!0,restoreSession:t&&e.restoreSession===!0,colorizeTabs:e.colorizeTabs!==!1,cleanModeEnabled:i,minimalHidePosters:s?e.minimalHidePosters!==!1:!0,minimalHideNotices:s?e.minimalHideNotices!==!1:!0,minimalHideCategoryBadges:s?e.minimalHideCategoryBadges!==!1:!0,minimalHideTags:s?e.minimalHideTags!==!1:!0,lowEndOptimizationEnabled:e.lowEndOptimizationEnabled===!0,previewEnabled:e.previewEnabled===!0,creditEnabled:e.creditEnabled!==!1,base64Enabled:e.base64Enabled!==!1,previewClickMode:e.previewClickMode==="single"?"single":"double",maxLiveFrames:B(e.maxLiveFrames,1,10,v.maxLiveFrames),maxOpenTabs:B(e.maxOpenTabs,5,50,v.maxOpenTabs),paneSizes:{sidebar:B(a.sidebar,160,360,v.paneSizes.sidebar),listRatio:Fe(a.listRatio,v.paneSizes.listRatio)},dualPaneSizes:{sidebar:B(r.sidebar,160,360,v.dualPaneSizes.sidebar),listRatio:Fe(r.listRatio,v.dualPaneSizes.listRatio)}}}function B(n,e,t,i){return typeof n=="number"&&Number.isFinite(n)?Math.round(Math.min(t,Math.max(e,n))):i}function Fe(n,e){return typeof n=="number"&&Number.isFinite(n)?Math.min(.7,Math.max(.3,n)):e}var ze=50;function _e(n,e){if(!n||typeof n!="object")return{...e};let t=n;return{sidebar:K(t.sidebar,160,360,e.sidebar),listRatio:ht(t.listRatio,e.listRatio)}}function ht(n,e){return typeof n=="number"&&Number.isFinite(n)?Math.min(.7,Math.max(.3,n)):e}function K(n,e,t,i){return typeof n=="number"&&Number.isFinite(n)?Math.round(Math.min(t,Math.max(e,n))):i}function bt(n){if(!n||typeof n!="object")return null;let e=n;return typeof e.id!="string"||typeof e.topicId!="string"||typeof e.url!="string"?null:{id:e.id,topicId:e.topicId,url:e.url,title:typeof e.title=="string"&&e.title.trim()?e.title:`\u4E3B\u9898 ${e.topicId}`,...typeof e.postNumber=="number"&&Number.isFinite(e.postNumber)?{postNumber:Math.max(1,Math.floor(e.postNumber))}:{},suspended:e.suspended===!0,lastActiveAt:K(e.lastActiveAt,0,Number.MAX_SAFE_INTEGER,0)}}function Ne(n,e){if(n.length<=ze)return n;let t=new Set(n.filter(i=>i.id!==e).sort((i,s)=>i.lastActiveAt-s.lastActiveAt).slice(0,n.length-ze).map(i=>i.id));return n.filter(i=>!t.has(i.id))}function U(n,e,t){return{schemaVersion:$,sessionId:n,listUrl:e,listScrollY:0,layoutMode:"native",paneSizes:{...v.paneSizes},dualPaneSizes:{...v.dualPaneSizes},tabs:[],activeTabId:null,secondaryTabIds:[],secondaryActiveTabId:null,updatedAt:t}}function me(n,e){if(!n||typeof n!="object")return e;let t=n;if(t.schemaVersion!==$||typeof t.sessionId!="string")return e;let i=Array.isArray(t.tabs)?t.tabs.map(bt).filter(c=>c!==null):[],s=Ne(Array.from(new Map(i.map(c=>[c.topicId,c])).values()),typeof t.activeTabId=="string"?t.activeTabId:""),a=new Set(s.map(c=>c.id)),r=Array.isArray(t.secondaryTabIds)?[...new Set(t.secondaryTabIds.filter(c=>typeof c=="string"&&a.has(c)))]:[],o=new Set(r),l=s.filter(c=>!o.has(c.id)),u=l.some(c=>c.id===t.activeTabId)?t.activeTabId:l.at(-1)?.id??null,h=r.includes(t.secondaryActiveTabId??"")?t.secondaryActiveTabId:r.at(-1)??null;return{schemaVersion:$,sessionId:t.sessionId,listUrl:typeof t.listUrl=="string"&&t.listUrl?t.listUrl:e.listUrl,listScrollY:K(t.listScrollY,0,1e7,0),layoutMode:t.layoutMode==="two"||t.layoutMode==="three"?t.layoutMode:"native",paneSizes:_e(t.paneSizes,e.paneSizes),dualPaneSizes:_e(t.dualPaneSizes,e.dualPaneSizes),tabs:s,activeTabId:u,secondaryTabIds:r,secondaryActiveTabId:h,updatedAt:K(t.updatedAt,0,Number.MAX_SAFE_INTEGER,e.updatedAt)}}function he(n,e,t){let i=n.tabs.find(o=>o.topicId===e.topicId),s=i?{...i,...e,suspended:!1,lastActiveAt:t}:{id:`topic-${e.topicId}`,topicId:e.topicId,url:e.url,title:e.title||`\u4E3B\u9898 ${e.topicId}`,...e.postNumber?{postNumber:e.postNumber}:{},suspended:!1,lastActiveAt:t},a=Ne(i?n.tabs.map(o=>o.topicId===e.topicId?s:o):[...n.tabs,s],s.id),r=n.secondaryTabIds.includes(s.id);return{...n,tabs:a,activeTabId:r?n.activeTabId:s.id,secondaryActiveTabId:r?s.id:n.secondaryActiveTabId,updatedAt:t}}function Ue(n,e,t){let i=n.tabs.findIndex(h=>h.id===e);if(i<0)return n;let s=n.tabs.filter(h=>h.id!==e),a=n.secondaryTabIds.filter(h=>h!==e),r=new Set(a),o=s.filter(h=>!r.has(h.id)),l=n.activeTabId===e?o[Math.min(i,o.length-1)]?.id??o.at(-1)?.id??null:n.activeTabId,u=n.secondaryActiveTabId===e?a.at(-1)??null:n.secondaryActiveTabId;return{...n,tabs:s,activeTabId:l,secondaryTabIds:a,secondaryActiveTabId:u,updatedAt:t}}function gt(n,e){if(!n)return e;try{return JSON.parse(n)}catch{return e}}var j=class{backend=typeof GM_getValue=="function"&&typeof GM_setValue=="function"&&typeof GM_deleteValue=="function"?"userscript":"local";get(e,t){if(this.backend==="userscript")try{return GM_getValue(e,t)}catch{return t}try{return gt(window.localStorage.getItem(e),t)}catch{return t}}set(e,t){if(this.backend==="userscript"){try{GM_setValue(e,t)}catch{}return}try{window.localStorage.setItem(e,JSON.stringify(t))}catch{}}remove(e){if(this.backend==="userscript"){try{GM_deleteValue(e)}catch{}return}try{window.localStorage.removeItem(e)}catch{}}};function ft(n=window.sessionStorage){try{let e=n.getItem(G);if(e)return e;let t=globalThis.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`;return n.setItem(G,t),t}catch{return"ephemeral"}}function qe(n=window.performance){try{return n.getEntriesByType("navigation")[0]?.type==="reload"}catch{return!1}}var vt=5*6e4,yt=720*60*6e4,wt=8;function be(n){let e=n.get(W,null);return Array.isArray(e)?e.filter(i=>!!(i&&typeof i=="object"&&typeof i.closedAt=="number"&&i.session&&typeof i.session.sessionId=="string")):[e,n.get(Y,null)].filter(i=>!!(i&&typeof i=="object"&&typeof i.sessionId=="string")).map(i=>({session:i,closedAt:i.updatedAt||0}))}function Ve(n,e){n.set(W,e),n.remove(Y)}function ge(n){let e=n.get(pe,[]);return Array.isArray(e)?e.filter(t=>!!(t&&typeof t=="object"&&typeof t.sessionId=="string"&&typeof t.updatedAt=="number")):[]}function fe(n,e){n.set(pe,e)}function Be(n,e,t){let i=ge(n).filter(s=>s.sessionId!==e);i.push({sessionId:e,updatedAt:t}),fe(n,i)}function $e(n,e=window.sessionStorage,t=Date.now(),i=!1){let s=ft(e),a=n.get(`${M}${s}`,null);if(!i&&a&&t>=a.updatedAt&&t-a.updatedAt<vt){s=De();try{e.setItem(G,s)}catch{}}let r={sessionId:s,ownerId:De()};return n.set(`${M}${s}`,{ownerId:r.ownerId,updatedAt:t}),r}function Ge(n,e,t=Date.now()){let i=n.get(`${M}${e.sessionId}`,null);i?.ownerId===e.ownerId&&(n.set(`${M}${e.sessionId}`,{...i,updatedAt:t}),Be(n,e.sessionId,t))}function Ye(n,e){n.get(`${M}${e.sessionId}`,null)?.ownerId===e.ownerId&&n.remove(`${M}${e.sessionId}`)}function De(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`}function We(n){return R(n.get(ue,v))}function ve(n,e){n.set(ue,R(e))}function Ke(n,e,t,i){let s=n.get(`${N}${e}`,null);return s==null?null:me(s,U(e,t,i))}function je(n,e,t,i){let s=be(n).filter(r=>r.session.sessionId!==e).sort((r,o)=>r.closedAt-o.closedAt).at(-1);if(!s)return null;let a=me(s.session,U(e,t,i));return a.sessionId!==e&&xt(n,a.sessionId),D(n),a.tabs.length===0?null:{...a,sessionId:e}}function I(n,e){n.set(`${N}${e.sessionId}`,e),Be(n,e.sessionId,e.updatedAt)}function Xe(n,e,t=Date.now()){if(e.tabs.length===0)return;let i=be(n).filter(s=>s.session.sessionId!==e.sessionId);i.push({session:e,closedAt:t}),Ve(n,i.sort((s,a)=>s.closedAt-a.closedAt).slice(-wt))}function Je(n,e){let t=be(n).filter(i=>i.session.sessionId!==e);t.length>0?Ve(n,t):D(n)}function ye(n,e=Date.now()){let t=[];for(let i of ge(n))e-i.updatedAt>=yt?(n.remove(`${N}${i.sessionId}`),n.remove(`${M}${i.sessionId}`)):t.push(i);fe(n,t)}function D(n){n.remove(W),n.remove(Y)}function xt(n,e){n.remove(`${N}${e}`),n.remove(`${M}${e}`),fe(n,ge(n).filter(t=>t.sessionId!==e))}var St=new Set(["/","/latest","/new","/unseen","/hot","/top","/read","/posted","/bookmarks","/categories","/tags"]);function Tt(n){return n==="linux.do"||n.endsWith(".linux.do")?!0:globalThis.window?.__LDU_TEST_MODE__===!0&&(n==="localhost"||n==="127.0.0.1")}function f(n,e="https://linux.do/"){let t;try{t=new URL(n,e)}catch{return null}if(!Tt(t.hostname))return null;let i=t.pathname.split("/").filter(Boolean),s=i.findIndex(o=>o==="t"||o==="n");if(s<0)return null;let a=i.findIndex((o,l)=>l>s&&/^\d+$/.test(o));if(a<0)return null;let r=i[a+1]&&/^\d+$/.test(i[a+1])?Number(i[a+1]):void 0;return{url:t,topicId:i[a],...r?{postNumber:r}:{}}}function C(n,e="https://linux.do/"){let t;try{t=new URL(n,e)}catch{return"other"}return f(t.href)?"topic":t.pathname==="/chat"||t.pathname.startsWith("/chat/")?"chat":t.pathname==="/search"||t.pathname.startsWith("/search/")?"search":t.pathname.startsWith("/u/")?"user":St.has(t.pathname)||t.pathname.startsWith("/c/")||t.pathname.startsWith("/tag/")?"list":"other"}function we(n,e="https://linux.do/"){let t=C(n,e);return t==="list"||t==="search"}function xe(n,e){let t=f(n,e),i=f(e,e);return!!(t&&(!i||t.topicId!==i.topicId))}var Ee="linuxdo-ultimate:view:v1:";var Qe=`${Ee}session-id`,X=`${Ee}lock-index`;var Te=class{constructor(e){this.options=e;this.fetcher=e.fetcher??fetch.bind(globalThis),this.now=e.now??Date.now,this.timeoutMs=e.timeoutMs??8e3}fetcher;now;timeoutMs;memoryLocks=new Map;async track(e,t,i,s=!1){if(e.url.origin!=="https://linux.do")return{status:"skipped"};let a=this.claim(e,t,s);if(!a)return{status:"skipped"};if(this.options.beforeClaimConfirmation?.(),!this.owns(e,a))return{status:"skipped"};let r=[];try{let o=await this.sendPageview(e,i);if(r.push(o),o.confirmed)return this.complete(e,a,t,"confirmed"),{status:"confirmed",confirmedBy:"pageview"}}catch{r.push({ok:!1,confirmed:!1})}try{let o=await this.sendTopicJson(e);if(r.push(o),o.confirmed)return this.complete(e,a,t,"confirmed"),{status:"confirmed",confirmedBy:"topic-json"}}catch{r.push({ok:!1,confirmed:!1})}return r.some(o=>o.ok)?(this.complete(e,a,t,"accepted"),{status:"accepted"}):(this.clearIfOwned(e,a),{status:"failed"})}stateKey(e){return`${Ee}${e.url.hostname}:${e.topicId}`}readState(e){let t=this.stateKey(e);try{return JSON.parse(this.options.storage.getItem(t)??"null")??this.memoryLocks.get(t)??null}catch{return this.memoryLocks.get(t)??null}}claim(e,t,i){this.cleanupExpiredLocks();let s=this.readState(e);if(!i&&s?.expiresAt&&s.expiresAt>this.now())return null;let a=globalThis.crypto?.randomUUID?.()??`${this.now()}-${Math.random().toString(36).slice(2)}`;return this.writeState(this.stateKey(e),{status:"pending",token:a,source:t,expiresAt:this.now()+3e4}),this.owns(e,a)?a:null}complete(e,t,i,s){this.writeState(this.stateKey(e),{status:s,token:t,source:i,expiresAt:this.now()+288e5})}clearIfOwned(e,t){this.readState(e)?.token===t&&this.removeState(this.stateKey(e))}owns(e,t){return this.readState(e)?.token===t}writeState(e,t){this.memoryLocks.set(e,t);try{this.options.storage.setItem(e,JSON.stringify(t));let i=this.readLockIndex().filter(s=>s.key!==e);i.push({key:e,expiresAt:t.expiresAt}),this.options.storage.setItem(X,JSON.stringify(i))}catch{}}removeState(e){this.memoryLocks.delete(e);try{this.options.storage.removeItem(e),this.options.storage.setItem(X,JSON.stringify(this.readLockIndex().filter(t=>t.key!==e)))}catch{}}readLockIndex(){try{let e=JSON.parse(this.options.storage.getItem(X)??"[]");return Array.isArray(e)?e.filter(t=>!!(t&&typeof t=="object"&&typeof t.key=="string"&&typeof t.expiresAt=="number")):[]}catch{return[]}}cleanupExpiredLocks(){let e=this.now();for(let[s,a]of this.memoryLocks)a.expiresAt<=e&&this.memoryLocks.delete(s);let t=this.readLockIndex(),i=t.filter(s=>{if(s.expiresAt>e)return!0;try{this.options.storage.removeItem(s.key)}catch{}return!1});if(i.length!==t.length)try{this.options.storage.setItem(X,JSON.stringify(i))}catch{}}commonHeaders(){let e={Accept:"application/json, text/javascript, */*; q=0.01","X-Requested-With":"XMLHttpRequest","Discourse-Present":"true"},t=this.options.csrfToken();return t&&(e["X-CSRF-Token"]=t),e}async sendPageview(e,t){let i={...this.commonHeaders(),"Discourse-Track-View-Deferred":"true","Discourse-Track-View-Topic-Id":e.topicId,"Discourse-Track-View-Url":e.url.href,"Discourse-Track-View-Referrer":t,"Discourse-Track-View-Session-Id":this.options.trackingSessionId()},s=await this.fetchWithTimeout(`${e.url.origin}${this.basePath()}/pageview`,{method:"POST",credentials:"same-origin",cache:"no-store",keepalive:!0,headers:i});return this.readAttempt(s)}async sendTopicJson(e){let t=await this.fetchWithTimeout(`${e.url.origin}${this.basePath()}/t/${e.topicId}.json?track_visit=true&forceLoad=true`,{method:"GET",credentials:"same-origin",cache:"no-store",headers:{...this.commonHeaders(),"Discourse-Track-View":"true","Discourse-Track-View-Topic-Id":e.topicId}});return this.readAttempt(t)}basePath(){let e=this.options.basePath?.()??"";return e?`/${e.replace(/^\/+|\/+$/g,"")}`:""}readAttempt(e){let t=e.headers.get("x-discourse-trackview"),i=e.headers.get("x-discourse-browserpageview");return{ok:e.ok,confirmed:t==="1"||i==="1"}}async fetchWithTimeout(e,t){let i=new AbortController,s=globalThis.setTimeout(()=>i.abort(),this.timeoutMs);try{return await this.fetcher(e,{...t,signal:i.signal})}finally{globalThis.clearTimeout(s)}}};function J(){return new Te({storage:window.localStorage,csrfToken:()=>document.querySelector('meta[name="csrf-token"]')?.content??"",trackingSessionId:()=>Et(window.sessionStorage,document.querySelector('meta[name="discourse-track-view-session-id"]')?.content??""),basePath:()=>document.querySelector('meta[name="discourse-base-uri"]')?.content??""})}var Se="";function Et(n,e="",t=kt){if(e)return e;try{let i=n.getItem(Qe);if(i)return i;let s=t();return n.setItem(Qe,s),s}catch{return Se||(Se=t()),Se}}function kt(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`}var F={ownerOnlyEnabled:!1,minimalHidePosters:!1,minimalHideNotices:!1,minimalHideCategoryBadges:!1,minimalHideTags:!1,lowEndOptimizationEnabled:!1};function O(n,e){let t=JSON.stringify(e);n.dataset.lduPageTools!==t&&(n.dataset.lduPageTools=t)}function Ze(n,e,t){q(n,"lduHidePosters",t.minimalHidePosters),q(n,"lduHideNotices",t.minimalHideNotices),q(n,"lduHideCategoryBadges",t.minimalHideCategoryBadges),q(n,"lduHideTags",t.minimalHideTags),q(n,"lduLowEnd",t.lowEndOptimizationEnabled&&Lt(e))}function z(n,e){return n.ownerOnlyEnabled===e.ownerOnlyEnabled&&n.minimalHidePosters===e.minimalHidePosters&&n.minimalHideNotices===e.minimalHideNotices&&n.minimalHideCategoryBadges===e.minimalHideCategoryBadges&&n.minimalHideTags===e.minimalHideTags&&n.lowEndOptimizationEnabled===e.lowEndOptimizationEnabled&&n.base64Enabled!==!1==(e.base64Enabled!==!1)}function q(n,e,t){let i=String(t);n.dataset[e]!==i&&(n.dataset[e]=i)}function Lt(n){let e=n.hardwareConcurrency,t=n.deviceMemory;return Number.isFinite(e)&&e<=4||typeof t=="number"&&Number.isFinite(t)&&t<=4}var V=class{constructor(e,t,i,s){this.container=e;this.maxLiveFrames=t;this.onMessage=i;this.onSuspend=s;this.liveLimit=Math.max(1,t)}frames=new Map;liveLimit;previewConfig={enabled:!1,clickMode:"double"};pageToolsConfig={...F};activeTabId=null;setMaxLiveFrames(e){this.liveLimit=Math.max(1,Math.min(10,Math.floor(e))),this.suspendOverflow("")}setPreviewConfig(e){if(!Mt(this.previewConfig,e)){this.previewConfig={...e};for(let t of this.frames.values())this.sendPreviewConfig(t.iframe)}}setPageToolsConfig(e){if(!z(this.pageToolsConfig,e)){this.pageToolsConfig={...e};for(let t of this.frames.values())O(t.iframe,this.pageToolsConfig),this.sendPageToolsConfig(t.iframe)}}activate(e,t){let i=this.activeTabId!==e.id,s=this.ensureRecord(e,t);if(i){for(let[a,r]of this.frames)this.setFrameActive(r,a===e.id);this.activeTabId=e.id}return this.suspendOverflow(e.id),s.iframe}prepare(e,t){let i=this.activeTabId&&this.frames.has(this.activeTabId)?this.activeTabId:"",s=this.ensureRecord(e,t);return e.id!==i&&this.setFrameActive(s,!1),this.suspendOverflow(i),s.iframe}ensureRecord(e,t){let i=this.frames.get(e.id);if(i){i.lastUsedAt=t,i.iframe.title=e.title;let s=new URL(e.url,document.baseURI).href;i.iframe.src!==s&&i.reportedUrl!==s&&(i.reportedUrl=null,i.loaded=!1,i.configSentForDocument=!1,i.iframe.src=s)}else{let s=document.createElement("iframe");s.className="ldu-topic-frame",s.name=`ldu-topic:${e.id}`,s.title=e.title,s.dataset.tabId=e.id,O(s,this.pageToolsConfig);let a=()=>{let r=this.frames.get(e.id);!r||r.iframe!==s||(r.loaded=!0,r.configSentForDocument=!1,this.sendLifecycleState(r),this.sendInitialConfigs(r),this.flushCommands(r),this.onMessage({type:"ldu:frame-ready",tabId:e.id,url:s.src},s))};s.addEventListener("load",a),s.src=e.url,i={iframe:s,lastUsedAt:t,reportedUrl:null,loaded:!1,softFrozen:!0,commands:[],loadListener:a,configSentForDocument:!1},this.frames.set(e.id,i),this.container.append(s)}return i}handleMessage(e){let t=e.data;if(!t||!["ldu:frame-state","ldu:frame-ready","ldu:frame-interaction","ldu:bookmark-result","ldu:preview-open","ldu:preview-dismiss","ldu:topic-open","ldu:list-navigate"].includes(t.type??"")||typeof t.tabId!="string")return;let i=this.frames.get(t.tabId);if(!(!i||e.source!==i.iframe.contentWindow)){if((t.type==="ldu:frame-state"||t.type==="ldu:frame-ready")&&t.url)try{i.reportedUrl=new URL(t.url,document.baseURI).href}catch{i.reportedUrl=null}t.type==="ldu:frame-ready"&&(i.loaded=!0,this.sendLifecycleState(i),this.sendInitialConfigs(i),this.flushCommands(i)),this.onMessage(t,i.iframe)}}remove(e){let t=this.frames.get(e);t&&(t.commands=[],t.iframe.removeEventListener("load",t.loadListener),t.iframe.remove(),this.frames.delete(e),this.activeTabId===e&&(this.activeTabId=null))}sendCommand(e,t){let i=this.frames.get(e);if(i){if(!i.loaded){i.commands.push(t);return}i.iframe.contentWindow?.postMessage(t,location.origin)}}getFrame(e){return this.frames.get(e)?.iframe??null}reload(e){let t=this.frames.get(e);if(!t)return!1;t.loaded=!1,t.reportedUrl=null,t.configSentForDocument=!1;try{t.iframe.contentWindow?.location.reload()}catch{t.iframe.src=t.iframe.src}return!0}detach(e){let t=this.frames.get(e);return t?(t.iframe.removeEventListener("load",t.loadListener),t.iframe.remove(),this.frames.delete(e),this.activeTabId===e&&(this.activeTabId=null),t):null}adopt(e,t,i){let s=t.iframe;s.name=`ldu-topic:${e.id}`,s.dataset.tabId=e.id,s.title=e.title,O(s,this.pageToolsConfig);let a=()=>{let l=this.frames.get(e.id);!l||l.iframe!==s||(l.loaded=!0,l.configSentForDocument=!1,this.sendInitialConfigs(l),this.flushCommands(l),this.onMessage({type:"ldu:frame-ready",tabId:e.id,url:s.src},s))};s.addEventListener("load",a);let r=new URL(e.url,document.baseURI).href;s.src!==r&&t.reportedUrl!==r&&(s.src=r);let o={...t,lastUsedAt:i,reportedUrl:null,loaded:!1,loadListener:a,configSentForDocument:!1};return this.frames.set(e.id,o),this.container.append(s),this.activate(e,i),s}destroy(){for(let e of this.frames.values())e.commands=[],e.iframe.removeEventListener("load",e.loadListener),e.iframe.remove();this.frames.clear(),this.activeTabId=null}sendPreviewConfig(e){e.contentWindow?.postMessage({type:"ldu:preview-config",...this.previewConfig},location.origin)}sendPageToolsConfig(e){e.contentWindow?.postMessage({type:"ldu:page-tools-config",...this.pageToolsConfig},location.origin)}sendInitialConfigs(e){e.configSentForDocument||(e.configSentForDocument=!0,this.sendPreviewConfig(e.iframe),this.sendPageToolsConfig(e.iframe))}setFrameActive(e,t){let i=String(!t);e.iframe.getAttribute("aria-hidden")!==i&&e.iframe.setAttribute("aria-hidden",i);let s=t?0:-1;e.iframe.tabIndex!==s&&(e.iframe.tabIndex=s);let a=!t;e.softFrozen!==a&&(e.softFrozen=a,e.loaded&&this.sendLifecycleState(e))}sendLifecycleState(e){e.iframe.contentWindow?.postMessage({type:"ldu:frame-lifecycle",active:!e.softFrozen},location.origin)}flushCommands(e){let t=e.commands.splice(0);for(let i of t)e.iframe.contentWindow?.postMessage(i,location.origin)}suspendOverflow(e){for(;this.frames.size>this.liveLimit;){let i=[...this.frames.entries()].filter(([r])=>r!==e).sort(([,r],[,o])=>r.lastUsedAt-o.lastUsedAt)[0];if(!i)return;let[s,a]=i;a.commands=[],a.iframe.removeEventListener("load",a.loadListener),a.iframe.remove(),this.frames.delete(s),this.activeTabId===s&&(this.activeTabId=null),this.onSuspend(s)}}};function Mt(n,e){return n.enabled===e.enabled&&n.clickMode===e.clickMode}var Q=class{constructor(e,t,i){this.container=e;this.frameId=t;this.onMessage=i}iframe=null;reportedUrl="";frameConfig={enabled:!1,clickMode:"double",pageTools:{...F}};configSentForDocument=!1;restoreScrollY=0;restoreTimer=null;restoreDeadline=0;mount(e){if(!this.iframe){let s=document.createElement("iframe");s.className="ldu-list-frame",s.name=`ldu-list:${this.frameId}`,s.title="\u5E16\u5B50\u5217\u8868\u548C\u7AD9\u5185\u9875\u9762",s.dataset.frameId=this.frameId,O(s,this.frameConfig.pageTools),s.addEventListener("load",()=>{this.configSentForDocument=!1,this.sendInitialConfigs(s),this.onMessage({type:"ldu:list-ready",frameId:this.frameId,url:s.src},s)}),this.iframe=s,this.container.append(s)}let i=(this.resolveSameOrigin(e)??new URL("/",location.href)).href;return this.iframe.src!==i&&this.reportedUrl!==i&&(this.reportedUrl="",this.configSentForDocument=!1,this.iframe.src=i),this.iframe.src||(this.iframe.src=i),this.iframe}navigate(e){let t=this.resolveSameOrigin(e);if(!t)return;if(!this.iframe){this.mount(t.href);return}let i=t.href;this.iframe.src===i||this.reportedUrl===i||(this.reportedUrl="",this.configSentForDocument=!1,this.iframe.src=i)}restoreScroll(e){!this.iframe?.contentWindow||e<=0||(this.restoreScrollY=e,this.restoreDeadline=Date.now()+5e3,this.attemptScrollRestore())}getElement(){return this.iframe}setConfig(e){let t=this.frameConfig.enabled!==e.enabled||this.frameConfig.clickMode!==e.clickMode,i=e.pageTools?{...e.pageTools}:this.frameConfig.pageTools,s=!z(this.frameConfig.pageTools,i);this.frameConfig={...this.frameConfig,...e,pageTools:i},this.iframe&&(t&&this.sendPreviewConfig(this.iframe),s&&(O(this.iframe,this.frameConfig.pageTools),this.sendPageToolsConfig(this.iframe)))}handleMessage(e){let t=e.data;if(!(!t||!["ldu:list-ready","ldu:list-visual-ready","ldu:list-state","ldu:list-interaction","ldu:list-topic-open","ldu:list-navigate","ldu:list-preview-open","ldu:list-preview-dismiss"].includes(t.type??""))&&!(t.frameId!==this.frameId||!this.iframe||e.source!==this.iframe.contentWindow||e.origin!==location.origin)){if((t.type==="ldu:list-ready"||t.type==="ldu:list-visual-ready"||t.type==="ldu:list-state")&&t.url)try{this.reportedUrl=new URL(t.url,document.baseURI).href}catch{this.reportedUrl=""}t.type==="ldu:list-ready"&&this.sendInitialConfigs(this.iframe),this.onMessage(t,this.iframe)}}sendPreviewConfig(e){e.contentWindow?.postMessage({type:"ldu:preview-config",...this.frameConfig},location.origin)}sendPageToolsConfig(e){e.contentWindow?.postMessage({type:"ldu:page-tools-config",...this.frameConfig.pageTools},location.origin)}sendInitialConfigs(e){this.configSentForDocument||(this.configSentForDocument=!0,this.sendPreviewConfig(e),this.sendPageToolsConfig(e))}resolveSameOrigin(e){try{let t=new URL(e,document.baseURI);return t.origin===location.origin&&/^https?:$/.test(t.protocol)?t:null}catch{return null}}attemptScrollRestore(){let e=this.iframe,t=this.restoreScrollY;if(!(!e?.contentWindow||t<=0)){if(this.restoreTimer!==null&&window.clearTimeout(this.restoreTimer),e.contentWindow.scrollTo({top:t,behavior:"instant"}),Math.abs(e.contentWindow.scrollY-t)<=2||Date.now()>=this.restoreDeadline){this.restoreScrollY=0,this.restoreDeadline=0,this.restoreTimer=null;return}this.restoreTimer=window.setTimeout(()=>{this.restoreTimer=null,this.iframe===e&&this.attemptScrollRestore()},100)}}destroy(){this.restoreTimer!==null&&window.clearTimeout(this.restoreTimer),this.restoreTimer=null,this.restoreScrollY=0,this.restoreDeadline=0,this.iframe?.remove(),this.iframe=null,this.reportedUrl="",this.configSentForDocument=!1}};var Z=class{constructor(e,t,i){this.session=e;this.maxTabs=t;this.onChange=i}getSession(){return this.session}getTabs(){return this.session.tabs.map(e=>({...e}))}get(e){let t=this.session.tabs.find(i=>i.id===e);return t?{...t}:null}getPrimaryTabs(){let e=new Set(this.session.secondaryTabIds);return this.session.tabs.filter(t=>!e.has(t.id)).map(t=>({...t}))}getSecondaryTabs(){let e=new Map(this.session.tabs.map(t=>[t.id,t]));return this.session.secondaryTabIds.flatMap(t=>e.has(t)?[{...e.get(t)}]:[])}getActive(){return this.session.tabs.find(e=>e.id===this.session.activeTabId)??null}getSecondaryActive(){return this.session.tabs.find(e=>e.id===this.session.secondaryActiveTabId)??null}setSessionFields(e,t,i=!0){this.session={...this.session,...e,updatedAt:t},i&&this.emit()}open(e,t){if(this.session=he(this.session,e,t),this.session.tabs.length>this.maxTabs){let i=this.session.tabs.filter(r=>r.id!==this.session.activeTabId),s=this.session.tabs.length-this.maxTabs,a=new Set(i.slice(0,s).map(r=>r.id));this.session={...this.session,tabs:this.session.tabs.filter(r=>!a.has(r.id))}}return this.repairPanelOwnership(),this.emit(),this.getActive()}openSecondary(e,t){this.session=he(this.session,e,t);let i=this.session.tabs.find(s=>s.topicId===e.topicId);return this.session.secondaryTabIds.includes(i.id)||(this.session={...this.session,secondaryTabIds:[...this.session.secondaryTabIds,i.id],secondaryActiveTabId:i.id,activeTabId:this.session.activeTabId===i.id?this.getPrimaryTabs().find(s=>s.id!==i.id)?.id??null:this.session.activeTabId}),this.repairPanelOwnership(),this.emit(),{...i}}activate(e,t){return this.getPrimaryTabs().some(i=>i.id===e)?(this.session={...this.session,activeTabId:e,tabs:this.session.tabs.map(i=>i.id===e?{...i,lastActiveAt:t,suspended:!1}:i),updatedAt:t},this.emit(),this.getActive()):null}activateSecondary(e,t){return this.session.secondaryTabIds.includes(e)?(this.session={...this.session,secondaryActiveTabId:e,tabs:this.session.tabs.map(i=>i.id===e?{...i,lastActiveAt:t,suspended:!1}:i),updatedAt:t},this.emit(),this.getSecondaryActive()):null}moveToSecondary(e,t,i=!0){if(!this.session.tabs.some(o=>o.id===e))return null;if(this.session.secondaryTabIds.includes(e))return this.activateSecondary(e,t);let s=this.getPrimaryTabs(),a=s.findIndex(o=>o.id===e),r=s.filter(o=>o.id!==e);return this.session={...this.session,secondaryTabIds:[...this.session.secondaryTabIds,e],secondaryActiveTabId:e,activeTabId:this.session.activeTabId===e?r[Math.min(a,r.length-1)]?.id??null:this.session.activeTabId,tabs:this.session.tabs.map(o=>o.id===e?{...o,lastActiveAt:t,suspended:!1}:o),updatedAt:t},i&&this.emit(),this.getSecondaryActive()}mergeSecondaryIntoPrimary(e,t=!0){if(this.session.secondaryTabIds.length===0)return;let i=this.session.secondaryActiveTabId;this.session={...this.session,activeTabId:this.session.activeTabId??i,secondaryTabIds:[],secondaryActiveTabId:null,updatedAt:e},t&&this.emit()}closeOthersInPane(e,t){let i=this.session.secondaryTabIds.includes(e),a=(i?this.getSecondaryTabs():this.getPrimaryTabs()).filter(o=>o.id!==e).map(o=>o.id);if(a.length===0)return[];let r=new Set(a);return this.session={...this.session,tabs:this.session.tabs.filter(o=>!r.has(o.id)),activeTabId:i?this.session.activeTabId:e,secondaryTabIds:this.session.secondaryTabIds.filter(o=>!r.has(o)),secondaryActiveTabId:i?e:this.session.secondaryActiveTabId,updatedAt:t},this.emit(),a}reorderInPane(e,t,i,s){if(e===t)return!1;let a=this.session.secondaryTabIds.includes(e);if(a!==this.session.secondaryTabIds.includes(t))return!1;let r=(a?this.getSecondaryTabs():this.getPrimaryTabs()).map(m=>m.id),o=[...r],l=r.indexOf(e);if(l<0||!r.includes(t))return!1;r.splice(l,1);let u=r.indexOf(t);if(r.splice(u+(i==="after"?1:0),0,e),r.every((m,g)=>m===o[g]))return!1;let h=new Set(r),c=new Map(this.session.tabs.map(m=>[m.id,m])),d=0;return this.session={...this.session,tabs:this.session.tabs.map(m=>h.has(m.id)?c.get(r[d++]):m),secondaryTabIds:a?r:this.session.secondaryTabIds,updatedAt:s},this.emit(),!0}update(e,t,i,s=!0){this.session={...this.session,tabs:this.session.tabs.map(a=>a.id===e?{...a,...t,lastActiveAt:i}:a),updatedAt:i},s&&this.emit()}suspend(e,t){this.update(e,{suspended:!0},t)}close(e,t,i=!0){this.session=Ue(this.session,e,t),i&&this.emit()}clear(e){this.session.tabs.length!==0&&(this.session={...this.session,tabs:[],activeTabId:null,secondaryTabIds:[],secondaryActiveTabId:null,updatedAt:e},this.emit())}emit(){this.onChange?.(this.session)}repairPanelOwnership(){let e=new Set(this.session.tabs.map(a=>a.id)),t=this.session.secondaryTabIds.filter(a=>e.has(a)),i=new Set(t),s=this.session.tabs.filter(a=>!i.has(a.id));this.session={...this.session,secondaryTabIds:t,activeTabId:this.session.activeTabId&&s.some(a=>a.id===this.session.activeTabId)?this.session.activeTabId:s.at(-1)?.id??null,secondaryActiveTabId:this.session.secondaryActiveTabId&&t.includes(this.session.secondaryActiveTabId)?this.session.secondaryActiveTabId:t.at(-1)??null}}};var et=[["\u5F00\u53D1\u8C03\u4F18","rgb(50, 195, 195)"],["\u56FD\u4EA7\u66FF\u4EE3","rgb(209, 44, 37)"],["\u8D44\u6E90\u835F\u8403","rgb(18, 168, 157)"],["\u6587\u6863\u5171\u5EFA","rgb(156, 182, 196)"],["\u8DF3\u86A4\u5E02\u573A","rgb(237, 32, 123)"],["\u79EF\u5206\u4E50\u56ED","rgb(252, 202, 68)"],["\u975E\u6211\u83AB\u5C5E","rgb(168, 198, 254)"],["\u8BFB\u4E66\u6210\u8BD7","rgb(224, 217, 0)"],["\u626C\u5E06\u8D77\u822A","rgb(255, 152, 56)"],["\u524D\u6CBF\u5FEB\u8BAF","rgb(187, 143, 206)"],["\u7F51\u7EDC\u8BB0\u5FC6","rgb(247, 148, 29)"],["\u798F\u5229\u7F8A\u6BDB","rgb(228, 87, 53)"],["\u641E\u4E03\u637B\u4E09","rgb(58, 181, 74)"],["\u793E\u533A\u5B75\u5316","rgb(255, 187, 0)"],["\u866B\u6D1E\u5E7F\u573A","rgb(255, 0, 247)"],["\u8FD0\u8425\u53CD\u9988","rgb(128, 130, 129)"],["\u6DF1\u6D77\u5E7D\u57DF","rgb(69, 183, 209)"]];function ke(n){let e=n.replace(/\s+-\s+LINUX DO(?:\s.*)?$/i,""),t=e.lastIndexOf(" - "),i=e.slice(t<0?0:t+3).trim(),s=et.find(([a])=>i===a||i.startsWith(`${a} /`)||i.startsWith(`${a},`));return s?{name:s[0],color:s[1]}:null}var It={settings:'<path d="M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z"/><path d="M19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06-2.83 2.83-.06-.06a1.7 1.7 0 0 0-1.88-.34 1.7 1.7 0 0 0-1.03 1.56V21h-4v-.08A1.7 1.7 0 0 0 8.95 19.4a1.7 1.7 0 0 0-1.88.34l-.06.06-2.83-2.83.06-.06A1.7 1.7 0 0 0 4.6 15a1.7 1.7 0 0 0-1.56-1.03H3v-4h.08A1.7 1.7 0 0 0 4.6 8.95a1.7 1.7 0 0 0-.34-1.88l-.06-.06 2.83-2.83.06.06A1.7 1.7 0 0 0 8.95 4.6 1.7 1.7 0 0 0 9.98 3.04V3h4v.08A1.7 1.7 0 0 0 15 4.6a1.7 1.7 0 0 0 1.88-.34l.06-.06 2.83 2.83-.06.06a1.7 1.7 0 0 0-.34 1.88 1.7 1.7 0 0 0 1.56 1.03H21v4h-.08A1.7 1.7 0 0 0 19.4 15Z"/>',close:'<path d="M18 6 6 18M6 6l12 12"/>',split:'<rect x="3" y="4" width="7" height="16" rx="1.5"/><rect x="14" y="4" width="7" height="16" rx="1.5"/><path d="M12 9v6m-3-3h6"/>',external:'<path d="M15 4h5v5M20 4l-9 9"/><path d="M18 13v5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h5"/>',refresh:'<path d="M20 6v5h-5"/><path d="M19 11a7 7 0 1 0 1 5"/>',copy:'<rect x="8" y="8" width="11" height="11" rx="2"/><path d="M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"/>',code:'<path d="m8 9-3 3 3 3M16 9l3 3-3 3M14 6l-4 12"/>',bookmark:'<path d="M6 4.8A1.8 1.8 0 0 1 7.8 3h8.4A1.8 1.8 0 0 1 18 4.8V21l-6-4-6 4V4.8Z"/>',"bookmark-filled":'<path class="ldu-symbol-fill" d="M6 4.8A1.8 1.8 0 0 1 7.8 3h8.4A1.8 1.8 0 0 1 18 4.8V21l-6-4-6 4V4.8Z"/>',"close-others":'<rect x="3" y="5" width="13" height="12" rx="2"/><path d="M8 3h10a3 3 0 0 1 3 3v8"/><path d="m18 16 4 4m0-4-4 4"/>',list:'<path d="M9 6h11M9 12h11M9 18h11"/><path d="M4 6h.01M4 12h.01M4 18h.01"/>',"tab-list":'<path d="m4 6 5 6-5 6M11 6h9M11 12h9M11 18h9"/>',check:'<path d="m5 12 4 4L19 6"/>',maximize:'<path d="M8 3H3v5M16 3h5v5M8 21H3v-5M16 21h5v-5"/>',restore:'<path d="M9 9H4V4M15 9h5V4M9 15H4v5M15 15h5v5"/>',trash:'<path d="M4 7h16M9 7V4h6v3M7 7l1 14h8l1-14M10 11v6M14 11v6"/>',"thumbs-up":'<path d="M7 10v11M15 5.9 14 10h5.8a2 2 0 0 1 1.9 2.6l-2.3 7A2 2 0 0 1 17.5 21H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h2.8a2 2 0 0 0 1.8-1.1L12 2a3.1 3.1 0 0 1 3 3.9Z"/>',"thumbs-down":'<path d="M17 14V3M9 18.1 10 14H4.2a2 2 0 0 1-1.9-2.6l2.3-7A2 2 0 0 1 6.5 3H20a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-2.8a2 2 0 0 0-1.8 1.1L12 22a3.1 3.1 0 0 1-3-3.9Z"/>',github:'<path d="M15 22v-3.9c.04-1-.35-1.76-.8-2.2 2.6-.3 5.3-1.27 5.3-5.75A4.5 4.5 0 0 0 18.3 7c.12-.3.52-1.53-.12-3.18 0 0-.98-.31-3.2 1.2a11.1 11.1 0 0 0-5.83 0c-2.22-1.51-3.2-1.2-3.2-1.2C5.3 5.47 5.7 6.7 5.82 7a4.5 4.5 0 0 0-1.2 3.15c0 4.47 2.72 5.46 5.32 5.75-.34.3-.64.82-.75 1.59-.67.3-2.37.82-3.42-.98 0 0-.62-1.13-1.8-1.21M9 19c-2.25 1-2.5-1-3.5-1.5"/>',gift:'<rect x="3" y="8" width="18" height="4" rx="1"/><path d="M12 8v13M5 12v9h14v-9M7.5 8C6.1 8 5 7 5 5.7S6.1 3.5 7.5 3.5C9.6 3.5 12 8 12 8s2.4-4.5 4.5-4.5C17.9 3.5 19 4.4 19 5.7S17.9 8 16.5 8"/>'};function E(n,e=20){return`<svg class="ldu-symbol ldu-symbol-${n}" viewBox="0 0 24 24" width="${e}" height="${e}" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${It[n]}</svg>`}function A(n,e,t=20){n.innerHTML=E(e,t)}function tt(n,e,t=18){let i=n.createElement("span");return i.className="ldu-context-icon",i.innerHTML=E(e,t),i}var _=new WeakMap;function it(n){n.querySelectorAll(":scope > .ldu-tab-item[data-tab-id]").forEach(e=>{e.classList.remove("is-dragging","is-drop-before","is-drop-after"),e.setAttribute("aria-grabbed","false"),e.style.transform=""}),n.classList.remove("is-reordering")}function Pt(n){let e=document.createElement("div");e.className="ldu-tab-item",e.setAttribute("role","presentation"),e.setAttribute("aria-grabbed","false"),e.addEventListener("contextmenu",r=>{let o=e.dataset.tabId,l=_.get(n);!o||!l||(r.preventDefault(),r.stopPropagation(),l.callbacks.onContextMenu?.(o,r.clientX,r.clientY))}),e.addEventListener("auxclick",r=>{if(r.button!==1)return;let o=e.dataset.tabId,l=_.get(n);!o||!l||(r.preventDefault(),r.stopPropagation(),l.callbacks.onClose(o))});let t=document.createElement("button");t.type="button",t.className="ldu-tab-button",t.setAttribute("role","tab");let i=document.createElement("span");i.className="ldu-tab-glyph",A(i,"list",15);let s=document.createElement("span");s.className="ldu-tab-title",t.append(i,s),t.addEventListener("click",()=>{let r=e.dataset.tabId,o=_.get(n);r&&o&&o.callbacks.onActivate(r)}),t.addEventListener("keydown",r=>{let o=e.dataset.tabId,l=_.get(n);if(!o||!l)return;let u=[...n.querySelectorAll(":scope > .ldu-tab-item[data-tab-id]")],h=u.findIndex(P=>P.dataset.tabId===o);if(h<0)return;let c=n.classList.contains("is-vertical"),d=c?"ArrowUp":"ArrowLeft",m=c?"ArrowDown":"ArrowRight",g=h;if(r.key===d||r.key===m)r.preventDefault(),g=(h+(r.key===m?1:-1)+u.length)%u.length;else if(r.key==="Home"||r.key==="End")r.preventDefault(),g=r.key==="Home"?0:u.length-1;else if(r.key==="Delete"){r.preventDefault(),l.callbacks.onClose(o);return}else return;let k=u[g];k?.dataset.tabId&&(l.callbacks.onActivate(k.dataset.tabId),k.querySelector(".ldu-tab-button")?.focus())});let a=document.createElement("button");return a.type="button",a.className="ldu-tab-close",a.draggable=!1,A(a,"close",16),a.title="\u5173\u95ED\u5E16\u5B50\u6807\u7B7E",a.addEventListener("click",r=>{r.stopPropagation();let o=e.dataset.tabId,l=_.get(n);o&&l&&l.callbacks.onClose(o)}),e.append(t,a),e}function Ct(n,e,t,i){let s=e.id===t,a=e.title||`\u4E3B\u9898 ${e.topicId}`;n.dataset.tabId=e.id,n.draggable=!!i.onReorder,n.classList.toggle("is-active",s),n.title=`${e.title}
${e.url}`;let r=ke(e.title);n.dataset.categoryGroup=r?.name??"other",r?n.style.setProperty("--ldu-tab-category-color",r.color):n.style.removeProperty("--ldu-tab-category-color");let o=n.querySelector(".ldu-tab-button");o.querySelector(".ldu-tab-title").textContent=a,o.id=`ldu-tab-${e.id}`,o.setAttribute("aria-selected",String(s)),o.tabIndex=s?0:-1,o.setAttribute("aria-label",`\u6253\u5F00 ${a}`),n.querySelector(".ldu-tab-close")?.setAttribute("aria-label",`\u5173\u95ED ${a}`)}function At(n){let e=document.createElement("div");e.className="ldu-tab-group-header",e.dataset.groupKey=n,e.setAttribute("role","presentation");let t=document.createElement("span");t.className="ldu-tab-group-marker";let i=document.createElement("span");return i.className="ldu-tab-group-label",e.append(t,i),e}function Le(n,e,t,i,s={}){_.set(n,{tabs:e,callbacks:i}),it(n);let a=s.orientation==="vertical"?"vertical":"horizontal",r=a==="vertical"&&s.groupByCategory===!0;n.classList.toggle("is-vertical",a==="vertical"),n.classList.toggle("is-grouped",r),n.setAttribute("aria-orientation",a),n.classList.toggle("is-category-colors-enabled",s.colorizeTabs!==!1);let o=null,l=null,u=null,h=null,c=()=>{it(n),o=null,l=null,u=null,h=null},d=p=>{if(!o||!u)return;let b=u.find(y=>y.tabId===o);if(!b)return;let S=u.filter(y=>y.tabId!==o),w=S.filter(y=>p>=y.center).length;if(w===h)return;h=w;let T=w;for(let y of u){let L=0;T>b.index&&y.index>b.index&&y.index<=T?L=-b.shift:T<b.index&&y.index>=T&&y.index<b.index&&(L=b.shift),y.item.style.transform=L?a==="vertical"?`translate3d(0, ${L}px, 0)`:`translate3d(${L}px, 0, 0)`:"",y.item.classList.remove("is-drop-before","is-drop-after")}let x=T===0?S[0]:S[T-1];if(!x){l=null;return}let H=T===0?"before":"after";x.item.classList.add(H==="before"?"is-drop-before":"is-drop-after"),l={tabId:x.tabId,position:H}};n.ondragstart=p=>{if(!i.onReorder||!(p.target instanceof Element)||p.target.closest(".ldu-tab-close")){p.preventDefault();return}let b=p.target.closest(".ldu-tab-item[data-tab-id]");if(!b?.dataset.tabId)return;o=b.dataset.tabId;let S=b.dataset.categoryGroup,w=[...n.querySelectorAll(".ldu-tab-item[data-tab-id]")].filter(x=>!r||x.dataset.categoryGroup===S),T=w.map(x=>x.getBoundingClientRect());if(u=w.map((x,H)=>{let y=T[H],L=T[H+1],ce=T[H-1],Ae=a==="vertical"?y.top:y.left,pt=a==="vertical"?y.bottom:y.right,He=a==="vertical"?y.height:y.width,Re=L?a==="vertical"?L.top:L.left:null,Oe=ce?a==="vertical"?ce.bottom:ce.right:null,mt=Re!==null?Math.max(0,Re-pt):Oe!==null?Math.max(0,Ae-Oe):0;return{tabId:x.dataset.tabId,item:x,index:H,center:Ae+He/2,shift:He+mt}}),n.classList.add("is-reordering"),b.classList.add("is-dragging"),b.setAttribute("aria-grabbed","true"),p.dataTransfer?.setData("text/plain",o),p.dataTransfer){p.dataTransfer.effectAllowed="move";let x=b.getBoundingClientRect();p.dataTransfer.setDragImage(b,Math.max(0,p.clientX-x.left),Math.max(0,p.clientY-x.top))}},n.ondragover=p=>{if(!o||!u)return;p.preventDefault(),p.dataTransfer&&(p.dataTransfer.dropEffect="move");let b=a==="vertical"?p.clientY:p.clientX;Number.isFinite(b)&&d(b)},n.ondrop=p=>{if(!o||!u)return;p.preventDefault();let b=a==="vertical"?p.clientY:p.clientX;if(Number.isFinite(b)&&d(b),!l){c();return}let S=o,w=l;c(),i.onReorder?.(S,w.tabId,w.position)},n.ondragend=c;let m=new Set(e.map(p=>p.id)),g=new Map([...n.querySelectorAll(":scope > .ldu-tab-item[data-tab-id]")].map(p=>[p.dataset.tabId,p]));for(let[p,b]of g)m.has(p)||(b.remove(),g.delete(p));let k=e.map(p=>{let b=g.get(p.id)??Pt(n);return Ct(b,p,t,i),b}),P=new Map([...n.querySelectorAll(":scope > .ldu-tab-group-header[data-group-key]")].map(p=>[p.dataset.groupKey,p])),le=[];if(r){let p=new Map;e.forEach((b,S)=>{let w=ke(b.title),T=w?.name??"other",x=p.get(T)??{label:w?.name??"\u5176\u4ED6",color:w?.color??null,items:[]};x.items.push(k[S]),p.set(T,x)});for(let[b,S]of p){let w=P.get(b)??At(b);w.querySelector(".ldu-tab-group-label").textContent=`${S.label} ${S.items.length}`,S.color?w.style.setProperty("--ldu-tab-category-color",S.color):w.style.removeProperty("--ldu-tab-category-color"),le.push(w,...S.items),P.delete(b)}}else le.push(...k);P.forEach(p=>p.remove());let de=n.firstElementChild;for(let p of le)p!==de&&n.insertBefore(p,de),de=p.nextElementSibling}var st="linuxdo-ultimate-styles";var nt=`
...
`;function ee(n=document){let e=n.getElementById(st);if(e instanceof HTMLStyleElement)return e;let t=n.createElement("style");return t.id=st,t.textContent=Ht,(n.head??n.documentElement).append(t),t}var Rt=1100,Ot=1680;function Ft(n,e){return e<Rt?"native":n==="two"||n==="three"?n:e>=Ot?"three":"two"}var te=class{constructor(e){this.options=e;this.preference=e.preference,this.paneSizes={...e.paneSizes},this.dualPaneSizes={...e.dualPaneSizes??e.paneSizes},this.tabPresentation=e.tabPresentation??"horizontal",this.verticalTabsAutoCollapse=e.verticalTabsAutoCollapse!==!1}shell=null;panel=null;content=null;secondaryPanel=null;secondaryContent=null;listContent=null;preference;paneSizes;dualPaneSizes;tabPresentation;verticalTabsAutoCollapse;open=!1;secondaryOpen=!1;listHandoff=null;headerResizeObserver=null;resizeListener=()=>this.apply();mount(){ee();let e=document.querySelector("#main-outlet-wrapper"),t=document.querySelector("#main-outlet");if(!e||!t)return!1;if(this.shell)this.shell.parentElement!==document.body&&document.body.append(this.shell);else if(this.shell=this.createShell(),document.body.append(this.shell),this.panel=this.shell.querySelector("#ldu-topic-panel"),this.content=this.panel?.querySelector(".ldu-topic-content")??null,this.secondaryPanel=this.shell.querySelector("#ldu-secondary-topic-panel"),this.secondaryContent=this.secondaryPanel?.querySelector(".ldu-topic-content")??null,this.listContent=this.shell.querySelector(".ldu-list-content"),window.addEventListener("resize",this.resizeListener,{passive:!0}),typeof ResizeObserver<"u"){let i=document.querySelector(".d-header");i&&(this.headerResizeObserver=new ResizeObserver(()=>this.apply()),this.headerResizeObserver.observe(i))}return this.apply(),!0}destroy(){this.finishListHandoff(),window.removeEventListener("resize",this.resizeListener),this.headerResizeObserver?.disconnect(),this.headerResizeObserver=null,this.shell?.remove(),this.shell=null,this.panel=null,this.content=null,this.secondaryPanel=null,this.secondaryContent=null,this.listContent=null,this.open=!1,this.secondaryOpen=!1,document.body.classList.remove("ldu-layout-active","ldu-layout-two","ldu-layout-three","ldu-secondary-open","ldu-tabs-vertical","ldu-vertical-tabs-static"),document.documentElement.classList.remove("ldu-layout-two-root")}setOpen(e){this.open=e,this.apply()}setSecondaryOpen(e){this.secondaryOpen=e,this.apply()}setPreference(e){this.preference=e,this.apply()}setTabPresentation(e,t=this.verticalTabsAutoCollapse){this.tabPresentation=e,this.verticalTabsAutoCollapse=t,this.apply()}setTabInteractionLocked(e,t){(t==="secondary"?this.secondaryPanel:this.panel)?.querySelector(".ldu-topic-toolbar")?.classList.toggle("is-interaction-locked",e)}setPaneSizes(e,t=this.dualPaneSizes){this.paneSizes={...e},this.dualPaneSizes={...t},this.apply()}getContentElement(){return this.content}getSecondaryContentElement(){return this.secondaryContent}getListContentElement(){return this.listContent}getShellElement(){return this.shell}beginListHandoff(e){if(this.listHandoff||!this.listContent)return!1;let t=document.querySelector("#main-outlet"),i=t?.parentElement;return!t||!i||i===this.listContent?!1:(this.listHandoff={outlet:t,parent:i,nextSibling:t.nextSibling,scrollY:Math.max(0,e)},this.listContent.classList.add("is-native-handoff"),this.listContent.prepend(t),this.listContent.scrollTop=this.listHandoff.scrollY,!0)}finishListHandoff(){let e=this.listHandoff;return e?(this.listHandoff=null,e.nextSibling?.parentNode===e.parent?e.parent.insertBefore(e.outlet,e.nextSibling):e.parent.append(e.outlet),this.listContent?.classList.remove("is-native-handoff"),this.listContent&&(this.listContent.scrollTop=0),e.scrollY):null}getTabStripElement(){return this.panel?.querySelector(".ldu-tab-strip")??null}getSecondaryTabStripElement(){return this.secondaryPanel?.querySelector(".ldu-tab-strip")??null}getActionsElement(){return this.panel?.querySelector(".ldu-topic-actions")??null}getSecondaryActionsElement(){return this.secondaryPanel?.querySelector(".ldu-topic-actions")??null}getPanelElement(){return this.panel}getSecondaryPanelElement(){return this.secondaryPanel}getMode(){return this.open?Ft(this.preference,window.innerWidth):"native"}apply(){if(!this.panel||!this.secondaryPanel||!this.shell)return;this.syncHeaderHeight();let e=this.getMode(),t=e!=="native";this.panel.hidden=!t,this.secondaryPanel.hidden=!t||!this.secondaryOpen,this.shell.hidden=!t,document.body.classList.toggle("ldu-layout-active",t),document.body.classList.toggle("ldu-layout-two",e==="two"),document.body.classList.toggle("ldu-layout-three",e==="three"),document.documentElement.classList.toggle("ldu-layout-two-root",e==="two"),document.body.classList.toggle("ldu-secondary-open",t&&this.secondaryOpen);let i=t&&this.tabPresentation==="vertical";document.body.classList.toggle("ldu-tabs-vertical",i),document.body.classList.toggle("ldu-vertical-tabs-static",i&&!this.verticalTabsAutoCollapse);let s=this.getActivePaneSizes();document.documentElement.style.setProperty("--ldu-sidebar-width",`${s.sidebar}px`),document.documentElement.style.setProperty("--ldu-topic-track",`${1-s.listRatio}fr`),document.documentElement.style.setProperty("--ldu-topic-split-track",`${(1-s.listRatio)/2}fr`),document.documentElement.style.setProperty("--ldu-list-track",`${s.listRatio}fr`),this.updateSeparatorValues()}createPanel(e=!1){let t=document.createElement("section");return t.id=e?"ldu-secondary-topic-panel":"ldu-topic-panel",t.className=e?"ldu-secondary-topic-panel":"",t.hidden=!0,t.setAttribute("aria-label",e?"\u7B2C\u4E8C\u5E16\u5B50\u9605\u8BFB\u533A":"\u5E16\u5B50\u9605\u8BFB\u533A"),t.innerHTML=`
    ...
    `,e||(this.bindResizeHandle(t.querySelector(".ldu-resize-before"),"before"),this.bindResizeHandle(t.querySelector(".ldu-resize-after"),"after")),t}createShell(){let e=document.createElement("div");e.id="ldu-layout-shell",e.hidden=!0,e.setAttribute("aria-label","Linux Do \u5206\u5C4F\u5DE5\u4F5C\u533A");let t=document.createElement("div");return t.className="ldu-list-content",t.setAttribute("aria-label","\u975E\u9605\u8BFB\u9875\u533A\u57DF"),e.append(t,this.createPanel(),this.createPanel(!0)),e}bindResizeHandle(e,t){e instanceof HTMLElement&&(e.setAttribute("role","separator"),e.setAttribute("aria-orientation","vertical"),e.tabIndex=0,e.addEventListener("keydown",i=>{if(!(i instanceof KeyboardEvent)||!["ArrowLeft","ArrowRight","Home","End"].includes(i.key))return;i.preventDefault();let s=i.key==="ArrowLeft"?-1:i.key==="ArrowRight"?1:0,a=this.getMode(),r=this.secondaryOpen?"dual":"single",o=this.getActivePaneSizes();if(t==="before"&&a==="three"&&document.body.classList.contains("has-sidebar-page"))o.sidebar=i.key==="Home"?160:i.key==="End"?360:Math.min(360,Math.max(160,o.sidebar+s*12));else if(t==="after"&&a==="three"||t==="before"&&a==="two"){let l=a==="three"?-s:s;o.listRatio=i.key==="Home"?.3:i.key==="End"?.7:Me(o.listRatio+l*.02)}else return;this.apply(),this.options.onPaneSizesChange?.({...o},r)}),e.addEventListener("pointerdown",i=>{if(!(i instanceof PointerEvent)||i.button!==0)return;let s=i.clientX,a=this.secondaryOpen?"dual":"single",r=this.getActivePaneSizes(),o={...r};e.setPointerCapture(i.pointerId);let l=h=>{let c=h.clientX-s,d=this.getMode(),m=this.panel?.parentElement,g=Math.max(1,(m?.clientWidth??window.innerWidth)-r.sidebar);t==="after"&&d==="three"?r.listRatio=Me(o.listRatio-c/g):t==="before"&&d==="two"?r.listRatio=Me(o.listRatio+c/g):t==="before"&&d==="three"&&document.body.classList.contains("has-sidebar-page")&&(r.sidebar=Math.round(Math.min(360,Math.max(160,o.sidebar+c)))),this.apply()},u=()=>{e.removeEventListener("pointermove",l),e.removeEventListener("pointerup",u),e.removeEventListener("pointercancel",u),this.options.onPaneSizesChange?.({...r},a)};e.addEventListener("pointermove",l),e.addEventListener("pointerup",u),e.addEventListener("pointercancel",u)}))}updateSeparatorValues(){if(!this.panel)return;let e=this.getMode(),t=this.getActivePaneSizes(),i=this.panel.querySelector(".ldu-resize-before"),s=this.panel.querySelector(".ldu-resize-after"),a=(r,o,l,u)=>{r&&(r.setAttribute("aria-valuemin",String(l)),r.setAttribute("aria-valuemax",String(u)),r.setAttribute("aria-valuenow",String(o)))};e==="three"&&document.body.classList.contains("has-sidebar-page")?a(i,t.sidebar,160,360):a(i,Math.round(t.listRatio*100),30,70),a(s,Math.round(t.listRatio*100),30,70)}syncHeaderHeight(){let e=document.querySelector(".d-header");if(!e)return;let t=Math.ceil(e.getBoundingClientRect().height);t>0&&document.documentElement.style.setProperty("--ldu-header-height",`${t}px`)}getActivePaneSizes(){return this.secondaryOpen?this.dualPaneSizes:this.paneSizes}};function Me(n){return Math.round(Math.min(.7,Math.max(.3,n))*1e3)/1e3}var at="https://raw.githubusercontent.com/jzcangshu/linuxdo-ultimate/main/updates/latest.json",rt="linuxdo-ultimate:update-cache",ot="linuxdo-ultimate:update-attempt";function zt(n,e){let t=a=>{let r=a.trim().replace(/^v/i,"").match(/^(\d+)\.(\d+)\.(\d+)(?:[-+].*)?$/);return r?[Number(r[1]),Number(r[2]),Number(r[3])]:null},i=t(n),s=t(e);if(!i||!s)return 0;for(let a=0;a<i.length;a+=1){let r=i[a]??0,o=s[a]??0;if(r!==o)return r>o?1:-1}return 0}function _t(n){if(!n||typeof n!="object")throw new Error("\u66F4\u65B0\u6E05\u5355\u683C\u5F0F\u65E0\u6548");let e=n,t=typeof e.version=="string"?e.version:"",i=typeof e.publishedAt=="string"?e.publishedAt:"",s=typeof e.releaseUrl=="string"?e.releaseUrl:"",a=Array.isArray(e.changelog)?e.changelog.filter(o=>typeof o=="string").slice(0,8):[];if(e.schemaVersion!==1||!/^\d+\.\d+\.\d+(?:[-+].*)?$/.test(t)||!i||a.length===0)throw new Error("\u66F4\u65B0\u6E05\u5355\u5185\u5BB9\u4E0D\u5B8C\u6574");let r=new URL(s);if(r.protocol!=="https:"||r.hostname!=="github.com"||r.pathname!=="/jzcangshu/linuxdo-ultimate/releases/tag/v"+t.replace(/^v/i,""))throw new Error("\u66F4\u65B0\u6E05\u5355\u53D1\u5E03\u5730\u5740\u65E0\u6548");return{schemaVersion:1,version:t,publishedAt:i,releaseUrl:s,changelog:a}}function Nt(n){if(typeof GM_xmlhttpRequest=="function")return GM_xmlhttpRequest(n);let e=!1;return fetch(n.url,{headers:n.headers,signal:AbortSignal.timeout(n.timeout)}).then(async t=>{e||n.onload({status:t.status,responseText:await t.text()})}).catch(t=>{e||n.onerror(t)}),{abort:()=>{e=!0}}}function Ie(){try{if(typeof chrome<"u"){let n=chrome.runtime?.getManifest?.().version;if(n)return n}}catch{}try{if(typeof GM_info<"u"&&GM_info.script.version)return GM_info.script.version}catch{}return"0.0.0"}var ie=class{constructor(e,t=Nt,i=Ie()){this.storage=e;this.request=t;this.currentVersion=i}async check(e=!1){let t=Date.now(),i=await Promise.resolve(this.storage.get(rt,null));if(!e&&i?.checkedByVersion===this.currentVersion&&t-i.checkedAt<864e5)return this.compare(i.manifest);let s=await Promise.resolve(this.storage.get(ot,0));return!e&&s>0&&t-s<36e5?i?this.compare(i.manifest):{status:"current",version:this.currentVersion}:(this.storage.set(ot,t),new Promise(a=>{let r=o=>a({status:"error",message:o});this.request({method:"GET",url:e?`${at}?t=${t}`:at,headers:{Accept:"application/json"},timeout:1e4,onload:o=>{if(o.status<200||o.status>=300){r(`HTTP ${o.status}`);return}try{let l=_t(JSON.parse(o.responseText));this.storage.set(rt,{checkedAt:t,checkedByVersion:this.currentVersion,manifest:l}),a(this.compare(l))}catch(l){r(l instanceof Error?l.message:"\u66F4\u65B0\u6E05\u5355\u89E3\u6790\u5931\u8D25")}},onerror:()=>r("\u7F51\u7EDC\u8FDE\u63A5\u5931\u8D25"),ontimeout:()=>r("\u8BF7\u6C42\u8D85\u65F6")})}))}compare(e){return zt(e.version,this.currentVersion)>0?{status:"available",manifest:e}:{status:"current",version:this.currentVersion}}};var se=class{constructor(e,t,i){this.host=e;this.settings=t;this.callbacks=i}panel=null;toggleButton=null;updateStatusTimer=null;mount(){if(this.panel)return;let e=document.createElement("button");e.type="button",e.className="ldu-icon-button btn-flat no-text",A(e,"settings",20),e.title="\u5E03\u5C40\u4E0E\u529F\u80FD\u8BBE\u7F6E",e.setAttribute("aria-label","\u5E03\u5C40\u4E0E\u529F\u80FD\u8BBE\u7F6E"),e.setAttribute("aria-controls","ldu-settings-panel"),e.setAttribute("aria-expanded","false"),e.addEventListener("click",()=>{this.panel&&this.setPanelOpen(this.panel.hidden)}),this.toggleButton=e,this.host.append(e);let t=document.createElement("div");t.id="ldu-settings-panel",t.className="ldu-settings-panel ldu-settings-drawer",t.hidden=!0,t.setAttribute("role","dialog"),t.setAttribute("aria-label","\u5E03\u5C40\u4E0E\u529F\u80FD\u8BBE\u7F6E"),t.innerHTML=`
      <div class="dc-modal">
        <header class="dc-header">
          <h2 class="ldu-settings-heading">Linux Do <span class="ldu-brand-ultimate">Ultimate</span><span class="ldu-settings-version">v${Ie()}</span></h2>
    ...
    `,this.panel=t,this.host.append(t),this.sync(),t.querySelectorAll("[data-setting]").forEach(i=>{i.addEventListener("change",()=>this.readControl(i)),i.addEventListener("input",()=>this.readControl(i))}),t.querySelectorAll("[data-pills-setting] .dc-pill-btn").forEach(i=>{i.addEventListener("click",()=>this.readPill(i))}),t.querySelector(".ldu-settings-close")?.addEventListener("click",()=>this.setPanelOpen(!1)),t.querySelector(".ldu-settings-reset")?.addEventListener("click",()=>{window.confirm("\u786E\u5B9A\u8981\u6062\u590D\u5168\u90E8\u9ED8\u8BA4\u8BBE\u7F6E\u5417\uFF1F")&&(this.settings=structuredClone(v),this.sync(),this.callbacks.onChange({...this.settings}))}),t.querySelector(".ldu-settings-donate")?.addEventListener("click",()=>{let i=t.querySelector(".ldu-donate-menu");this.setDonationMenuOpen(!!i?.hidden)}),t.querySelector(".ldu-settings-update")?.addEventListener("click",()=>{this.callbacks.onCheckUpdates?.()}),t.querySelectorAll(".ldu-donate-menu a").forEach(i=>{i.addEventListener("click",()=>this.setDonationMenuOpen(!1))}),t.querySelector(".ldu-update-link")?.addEventListener("click",()=>{this.setUpdateMenuOpen(!1)}),document.addEventListener("pointerdown",i=>{!this.panel?.hidden&&!this.host.contains(i.target)&&this.setPanelOpen(!1)},!0),document.addEventListener("keydown",i=>{if(i.key!=="Escape")return;let s=this.panel?.querySelector(".ldu-donate-menu");s&&!s.hidden?this.setDonationMenuOpen(!1):this.panel?.querySelector(".ldu-update-menu")?.hidden===!1?this.setUpdateMenuOpen(!1):this.panel&&!this.panel.hidden&&(this.setPanelOpen(!1),this.toggleButton?.focus({preventScroll:!0}))},!0)}setSettings(e){this.settings=e,this.sync()}setUpdateState(e,t=!1){let i=this.panel?.querySelector(".ldu-settings-update"),s=this.panel?.querySelector(".ldu-update-menu"),a=this.panel?.querySelector(".ldu-update-summary"),r=this.panel?.querySelector(".ldu-update-link");if(!i||!s||!a||!r)return;this.updateStatusTimer!==null&&window.clearTimeout(this.updateStatusTimer),i.disabled=e.status==="checking";let o=e.status==="available";if(i.classList.toggle("ldu-update-available",o),this.toggleButton?.classList.toggle("ldu-update-available",o),e.status==="checking"){this.setUpdateButton(i,"\u68C0\u67E5\u4E2D..."),i.title="\u6B63\u5728\u68C0\u67E5\u66F4\u65B0",this.setUpdateMenuOpen(!1);return}if(e.status==="available"){this.setUpdateButton(i,`\u53D1\u73B0 v${e.manifest.version}`),i.title=`\u53D1\u73B0\u65B0\u7248\u672C v${e.manifest.version}`,a.replaceChildren();let l=document.createElement("div");l.className="ldu-update-header";let u=document.createElement("strong");u.className="ldu-update-title",u.textContent="\u53D1\u73B0\u65B0\u7248\u672C";let h=document.createElement("span");h.className="ldu-update-version",h.textContent=`v${e.manifest.version}`,l.append(u,h);let c=document.createElement("time");c.className="ldu-update-date",c.dateTime=e.manifest.publishedAt,c.textContent=`\u53D1\u5E03\u4E8E ${e.manifest.publishedAt}`;let d=document.createElement("ul");d.className="ldu-update-changelog",e.manifest.changelog.forEach(m=>{let g=document.createElement("li");g.textContent=m,d.append(g)}),a.append(l,c,d),r.href=e.manifest.releaseUrl,this.setUpdateMenuOpen(t);return}this.setUpdateButton(i,e.status==="current"?"\u5DF2\u662F\u6700\u65B0\u7248":"\u68C0\u67E5\u5931\u8D25"),i.title=e.status==="error"?e.message:"\u5F53\u524D\u5DF2\u662F\u6700\u65B0\u7248\u672C",this.setUpdateMenuOpen(!1),this.updateStatusTimer=window.setTimeout(()=>{this.setUpdateButton(i,"\u68C0\u67E5\u66F4\u65B0"),i.title="\u68C0\u67E5\u66F4\u65B0"},2500)}setUpdateButton(e,t){e.innerHTML=`${E("refresh",14)}${t}`}sync(){if(!this.panel)return;let e=this.panel.querySelector('[data-setting="tabsEnabled"]'),t=this.panel.querySelector('[data-setting="verticalTabsAutoCollapse"]'),i=this.panel.querySelector('[data-setting="groupVerticalTabs"]'),s=this.panel.querySelector('[data-setting="restoreSession"]'),a=this.panel.querySelector('[data-setting="colorizeTabs"]'),r=this.panel.querySelector('[data-setting="cleanModeEnabled"]'),o=this.panel.querySelector('[data-setting="minimalHidePosters"]'),l=this.panel.querySelector('[data-setting="minimalHideNotices"]'),u=this.panel.querySelector('[data-setting="minimalHideCategoryBadges"]'),h=this.panel.querySelector('[data-setting="minimalHideTags"]'),c=this.panel.querySelector('[data-setting="lowEndOptimizationEnabled"]'),d=this.panel.querySelector('[data-setting="base64Enabled"]'),m=this.panel.querySelector('[data-setting="previewEnabled"]'),g=this.panel.querySelector('[data-setting="creditEnabled"]'),k=this.panel.querySelector('[data-setting="maxLiveFrames"]'),P=this.panel.querySelector('[data-output="maxLiveFrames"]');e&&(e.checked=this.settings.tabsEnabled),t&&(t.checked=this.settings.verticalTabsAutoCollapse),i&&(i.checked=this.settings.groupVerticalTabs),s&&(s.checked=this.settings.restoreSession),a&&(a.checked=this.settings.colorizeTabs),r&&(r.checked=this.settings.cleanModeEnabled),o&&(o.checked=this.settings.minimalHidePosters),l&&(l.checked=this.settings.minimalHideNotices),u&&(u.checked=this.settings.minimalHideCategoryBadges),h&&(h.checked=this.settings.minimalHideTags),c&&(c.checked=this.settings.lowEndOptimizationEnabled),d&&(d.checked=this.settings.base64Enabled),m&&(m.checked=this.settings.previewEnabled),g&&(g.checked=this.settings.creditEnabled),k&&(k.value=String(this.settings.maxLiveFrames)),P&&(P.value=String(this.settings.maxLiveFrames)),this.syncPills("layoutPreference",this.settings.layoutPreference),this.syncPills("tabPresentation",this.settings.tabPresentation),this.syncPills("previewClickMode",this.settings.previewClickMode),this.syncDependencies()}readControl(e){let t=e.dataset.setting;if(!t||t==="schemaVersion"||t==="paneSizes"||t==="dualPaneSizes")return;let i;if(e instanceof HTMLInputElement&&e.type==="checkbox")i=e.checked;else if(e instanceof HTMLInputElement&&e.type==="range")i=Number(e.value);else if(e instanceof HTMLSelectElement)i=e.value;else return;this.settings={...this.settings,[t]:i};let s=this.panel?.querySelector(`[data-output="${t}"]`);s&&(s.value=String(i)),this.syncDependencies(),this.callbacks.onChange({[t]:i})}readPill(e){let i=e.closest("[data-pills-setting]")?.dataset.pillsSetting,s=e.dataset.val;!i||!s||i==="schemaVersion"||i==="paneSizes"||i==="dualPaneSizes"||(this.settings={...this.settings,[i]:s},this.syncPills(i,s),this.syncDependencies(),this.callbacks.onChange({[i]:s}))}syncPills(e,t){this.panel?.querySelectorAll(`[data-pills-setting="${e}"] .dc-pill-btn`).forEach(i=>{let s=i.dataset.val===t;i.classList.toggle("active",s),i.setAttribute("aria-pressed",String(s))})}syncDependencies(){this.panel&&this.panel.querySelectorAll("[data-depends-on]").forEach(e=>{let t=e.dataset.dependsOn,i=e.dataset.dependsValue,s=!!t&&(i===void 0?this.settings[t]===!0:String(this.settings[t])===i);e.hidden=!s})}setPanelOpen(e){this.panel&&(this.panel.hidden=!e,this.toggleButton?.setAttribute("aria-expanded",String(e)),e||(this.setDonationMenuOpen(!1),this.setUpdateMenuOpen(!1)))}setDonationMenuOpen(e){let t=this.panel?.querySelector(".ldu-donate-menu"),i=this.panel?.querySelector(".ldu-settings-donate");t&&(t.hidden=!e),i?.setAttribute("aria-expanded",String(e)),e&&this.setUpdateMenuOpen(!1)}setUpdateMenuOpen(e){let t=this.panel?.querySelector(".ldu-update-menu"),i=this.panel?.querySelector(".ldu-settings-update");if(t&&(t.hidden=!e),i?.setAttribute("aria-expanded",String(e)),e){let s=this.panel?.querySelector(".ldu-donate-menu"),a=this.panel?.querySelector(".ldu-settings-donate");s&&(s.hidden=!0),a?.setAttribute("aria-expanded","false")}}};var Ut=[[{action:"onMoveToSplit",key:"split",label:"\u5411\u65B0\u7684\u62C6\u5206\u89C6\u56FE\u4E2D\u6DFB\u52A0\u6807\u7B7E\u9875",icon:"split"},{action:"onOpenBrowserTab",key:"browser-tab",label:"\u5728\u65B0\u7684\u6D4F\u89C8\u5668\u6807\u7B7E\u9875\u4E2D\u6253\u5F00",icon:"external"}],[{action:"onReload",key:"reload",label:"\u91CD\u65B0\u52A0\u8F7D\u5F53\u524D\u5E16\u5B50",icon:"refresh"},{action:"onCopyLink",key:"copy",label:"\u590D\u5236\u94FE\u63A5",icon:"copy"}],[{action:"onBookmark",key:"bookmark",label:"\u6DFB\u52A0\u5230\u4E66\u7B7E",icon:"bookmark"}],[{action:"onCloseOthers",key:"close-others",label:"\u5173\u95ED\u5176\u4ED6\u6807\u7B7E\u9875",icon:"close-others"}]],ne=class{constructor(e){this.callbacks=e}root=null;onOutsidePointer=e=>{this.root?.contains(e.target)||this.close()};onKeyDown=e=>{e.key==="Escape"&&this.close()};activePane="primary";open(e,t,i,s=!1,a="primary"){this.close(),this.activePane=a;let r=document.createElement("div");r.className="ldu-tab-context-menu",r.setAttribute("role","menu"),r.setAttribute("aria-label","\u6807\u7B7E\u9875\u7BA1\u7406\u83DC\u5355");for(let[u,h]of Ut.entries()){if(u>0){let c=document.createElement("div");c.className="ldu-context-separator",c.setAttribute("role","separator"),r.append(c)}for(let c of h){let d=document.createElement("button");d.type="button",d.className="ldu-context-item",d.dataset.action=c.key,d.setAttribute("role","menuitem"),c.key==="split"&&s&&(d.disabled=!0),d.append(tt(document,c.icon));let m=document.createElement("span");if(m.className="ldu-context-label",m.textContent=c.label,d.append(m),c.shortcut){let g=document.createElement("span");g.className="ldu-context-shortcut",g.textContent=c.shortcut,d.append(g)}d.addEventListener("click",()=>{this.close(),this.callbacks[c.action](e)}),r.append(d)}}document.body.append(r),this.root=r,this.callbacks.onOpenChange?.(!0,a);let o=r.getBoundingClientRect(),l=8;r.style.left=`${Math.max(l,Math.min(t,window.innerWidth-o.width-l))}px`,r.style.top=`${Math.max(l,Math.min(i,window.innerHeight-o.height-l))}px`,document.addEventListener("pointerdown",this.onOutsidePointer,!0),document.addEventListener("keydown",this.onKeyDown,!0),r.querySelector("button:not(:disabled)")?.focus()}close(){let e=!!this.root;document.removeEventListener("pointerdown",this.onOutsidePointer,!0),document.removeEventListener("keydown",this.onKeyDown,!0),this.root?.remove(),this.root=null,e&&this.callbacks.onOpenChange?.(!1,this.activePane)}destroy(){this.close()}};var ae=class{constructor(e){this.options=e}api=null;loading=null;mount(){let e=this.ensureApi();e instanceof Promise}install(e){if(this.api||!this.options.isEnabled())return this.api;let t=e({isEnabled:this.options.isEnabled,clickMode:this.options.clickMode,...this.options.onClickModeChange?{onClickModeChange:this.options.onClickModeChange}:{},isPreviewableUrl:(i,s)=>this.isPreviewable(i,s)});return this.api=t??null,this.api}ensureApi(){if(this.api||!this.options.isEnabled())return this.api;if(this.loading)return this.loading;try{let e=this.options.loadPreviewer();return e instanceof Promise?(this.loading=e.then(t=>this.install(t)).catch(t=>(console.error("[Linux Do Ultimate] Preview runtime failed to load",t),null)).finally(()=>{this.loading=null}),this.loading):this.install(e)}catch(e){return console.error("[Linux Do Ultimate] Preview runtime failed to load",e),null}}close(){this.api?.close()}syncClickMode(){let e=this.ensureApi();e instanceof Promise?e.then(t=>t?.syncClickMode()):e?.syncClickMode()}openFromFrame(e,t,i){if(!this.options.isEnabled()||!this.isPreviewable(e,null))return;let s=t.getBoundingClientRect(),a=i??{left:0,bottom:0},r=l=>{!l||!this.options.isEnabled()||l.openFromFrame(e,{left:s.left+a.left,top:s.top+a.bottom,bottom:s.top+a.bottom})},o=this.ensureApi();o instanceof Promise?o.then(r):r(o)}isPreviewable(e,t){return!/^https?:/i.test(e)||f(e)?!1:t?t.closest(".d-header, .sidebar-wrapper, .ldu-topic-toolbar, .ldu-settings-panel")||t.closest("button, [role=button], .btn, .d-button, input, textarea, select")||t.matches(".lightbox")||t.querySelector("img, picture")?!1:!t.closest("img, picture, .lightbox-wrapper"):!0}};var Pe="linuxdo-ultimate:credit-cache:v1",Dt="linuxdo-ultimate:credit-refresh",re=class{constructor(e={}){this.options=e}host=null;button=null;value=null;tooltip=null;communityBalance=null;gamificationScore=null;username=null;tooltipContent="\u52A0\u8F7D\u4E2D...";timeoutId=null;inFlight=null;requestGeneration=0;activeRequestController=null;mounted=!1;enabled=!1;mount(e){this.mounted||!(this.options.isTopLevel?.()??window.self===window.top)||(this.mounted=!0,this.createWidget(),document.addEventListener("visibilitychange",()=>this.handleVisibilityChange()),this.ensureHost(),this.setEnabled(e))}ensureHost(){if(!this.host)return;let e=document.querySelector(".d-header-icons > .language-switcher");if(e)e.nextElementSibling!==this.host&&e.after(this.host);else{let t=document.querySelector(".d-header-icons");if(!t)return;this.host.parentElement!==t&&t.append(this.host)}this.enabled&&this.startUpdates()}setEnabled(e){if(!this.mounted){this.mount(e);return}if(this.enabled=e,this.host&&(this.host.hidden=!e),this.tooltip&&(this.tooltip.hidden=!0),!e){this.requestGeneration+=1,this.activeRequestController?.abort(),this.activeRequestController=null,this.inFlight=null,this.clearSchedule();return}this.ensureHost(),this.host?.isConnected&&this.startUpdates()}startUpdates(){!this.enabled||!this.isVisible()||this.inFlight||this.timeoutId!==null||this.fetchData(!1)}createWidget(){let e=document.createElement("li");e.className="header-dropdown-toggle ldu-credit-host";let t=document.createElement("button");t.type="button",t.className="btn no-text language-switcher-trigger btn-flat ldu-credit-button is-loading",t.title="Credit \u79EF\u5206\u6536\u5165\uFF0C\u70B9\u51FB\u5237\u65B0",t.setAttribute("aria-label","Credit \u79EF\u5206\u6536\u5165\uFF0C\u70B9\u51FB\u5237\u65B0"),t.setAttribute("aria-describedby","ldu-credit-tooltip");let i=document.createElement("span");i.className="ldu-credit-value",i.setAttribute("aria-live","polite"),i.textContent="\xB7\xB7\xB7",t.append(i),e.append(t);let s=document.createElement("div");s.id="ldu-credit-tooltip",s.className="ldu-credit-tooltip",s.hidden=!0,s.setAttribute("role","tooltip"),document.body.append(s);let a=()=>{if(!this.enabled)return;s.textContent=this.tooltipContent,s.hidden=!1;let o=t.getBoundingClientRect(),l=Math.max(8,Math.min(window.innerWidth-s.offsetWidth-8,o.right-s.offsetWidth));s.style.left=`${l}px`,s.style.top=`${o.bottom+6}px`},r=()=>{s.hidden=!0};t.addEventListener("mouseenter",a),t.addEventListener("mouseleave",r),t.addEventListener("focus",a),t.addEventListener("blur",r),t.addEventListener("click",()=>{this.setLoading("\u5237\u65B0\u4E2D..."),this.fetchData(!0)}),this.host=e,this.button=t,this.value=i,this.tooltip=s}fetchData(e){if(!this.enabled||!this.isVisible())return Promise.resolve();if(this.inFlight)return this.inFlight;let t=++this.requestGeneration,i=this.now(),s=new AbortController;this.activeRequestController=s;let a=(async()=>{try{let r=e?null:this.readSharedSnapshot(),o=r??await this.fetchSnapshotCoordinated(e,i,s.signal);if(!this.enabled||t!==this.requestGeneration)return;this.communityBalance=o.communityBalance,this.gamificationScore=o.gamificationScore,this.username=o.username,r||this.writeSharedSnapshot(o),this.updateDisplay()}catch(r){if(s.signal.aborted)return;console.error("[Linux Do Ultimate] LDC request failed",r),this.enabled&&t===this.requestGeneration&&this.showError()}})().finally(()=>{this.activeRequestController===s&&(this.activeRequestController=null),this.inFlight===a&&(this.inFlight=null),this.enabled&&this.isVisible()&&t===this.requestGeneration&&this.scheduleNext()});return this.inFlight=a,a}async fetchSnapshot(e){let t=await this.request("https://credit.linux.do/api/v1/oauth/user-info",e),i=t?.data?.["community-balance"]??t?.data?.community_balance,s=t?.data?.username??t?.data?.nickname,a=Number.parseFloat(String(i));if(!s||!Number.isFinite(a))throw new Error("invalid credit response");let r=await this.request(`https://linux.do/u/${encodeURIComponent(s)}.json`,e),o=Number.parseFloat(String(r?.user?.gamification_score));if(!Number.isFinite(o))throw new Error("invalid gamification response");return{communityBalance:a,gamificationScore:o,username:s,updatedAt:this.now()}}async fetchSnapshotCoordinated(e,t,i){let s=typeof navigator<"u"?navigator.locks:void 0;return s?s.request(Dt,{signal:i},async()=>{let a=this.readSharedSnapshot();if(a&&(!e||a.updatedAt>=t))return a;let r=await this.fetchSnapshot(i);return this.writeSharedSnapshot(r),r}):this.fetchSnapshot(i)}scheduleNext(){this.clearSchedule(),this.timeoutId=window.setTimeout(()=>{this.timeoutId=null,this.fetchData(!1)},3e5)}clearSchedule(){this.timeoutId!==null&&window.clearTimeout(this.timeoutId),this.timeoutId=null}handleVisibilityChange(){if(!this.isVisible()){this.clearSchedule();return}this.enabled&&this.startUpdates()}isVisible(){return this.options.isVisible?.()??document.visibilityState!=="hidden"}now(){return this.options.now?.()??Date.now()}readSharedSnapshot(){try{let e=localStorage.getItem(Pe);if(e===null)return null;let t=JSON.parse(e);return!t||this.now()-Number(t.updatedAt)>=6e4||!Number.isFinite(t.communityBalance)||!Number.isFinite(t.gamificationScore)||typeof t.username!="string"?(this.clearSharedSnapshot(),null):t}catch{return this.clearSharedSnapshot(),null}}clearSharedSnapshot(){try{localStorage.removeItem(Pe)}catch{}}writeSharedSnapshot(e){try{localStorage.setItem(Pe,JSON.stringify(e))}catch{}}updateDisplay(){if(this.communityBalance===null||this.gamificationScore===null||!this.value||!this.button)return;let e=this.gamificationScore-this.communityBalance;this.value.textContent=`${e>0?"+":""}${e.toFixed(2)}`,this.button.classList.remove("is-loading","is-positive","is-negative","is-neutral"),this.button.classList.add(e>0?"is-positive":e<0?"is-negative":"is-neutral"),this.tooltipContent=`\u4EC5\u4F9B\u53C2\u8003\uFF0C\u53EF\u80FD\u6709\u8BEF\u5DEE\uFF01
\u5F53\u524D\u5206: ${this.gamificationScore.toFixed(2)}
\u57FA\u51C6\u503C: ${this.communityBalance.toFixed(2)}`}setLoading(e){this.value&&(this.value.textContent="\xB7\xB7\xB7"),this.button?.classList.remove("is-positive","is-negative","is-neutral"),this.button?.classList.add("is-loading"),this.tooltipContent=e}showError(){this.value&&(this.value.textContent="!"),this.button?.classList.remove("is-loading","is-positive","is-neutral"),this.button?.classList.add("is-negative"),this.tooltipContent="\u8BF7\u6C42\u5931\u8D25\uFF0C\u8BF7\u786E\u8BA4\u5DF2\u767B\u5F55"}request(e,t){if(this.options.request)return this.options.request(e);let i=document.querySelector('meta[name="csrf-token"]')?.content,s={Accept:"application/json",...i?{"x-csrf-token":i}:{}};return e.startsWith(location.origin)?fetch(e,{credentials:"include",headers:s,signal:t}).then(a=>{if(!a.ok)throw new Error(String(a.status));return a.json()}).catch(a=>t.aborted?Promise.reject(a):this.requestWithUserscript(e,s,t)):this.requestWithUserscript(e,s,t)}requestWithUserscript(e,t,i){return new Promise((s,a)=>{if(typeof GM_xmlhttpRequest!="function"){a(new Error("GM_xmlhttpRequest is unavailable"));return}let r=!1,o=null,l=c=>{r||(r=!0,i.removeEventListener("abort",u),c())},u=()=>{try{o?.abort()}catch{}l(()=>a(new DOMException("Aborted","AbortError")))};if(i.aborted){u();return}i.addEventListener("abort",u,{once:!0});let h={method:"GET",url:e,withCredentials:!0,headers:{...t,Referer:"https://credit.linux.do/home"},timeout:1e4,onload:c=>{if(c.status!==200){l(()=>a(new Error(String(c.status))));return}try{let d=JSON.parse(c.responseText);l(()=>s(d))}catch(d){l(()=>a(d))}},onerror:c=>l(()=>a(c)),ontimeout:()=>l(()=>a(new Error("timeout")))};o=GM_xmlhttpRequest(h)})}};var oe=class{constructor(e={}){this.options=e;this.win=e.window??window,this.doc=e.document??document}config={...F};active=!0;stopped=!1;ownerInstaller=null;ownerController=null;ownerLoad=null;win;doc;setConfig(e){if(this.stopped)return;let t={...this.config,...e};z(this.config,t)||(this.config=t,this.applyStaticModes(),this.ownerController?.setConfig?.({ownerOnlyEnabled:t.ownerOnlyEnabled,base64Enabled:t.base64Enabled!==!1}),this.syncOwnerView())}setActive(e){this.stopped||this.active===e||(this.active=e,this.syncOwnerView())}stop(){this.stopped||(this.stopped=!0,this.ownerController?.stop(),this.ownerController=null,delete this.doc.documentElement.dataset.lduHidePosters,delete this.doc.documentElement.dataset.lduHideNotices,delete this.doc.documentElement.dataset.lduHideCategoryBadges,delete this.doc.documentElement.dataset.lduHideTags,delete this.doc.documentElement.dataset.lduLowEnd)}applyStaticModes(){Ze(this.doc.documentElement,this.win.navigator,this.config)}wantsOwnerView(){return this.active&&this.ownerViewConfigured()}ownerViewConfigured(){return this.options.allowOwnerView!==!1&&this.config.ownerOnlyEnabled&&typeof this.options.loadOwnerView=="function"}syncOwnerView(){if(!this.ownerViewConfigured()){this.ownerController?.stop(!0),this.ownerController=null;return}if(!this.active){this.ownerController?.setActive(!1);return}if(this.ownerController){this.ownerController.setActive(!0);return}if(this.ownerInstaller){this.installOwnerView(this.ownerInstaller);return}if(!this.ownerLoad)try{let e=this.options.loadOwnerView();if(!(e instanceof Promise)){this.ownerInstaller=e,this.installOwnerView(e);return}this.ownerLoad=e.then(t=>(this.ownerInstaller=t,this.wantsOwnerView()&&this.installOwnerView(t),t)).catch(t=>(console.error("[Linux Do Ultimate] Owner view runtime failed to load",t),null)).finally(()=>{this.ownerLoad=null})}catch(e){console.error("[Linux Do Ultimate] Owner view runtime failed to load",e)}}installOwnerView(e){!this.wantsOwnerView()||this.ownerController||(this.ownerController=e({window:this.win,document:this.doc,...this.options.isEmbedded!==void 0?{isEmbedded:this.options.isEmbedded}:{},...this.options.isSplitHost?{isSplitHost:this.options.isSplitHost}:{},base64Enabled:this.config.base64Enabled!==!1}),this.ownerController.setActive(!0))}};var qt=100,Vt=30*6e4,Bt=3e3;function lt(n={}){if(window.self!==window.top)return;let e=()=>new Ce(n).start();document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):e()}var Ce=class{constructor(e){this.options=e}storage=new j;settings=R(v);session;tabStore;layout;frames=null;secondaryFrames=null;listFrame=null;preview;settingsPanel;credit;settingsHost=null;routeTimer=null;persistTimer=null;lastRoute="";restoredTabsTracked=!1;trackedTopicKey="";topicTrackTimers=[];routeRetryTimer=null;routeRetryAttempts=0;hostMaintenanceTimer=null;hasRestoredSession=!1;sessionLease;leaseTimer=null;sessionMaintenanceTimer=null;tabContextMenu;listHandoffTimer=null;updateChecker=new ie(this.storage);updateCheckTimer=null;pageTools;start(){this.settings=We(this.storage),ee(),this.pageTools=new oe({isEmbedded:!1,isSplitHost:()=>document.body.classList.contains("ldu-layout-active"),allowOwnerView:!!f(location.href,location.href),...this.options.loadOwnerView?{loadOwnerView:this.options.loadOwnerView}:{}}),this.pageTools.setConfig(this.getPageToolsConfig()),this.preview=new ae({isEnabled:()=>this.settings.enabled&&this.settings.previewEnabled,clickMode:()=>this.settings.previewClickMode,onClickModeChange:a=>this.applySettings({previewClickMode:a}),loadPreviewer:this.options.loadPreviewer??(()=>Promise.reject(new Error("Preview runtime is unavailable")))}),this.preview.mount(),this.tabContextMenu=new ne({onMoveToSplit:a=>this.moveTabToSecondary(a),onOpenBrowserTab:a=>this.openTabInBrowser(a),onReload:a=>this.reloadTab(a),onCopyLink:a=>void this.copyTabLink(a),onBookmark:a=>this.bookmarkTab(a),onCloseOthers:a=>this.closeOtherTabs(a),onOpenChange:(a,r)=>this.layout.setTabInteractionLocked(a,r)}),this.sessionLease=$e(this.storage,window.sessionStorage,Date.now(),qe(window.performance));let e=this.sessionLease.sessionId;Je(this.storage,e),ye(this.storage),this.settings.restoreSession||D(this.storage);let t=U(e,location.href,Date.now());t.paneSizes={...this.settings.paneSizes},t.dualPaneSizes={...this.settings.dualPaneSizes};let i=Ke(this.storage,e,location.href,Date.now()),s=!i&&C(location.href)!=="topic"&&this.settings.restoreSession?je(this.storage,e,location.href,Date.now()):null;this.session=i??s??t,this.hasRestoredSession=!!s?.tabs.length,this.tabStore=new Z(this.session,this.settings.maxOpenTabs,a=>{this.session=a,I(this.storage,a),this.renderTabs()}),this.layout=new te({preference:this.settings.layoutPreference,paneSizes:this.session.paneSizes,dualPaneSizes:this.session.dualPaneSizes,tabPresentation:this.settings.tabPresentation,verticalTabsAutoCollapse:this.settings.verticalTabsAutoCollapse,onPaneSizesChange:(a,r)=>this.persistPaneSizes(a,r)}),this.mountSettings(),this.credit=new re,this.credit.mount(this.settings.enabled&&this.settings.creditEnabled),this.lastRoute=location.href,this.bindGlobalEvents(),this.leaseTimer=window.setInterval(()=>Ge(this.storage,this.sessionLease),3e4),this.sessionMaintenanceTimer=window.setInterval(()=>ye(this.storage),Vt),this.syncRoute(),window.__LDU_TEST_MODE__&&(window.__LDU_TEST_API__={openTopic:(a,r)=>{let o=f(a,location.href);o&&this.openTopic(o.topicId,o.url.href,r,o.postNumber)}})}bindGlobalEvents(){document.addEventListener("click",e=>this.handleTopicLinkClick(e),!0),window.addEventListener("message",e=>{this.frames?.handleMessage(e),this.secondaryFrames?.handleMessage(e),this.listFrame?.handleMessage(e)}),window.addEventListener("popstate",()=>this.scheduleRouteSync()),window.addEventListener("hashchange",()=>this.scheduleRouteSync()),window.addEventListener("pagehide",e=>this.handlePageHide(e),{capture:!0}),new MutationObserver(()=>{typeof window>"u"||typeof document>"u"||(this.hostMaintenanceTimer===null&&(this.hostMaintenanceTimer=window.setTimeout(()=>{this.hostMaintenanceTimer=null,this.ensureSettingsHost(),this.credit?.ensureHost()},100)),this.lastRoute!==location.href&&this.scheduleRouteSync())}).observe(document.documentElement,{childList:!0,subtree:!0})}dismissHostOverlays(){document.body.dispatchEvent(new MouseEvent("pointerdown",{bubbles:!0,cancelable:!0,button:0}))}handleUserMenuLink(e,t){if(!t.closest(".user-menu")||t.matches(".user-menu-tab, [role=tab]"))return!1;let i;try{i=new URL(t.href,location.href)}catch{return!1}if(i.origin!==location.origin||t.target==="_blank"||t.hasAttribute("download"))return!1;let s=f(i.href,location.href),a=!!this.layout.getShellElement()&&this.layout.getMode()!=="native";return!s&&!a?!1:(e.preventDefault(),e.stopImmediatePropagation(),this.dismissHostOverlays(),s?this.openTopic(s.topicId,s.url.href,t.textContent?.trim()||`\u4E3B\u9898 ${s.topicId}`,s.postNumber):this.navigateList(i.href),!0)}handleTopicLinkClick(e){if(!(e instanceof MouseEvent)||e.button!==0||e.ctrlKey||e.metaKey||e.shiftKey||e.altKey||!this.settings.enabled||!this.settings.tabsEnabled)return;let t=e.target,i=t instanceof Element?t.closest("a[href]"):null;if(!i||this.handleUserMenuLink(e,i))return;let s=null;try{s=new URL(i.href,location.href)}catch{}if(!!this.layout.getShellElement()&&this.layout.getMode()!=="native"&&s&&s.origin===location.origin&&C(s.href)==="chat"){e.preventDefault(),e.stopImmediatePropagation(),this.dismissHostOverlays(),this.navigateList(s.href);return}if(!i.closest("button, [role=button], .btn, .d-button, .post-controls, .actions, .topic-timeline, .no-track-view-patch")){if(C(location.href)==="topic"&&this.tabStore.getTabs().length===0){this.promoteDirectTopicNavigation(e,i);return}if(xe(i.href,location.href)){let r=f(i.href);if(!r)return;e.preventDefault(),e.stopImmediatePropagation(),this.openTopic(r.topicId,r.url.href,i.textContent?.trim()||`\u4E3B\u9898 ${r.topicId}`,r.postNumber);return}!this.layout.getShellElement()||this.layout.getMode()==="native"||s&&(s.origin!==location.origin||s.protocol==="javascript:"||i.target==="_blank"||i.hasAttribute("download")||(e.preventDefault(),e.stopImmediatePropagation(),this.navigateList(s.href)))}}openTopic(e,t,i,s,a="primary",r=!1){let o=this.tabStore.getTabs().length===0&&C(location.href)!=="topic"&&this.layout.getMode()==="native",l=o?window.scrollY:0;if(!this.layout.mount())return;o&&this.tabStore.setSessionFields({listUrl:location.href,listScrollY:l},Date.now(),!1),this.ensureFrames(),o&&this.layout.beginListHandoff(l)&&this.scheduleListHandoffFallback(),this.layout.setOpen(!0);let u={topicId:e,url:t,title:i,...s?{postNumber:s}:{}};a==="secondary"?this.tabStore.openSecondary(u,Date.now()):this.tabStore.open(u,Date.now()),r||this.ensureListFrame();let h=f(t);if(h){let c=J();c.track(h,"split-open",location.href).then(d=>{d.status==="failed"&&window.setTimeout(()=>void c.track(h,"manual-retry",location.href),1e4)})}}syncRoute(){this.routeTimer=null,this.lastRoute!==location.href&&(this.lastRoute=location.href);let e=C(location.href);if(this.settings.enabled&&this.settings.tabsEnabled&&(we(location.href)||this.tabStore.getTabs().length>0)){if(this.clearTopicTrackSchedule(),!this.layout.mount()){this.scheduleRouteMountRetry();return}this.routeRetryAttempts=0;let i=this.tabStore.getTabs().length>0;if(this.layout.setOpen(i),i){this.ensureFrames(),this.ensureListFrame(),this.tabStore.getSecondaryTabs().length>0&&(this.layout.setSecondaryOpen(!0),this.ensureSecondaryFrames());let s=this.tabStore.getActive();if(s&&(this.activateFrame(s,"primary"),this.hasRestoredSession&&!this.restoredTabsTracked)){this.restoredTabsTracked=!0;let r=f(s.url);r&&J().track(r,"restored-tab",location.href)}let a=this.tabStore.getSecondaryActive();a&&this.activateFrame(a,"secondary")}return}if(this.disposeSplitRuntime(),e==="topic"){let i=f(location.href);i&&this.scheduleTopicTracking(i.topicId,i.url.href)}else this.clearTopicTrackSchedule()}promoteDirectTopicNavigation(e,t){let i=f(location.href);if(!i)return;let s;try{s=new URL(t.href,location.href)}catch{return}if(s.origin!==location.origin)return;let a=C(s.href,location.href);if(a==="topic"&&f(s.href,location.href)?.topicId===i.topicId||t.target==="_blank"||t.hasAttribute("download"))return;let r=a==="topic"?new URL("/",location.href).href:s.href;if(this.layout.mount()){if(this.clearTopicTrackSchedule(),this.tabStore.setSessionFields({listUrl:r,listScrollY:0},Date.now(),!1),this.ensureFrames(),this.layout.setOpen(!0),e.preventDefault(),e.stopImmediatePropagation(),this.openTopic(i.topicId,i.url.href,this.currentTopicTitle(i.topicId),i.postNumber,"primary",!0),a==="topic"){let o=f(s.href,location.href);o&&this.openTopic(o.topicId,o.url.href,t.textContent?.trim()||`\u4E3B\u9898 ${o.topicId}`,o.postNumber,"primary",!0)}this.ensureListFrame(r)}}currentTopicTitle(e){return document.querySelector("#topic-title h1, .fancy-title")?.textContent?.trim()||document.title||`\u4E3B\u9898 ${e}`}scheduleRouteMountRetry(){this.routeRetryTimer!==null||this.routeRetryAttempts>=30||(this.routeRetryAttempts+=1,this.routeRetryTimer=window.setTimeout(()=>{this.routeRetryTimer=null,this.syncRoute()},100))}scheduleRouteSync(){this.routeRetryAttempts=0,this.routeTimer!==null&&window.clearTimeout(this.routeTimer),this.routeTimer=window.setTimeout(()=>this.syncRoute(),qt)}ensureListFrame(e){let t=this.layout.getListContentElement();if(!t)return;this.listFrame||(this.listFrame=new Q(t,this.session.sessionId,(r,o)=>this.handleListFrameMessage(r,o))),this.listFrame.setConfig({enabled:this.settings.enabled&&this.settings.previewEnabled,clickMode:this.settings.previewClickMode,pageTools:this.getPageToolsConfig()});let i=e??this.tabStore.getSession().listUrl,s;try{s=new URL(i||"/",location.href)}catch{s=new URL("/",location.href)}let a=s.origin!==location.origin||f(s.href,location.href)?new URL("/",location.href).href:s.href;this.listFrame.mount(a)}navigateList(e){let t;try{t=new URL(e,location.href)}catch{return}t.origin!==location.origin||f(t.href,location.href)||this.layout.mount()&&(this.tabStore.setSessionFields({listUrl:t.href,listScrollY:0},Date.now(),!1),I(this.storage,this.tabStore.getSession()),this.ensureListFrame(t.href),this.listFrame?.navigate(t.href))}handleListFrameMessage(e,t){if(e.type==="ldu:list-interaction"){this.dismissHostOverlays();return}if(e.type==="ldu:list-preview-open"){this.preview.openFromFrame(e.url??"",t,e.anchorRect);return}if(e.type==="ldu:list-preview-dismiss"){this.preview.close();return}if(e.type==="ldu:list-topic-open"){let o=e.url?f(e.url,location.href):null;if(!o)return;this.openTopic(o.topicId,o.url.href,e.topicTitle||`\u4E3B\u9898 ${o.topicId}`,o.postNumber);return}if(e.type==="ldu:list-navigate"&&e.url){this.navigateList(e.url);return}if(!e.url||f(e.url,location.href))return;let i=this.tabStore.getSession(),s=new URL(e.url,location.href).href,a=i.listUrl===s,r=a?i.listScrollY:0;if(this.tabStore.setSessionFields({listUrl:s,...e.type==="ldu:list-state"&&typeof e.scrollY=="number"?{listScrollY:e.scrollY}:a?{}:{listScrollY:0}},Date.now(),!1),e.type==="ldu:list-state"&&this.schedulePersist(),e.type==="ldu:list-ready"&&(this.listFrame?.restoreScroll(r),this.schedulePersist()),e.type==="ldu:list-visual-ready"){let o=this.finishListHandoff();o!==null&&this.listFrame?.restoreScroll(o),this.schedulePersist()}}ensureFrames(){let e=this.layout.getContentElement();!e||this.frames||(this.frames=new V(e,this.settings.maxLiveFrames,(t,i)=>this.handleFrameMessage(t,i,"primary"),t=>{this.tabStore.update(t,{suspended:!0},Date.now(),!1),this.schedulePersist()}),this.frames.setPreviewConfig({enabled:this.settings.enabled&&this.settings.previewEnabled,clickMode:this.settings.previewClickMode}),this.frames.setPageToolsConfig(this.getPageToolsConfig()),this.renderTabs())}ensureSecondaryFrames(){let e=this.layout.getSecondaryContentElement();!e||this.secondaryFrames||(this.secondaryFrames=new V(e,this.settings.maxLiveFrames,(t,i)=>this.handleFrameMessage(t,i,"secondary"),t=>{this.tabStore.update(t,{suspended:!0},Date.now(),!1),this.schedulePersist()}),this.secondaryFrames.setPreviewConfig({enabled:this.settings.enabled&&this.settings.previewEnabled,clickMode:this.settings.previewClickMode}),this.secondaryFrames.setPageToolsConfig(this.getPageToolsConfig()))}mountSettings(){if(this.settingsPanel)return;let e=document.createElement("li");e.className="ldu-settings-host",this.settingsHost=e,this.ensureSettingsHost(),this.settingsPanel=new se(e,this.settings,{onChange:t=>this.applySettings(t),onCheckUpdates:()=>this.checkForUpdates(!0)}),this.settingsPanel.mount(),this.updateCheckTimer=window.setTimeout(()=>{if(this.updateCheckTimer=null,document.visibilityState==="visible"){this.checkForUpdates(!1);return}document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&this.checkForUpdates(!1)},{once:!0})},2e4)}async checkForUpdates(e){e&&this.settingsPanel?.setUpdateState({status:"checking"});let t=await this.updateChecker.check(e);(e||t.status==="available")&&this.settingsPanel?.setUpdateState(t,e&&t.status==="available")}ensureSettingsHost(){if(!this.settingsHost)return;let e=document.querySelector(".d-header-icons")??document.querySelector(".d-header .contents")??document.body;this.settingsHost.parentElement!==e&&e.append(this.settingsHost)}getPageToolsConfig(){let e=this.settings.enabled&&this.settings.cleanModeEnabled;return{ownerOnlyEnabled:!0,minimalHidePosters:e&&this.settings.minimalHidePosters,minimalHideNotices:e&&this.settings.minimalHideNotices,minimalHideCategoryBadges:e&&this.settings.minimalHideCategoryBadges,minimalHideTags:e&&this.settings.minimalHideTags,lowEndOptimizationEnabled:this.settings.enabled&&this.settings.lowEndOptimizationEnabled,base64Enabled:this.settings.enabled&&this.settings.base64Enabled}}applySettings(e){this.settings=R({...this.settings,...e}),ve(this.storage,this.settings);let t=Object.keys(e);if(t.length>0&&t.every(o=>["verticalTabsAutoCollapse","tabPresentation","groupVerticalTabs","colorizeTabs"].includes(o))){(e.verticalTabsAutoCollapse!==void 0||e.tabPresentation!==void 0)&&this.layout.setTabPresentation(this.settings.tabPresentation,this.settings.verticalTabsAutoCollapse),this.settingsPanel?.setSettings(this.settings),(e.tabPresentation!==void 0||e.groupVerticalTabs!==void 0||e.colorizeTabs!==void 0)&&this.renderTabs(!1);return}if(this.layout.setPreference(this.settings.layoutPreference),this.layout.setTabPresentation(this.settings.tabPresentation,this.settings.verticalTabsAutoCollapse),this.pageTools?.setConfig(this.getPageToolsConfig()),(e.paneSizes||e.dualPaneSizes)&&(this.layout.setPaneSizes(this.settings.paneSizes,this.settings.dualPaneSizes),this.tabStore.setSessionFields({paneSizes:this.settings.paneSizes,dualPaneSizes:this.settings.dualPaneSizes},Date.now(),!1),I(this.storage,this.tabStore.getSession())),this.frames?.setMaxLiveFrames(this.settings.maxLiveFrames),this.secondaryFrames?.setMaxLiveFrames(this.settings.maxLiveFrames),this.frames?.setPreviewConfig({enabled:this.settings.enabled&&this.settings.previewEnabled,clickMode:this.settings.previewClickMode}),this.secondaryFrames?.setPreviewConfig({enabled:this.settings.enabled&&this.settings.previewEnabled,clickMode:this.settings.previewClickMode}),this.frames?.setPageToolsConfig(this.getPageToolsConfig()),this.secondaryFrames?.setPageToolsConfig(this.getPageToolsConfig()),this.listFrame?.setConfig({enabled:this.settings.enabled&&this.settings.previewEnabled,clickMode:this.settings.previewClickMode,pageTools:this.getPageToolsConfig()}),this.settingsPanel?.setSettings(this.settings),this.credit?.setEnabled(this.settings.enabled&&this.settings.creditEnabled),e.previewClickMode!==void 0&&this.preview.syncClickMode(),this.settings.enabled&&this.settings.previewEnabled&&this.preview.mount(),e.restoreSession===!1&&D(this.storage),(!this.settings.enabled||!this.settings.previewEnabled)&&this.preview.close(),(e.colorizeTabs!==void 0||e.tabPresentation!==void 0||e.groupVerticalTabs!==void 0)&&this.renderTabs(),!(this.settings.enabled&&this.settings.tabsEnabled&&(we(location.href)||this.tabStore.getTabs().length>0))){this.disposeSplitRuntime();return}if(!this.layout.mount())return;let a=this.tabStore.getActive(),r=this.tabStore.getTabs().length>0;if(this.layout.setOpen(r),r){this.ensureFrames(),this.ensureListFrame(),a&&this.activateFrame(a,"primary");let o=this.tabStore.getSecondaryActive();o&&(this.layout.setSecondaryOpen(!0),this.ensureSecondaryFrames(),this.activateFrame(o,"secondary"))}}persistPaneSizes(e,t){this.settings=R({...this.settings,...t==="dual"?{dualPaneSizes:e}:{paneSizes:e}}),ve(this.storage,this.settings),this.tabStore.setSessionFields(t==="dual"?{dualPaneSizes:this.settings.dualPaneSizes}:{paneSizes:this.settings.paneSizes},Date.now(),!1),I(this.storage,this.tabStore.getSession()),this.settingsPanel?.setSettings(this.settings)}scheduleTopicTracking(e,t){let i=e;if(this.trackedTopicKey===i)return;this.clearTopicTrackSchedule(),this.trackedTopicKey=i;let s=f(t);if(!s)return;let a=J();this.topicTrackTimers=[2500,1e4].map(r=>window.setTimeout(()=>{a.track(s,"browser-open",document.referrer)},r))}clearTopicTrackSchedule(){for(let e of this.topicTrackTimers)window.clearTimeout(e);this.topicTrackTimers=[],this.trackedTopicKey=""}activateFrame(e,t){let i=t==="secondary"?this.secondaryFrames:this.frames;if(!e||!i)return;i.activate(e,Date.now());let a=(t==="secondary"?this.layout.getSecondaryContentElement():this.layout.getContentElement())?.querySelector(".ldu-topic-empty");a&&(a.hidden=!0)}handleFrameMessage(e,t,i){let s=this.tabStore.get(e.tabId);if(!s)return;if(e.type==="ldu:frame-interaction"){this.dismissHostOverlays();return}if(e.type==="ldu:bookmark-result"){this.showActionToast(e.message||(e.ok?"\u5DF2\u6DFB\u52A0\u5230\u4E66\u7B7E":"\u6DFB\u52A0\u4E66\u7B7E\u5931\u8D25"),e.ok===!1);return}if(e.type==="ldu:list-navigate"&&e.url){this.navigateList(e.url);return}if(e.type==="ldu:preview-open"){this.preview.openFromFrame(e.url??"",t,e.anchorRect);return}if(e.type==="ldu:preview-dismiss"){this.preview.close();return}if(e.type==="ldu:topic-open"){let l=e.url?f(e.url,location.href):null;if(!l||!xe(l.url.href,s.url))return;this.openTopic(l.topicId,l.url.href,e.title||`\u4E3B\u9898 ${l.topicId}`,l.postNumber,i);return}let a=e.url?f(e.url):null,r=a?.topicId===s.topicId,o={...e.url?{url:e.url}:{},...e.title?{title:e.title}:{},...a?.postNumber?{postNumber:a.postNumber}:{},suspended:!1};this.tabStore.update(s.id,o,Date.now(),e.type==="ldu:frame-ready"||!!(e.title&&!r)),e.type==="ldu:frame-state"&&this.schedulePersist()}renderTabs(e=!0){let t=this.layout?.getTabStripElement();if(!t||!this.tabStore)return;let i=this.tabStore.getPrimaryTabs(),s=this.tabStore.getSecondaryTabs();this.layout.setSecondaryOpen(s.length>0),s.length>0?this.ensureSecondaryFrames():this.secondaryFrames&&(this.secondaryFrames.destroy(),this.secondaryFrames=null),Le(t,i,this.tabStore.getSession().activeTabId,{onActivate:d=>{let m=this.tabStore.activate(d,Date.now());m&&this.activateFrame(m,"primary")},onClose:d=>this.closeTab(d,"primary"),onContextMenu:(d,m,g)=>this.tabContextMenu.open(d,m,g,!1,"primary"),onReorder:(d,m,g)=>{this.tabStore.reorderInPane(d,m,g,Date.now())}},{colorizeTabs:this.settings.colorizeTabs,orientation:this.settings.tabPresentation,groupByCategory:this.settings.groupVerticalTabs});let a=this.layout.getSecondaryTabStripElement();a&&Le(a,s,this.tabStore.getSession().secondaryActiveTabId,{onActivate:d=>{let m=this.tabStore.activateSecondary(d,Date.now());m&&this.activateFrame(m,"secondary")},onClose:d=>this.closeTab(d,"secondary"),onContextMenu:(d,m,g)=>this.tabContextMenu.open(d,m,g,!0,"secondary"),onReorder:(d,m,g)=>{this.tabStore.reorderInPane(d,m,g,Date.now())}},{colorizeTabs:this.settings.colorizeTabs,orientation:this.settings.tabPresentation,groupByCategory:this.settings.groupVerticalTabs});let r=this.layout.getActionsElement();if(r&&!r.querySelector(".ldu-close-all")){let d=document.createElement("button");d.type="button",d.className="ldu-icon-button ldu-close-all",A(d,"close",18),d.title="\u5173\u95ED\u6240\u6709\u5E16\u5B50\u6807\u7B7E",d.setAttribute("aria-label","\u5173\u95ED\u6240\u6709\u5E16\u5B50\u6807\u7B7E"),d.addEventListener("click",()=>{for(let m of this.tabStore.getTabs())this.frames?.remove(m.id),this.secondaryFrames?.remove(m.id);this.tabStore.clear(Date.now()),this.disposeSplitRuntime()}),r.append(d)}let o=this.layout.getSecondaryActionsElement();if(o&&!o.querySelector(".ldu-close-secondary")){let d=document.createElement("button");d.type="button",d.className="ldu-icon-button ldu-close-secondary",A(d,"close",18),d.title="\u5173\u95ED\u7B2C\u4E8C\u9605\u8BFB\u533A",d.setAttribute("aria-label","\u5173\u95ED\u7B2C\u4E8C\u9605\u8BFB\u533A\u5E76\u5C06\u6807\u7B7E\u79FB\u56DE\u4E3B\u9605\u8BFB\u533A"),d.addEventListener("click",()=>this.closeSecondaryPanel()),o.append(d)}let l=this.layout.getContentElement()?.querySelector(".ldu-topic-empty");l&&(l.hidden=i.length>0);let u=this.layout.getSecondaryContentElement()?.querySelector(".ldu-topic-empty");if(u&&(u.hidden=s.length>0),!e)return;let h=this.tabStore.getActive();h&&this.activateFrame(h,"primary");let c=this.tabStore.getSecondaryActive();c&&this.activateFrame(c,"secondary")}closeTab(e,t){if((t==="secondary"?this.secondaryFrames:this.frames)?.remove(e),this.tabStore.close(e,Date.now(),!1),t==="primary"&&this.tabStore.getPrimaryTabs().length===0&&this.tabStore.getSecondaryTabs().length>0){this.closeSecondaryPanel();return}I(this.storage,this.tabStore.getSession()),this.renderTabs(),this.tabStore.getTabs().length===0&&this.disposeSplitRuntime()}moveTabToSecondary(e){if(this.tabStore.getSession().secondaryTabIds.includes(e)||!this.captureLiveFrameState(e,this.frames)||!this.layout.mount())return;let i=this.frames?.detach(e)??null;this.layout.setSecondaryOpen(!0),this.ensureSecondaryFrames();let s=this.tabStore.moveToSecondary(e,Date.now(),!1);s&&(i&&this.secondaryFrames&&this.secondaryFrames.adopt(s,i,Date.now()),I(this.storage,this.tabStore.getSession()),this.renderTabs())}closeSecondaryPanel(){let t=this.tabStore.getSecondaryTabs().flatMap(i=>{let s=this.captureLiveFrameState(i.id,this.secondaryFrames)??i,a=this.secondaryFrames?.detach(i.id);return a?[{tab:s,transfer:a}]:[]});this.tabStore.mergeSecondaryIntoPrimary(Date.now(),!1);for(let{tab:i,transfer:s}of t)this.frames?.adopt(i,s,Date.now());I(this.storage,this.tabStore.getSession()),this.renderTabs()}openTabInBrowser(e){let t=this.tabStore.get(e);if(!t)return;let i=document.createElement("a");i.href=t.url,i.target="_blank",i.rel="noopener noreferrer",i.click()}reloadTab(e){let i=this.tabStore.getSession().secondaryTabIds.includes(e)?this.secondaryFrames:this.frames,s=this.captureLiveFrameState(e,i);s&&(i?.getFrame(e)?i.reload(e):i?.prepare(s,Date.now()))}async copyTabLink(e){let t=this.tabStore.get(e);if(t)try{await navigator.clipboard.writeText(t.url);return}catch{let i=document.createElement("textarea");i.value=t.url,i.style.position="fixed",i.style.opacity="0",document.body.append(i),i.select(),document.execCommand("copy"),i.remove()}}bookmarkTab(e){let t=this.tabStore.getSession().secondaryTabIds.includes(e),i=this.tabStore.get(e);if(!i)return;let s=t?this.secondaryFrames:this.frames;s?.prepare(i,Date.now()),s?.sendCommand(e,{type:"ldu:bookmark",topicId:i.topicId})}closeOtherTabs(e){let t=this.tabStore.getSession().secondaryTabIds.includes(e),i=t?this.tabStore.getSecondaryTabs():this.tabStore.getPrimaryTabs();for(let s of i)s.id!==e&&(t?this.secondaryFrames:this.frames)?.remove(s.id);this.tabStore.closeOthersInPane(e,Date.now())}persistSession(){let e=this.tabStore?.getActive();e&&this.frames&&this.captureLiveFrameState(e.id,this.frames);let t=this.tabStore?.getSecondaryActive();t&&this.secondaryFrames&&this.captureLiveFrameState(t.id,this.secondaryFrames),this.tabStore&&I(this.storage,this.tabStore.getSession())}captureLiveFrameState(e,t){let i=this.tabStore.get(e),s=t?.getFrame(e);if(!i||!s?.contentWindow)return i;let a=i.url,r=i.title;try{let l=s.contentWindow.location.href;f(l,i.url)?.topicId===i.topicId&&(a=l);let u=s.contentDocument?.title?.trim();u&&(r=u)}catch{return i}let o=f(a,i.url);return this.tabStore.update(e,{url:a,title:r,...o?.postNumber?{postNumber:o.postNumber}:{},suspended:!1},Date.now(),!1),this.tabStore.get(e)??i}showActionToast(e,t){document.querySelector(".ldu-action-toast")?.remove();let i=document.createElement("div");i.className=`ldu-action-toast${t?" is-error":""}`,i.setAttribute("role",t?"alert":"status"),i.textContent=e,document.body.append(i),window.setTimeout(()=>i.remove(),2800)}disposeSplitRuntime(){this.finishListHandoff(),this.preview?.close(),this.frames?.destroy(),this.frames=null,this.secondaryFrames?.destroy(),this.secondaryFrames=null,this.tabContextMenu?.close(),this.listFrame?.destroy(),this.listFrame=null,this.layout?.destroy()}scheduleListHandoffFallback(){this.listHandoffTimer!==null&&window.clearTimeout(this.listHandoffTimer),this.listHandoffTimer=window.setTimeout(()=>{this.listHandoffTimer=null;let e=this.layout?.finishListHandoff()??null;e!==null&&this.listFrame?.restoreScroll(e)},Bt)}finishListHandoff(){return this.listHandoffTimer!==null&&window.clearTimeout(this.listHandoffTimer),this.listHandoffTimer=null,this.layout?.finishListHandoff()??null}handlePageHide(e){this.persistSession(),!e.persisted&&(this.settings.restoreSession&&this.tabStore?.getTabs().length>0&&Xe(this.storage,this.tabStore.getSession()),this.leaseTimer!==null&&window.clearInterval(this.leaseTimer),this.sessionMaintenanceTimer!==null&&window.clearInterval(this.sessionMaintenanceTimer),this.updateCheckTimer!==null&&window.clearTimeout(this.updateCheckTimer),this.leaseTimer=null,this.sessionMaintenanceTimer=null,this.updateCheckTimer=null,Ye(this.storage,this.sessionLease))}schedulePersist(){this.persistTimer!==null&&window.clearTimeout(this.persistTimer),this.persistTimer=window.setTimeout(()=>{this.persistTimer=null,this.persistSession()},500)}};var dt="ldu:extension-request",ct="ldu:extension-request-cancel";function $t(n=chrome.runtime){return e=>{let t=globalThis.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`,i=!1,s=!1,a={type:dt,requestId:t,method:e.method??"GET",url:e.url,headers:{...e.headers??{}},...typeof e.data=="string"?{body:e.data}:{},timeout:Math.max(0,e.timeout??3e4)};return n.sendMessage(a).then(r=>{if(i||s)return;i=!0;let o=r;if(!o?.ok){o?.error==="timeout"?e.ontimeout?.():e.onerror?.(o??new Error("Extension request failed"));return}e.onload?.(o)}).catch(r=>{i||s||(i=!0,e.onerror?.(r))}),{abort:()=>{i||s||(s=!0,i=!0,e.onabort?.(),n.sendMessage({type:ct,requestId:t}).catch(()=>{}))}}}}function ut(n=chrome.runtime){Object.defineProperty(globalThis,"GM_xmlhttpRequest",{configurable:!0,value:$t(n)})}ut();location.pathname.startsWith("/challenge")||lt({loadPreviewer:async()=>(await import(chrome.runtime.getURL("preview-runtime.js"))).installLinkHoverPreviewer,loadOwnerView:async()=>(await import(chrome.runtime.getURL("topic-tools-runtime.js"))).installOwnerView});})();
