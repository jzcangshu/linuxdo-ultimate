...
- **划词 Base64 工具**：选中帖子中的文字后，可从原生操作条打开可拖拽的 Base64 编码/解码窗口，自动带入当前选区。
- **界面优化**：可隐藏公告、分类徽章、话题标签和列表头像，也可减少动画与过渡效果。
- **自动过盾**：遇到社区错误弹窗或人机验证时自动尝试恢复原页面。
- **实用工具**：可显示 LDC 收入、检查插件更新，并在设置中开关“一键 Base64”。
...
4. 刷新 Linux Do，点击顶部导航栏中的齿轮按钮打开右侧设置抽屉；内容较多时可在抽屉正文内滚动。

### Firefox（火狐浏览器）

1. 打开 `about:debugging#/runtime/this-firefox`。
2. 点击“临时载入附加组件”，选择你在 release 中下载的压缩包。
3. 刷新 Linux Do，点击顶部导航栏中的齿轮按钮打开右侧设置抽屉。
