"use strict";(()=>{var v={schemaVersion:5,enabled:!0,layoutPreference:"auto",tabsEnabled:!0,tabPresentation:"horizontal",verticalTabsAutoCollapse:!0,groupVerticalTabs:!1,restoreSession:!1,colorizeTabs:!0,cleanModeEnabled:!0,minimalHidePosters:!0,minimalHideNotices:!0,minimalHideCategoryBadges:!0,minimalHideTags:!0,lowEndOptimizationEnabled:!1,previewEnabled:!1,creditEnabled:!0,previewClickMode:"double",maxLiveFrames:3,maxOpenTabs:50,paneSizes:{sidebar:216,listRatio:.35},dualPaneSizes:{sidebar:216,listRatio:.35}},$=1,ue="linuxdo-ultimate:settings",N="linuxdo-ultimate:session:",G="linuxdo-ultimate:session-id",M="linuxdo-ultimate:session-owner:",pe="linuxdo-ultimate:session-index",Y="linuxdo-ultimate:latest-session",W="linuxdo-ultimate:latest-session-candidate";function H(n){if(!n||typeof n!="object")return structuredClone(v);let e=n,t=e.schemaVersion===2||e.schemaVersion===3||e.schemaVersion===4||e.schemaVersion===v.schemaVersion,i=e.schemaVersion===3||e.schemaVersion===4||e.schemaVersion===v.schemaVersion?e.cleanModeEnabled!==!1:e.cleanModeEnabled===!0||e.hidePosters!==!1,s=e.schemaVersion===4||e.schemaVersion===v.schemaVersion,r=e.paneSizes&&typeof e.paneSizes=="object"?e.paneSizes:{},a=e.dualPaneSizes&&typeof e.dualPaneSizes=="object"?e.dualPaneSizes:{};return{...v,enabled:!0,layoutPreference:e.layoutPreference==="two"||e.layoutPreference==="three"?e.layoutPreference:"auto",tabsEnabled:e.tabsEnabled!==!1,tabPresentation:e.tabPresentation==="vertical"?"vertical":"horizontal",verticalTabsAutoCollapse:e.verticalTabsAutoCollapse!==!1,groupVerticalTabs:e.groupVerticalTabs===!0,restoreSession:t&&e.restoreSession===!0,colorizeTabs:e.colorizeTabs!==!1,cleanModeEnabled:i,minimalHidePosters:s?e.minimalHidePosters!==!1:!0,minimalHideNotices:s?e.minimalHideNotices!==!1:!0,minimalHideCategoryBadges:s?e.minimalHideCategoryBadges!==!1:!0,minimalHideTags:s?e.minimalHideTags!==!1:!0,lowEndOptimizationEnabled:e.lowEndOptimizationEnabled===!0,previewEnabled:e.previewEnabled===!0,creditEnabled:e.creditEnabled!==!1,previewClickMode:e.previewClickMode==="single"?"single":"double",maxLiveFrames:B(e.maxLiveFrames,1,10,v.maxLiveFrames),maxOpenTabs:B(e.maxOpenTabs,5,50,v.maxOpenTabs),paneSizes:{sidebar:B(r.sidebar,160,360,v.paneSizes.sidebar),listRatio:Fe(r.listRatio,v.paneSizes.listRatio)},dualPaneSizes:{sidebar:B(a.sidebar,160,360,v.dualPaneSizes.sidebar),listRatio:Fe(a.listRatio,v.dualPaneSizes.listRatio)}}}function B(n,e,t,i){return typeof n=="number"&&Number.isFinite(n)?Math.round(Math.min(t,Math.max(e,n))):i}function Fe(n,e){return typeof n=="number"&&Number.isFinite(n)?Math.min(.7,Math.max(.3,n)):e}var ze=50;function _e(n,e){if(!n||typeof n!="object")return{...e};let t=n;return{sidebar:K(t.sidebar,160,360,e.sidebar),listRatio:mt(t.listRatio,e.listRatio)}}function mt(n,e){return typeof n=="number"&&Number.isFinite(n)?Math.min(.7,Math.max(.3,n)):e}function K(n,e,t,i){return typeof n=="number"&&Number.isFinite(n)?Math.round(Math.min(t,Math.max(e,n))):i}function ht(n){if(!n||typeof n!="object")return null;let e=n;return typeof e.id!="string"||typeof e.topicId!="string"||typeof e.url!="string"?null:{id:e.id,topicId:e.topicId,url:e.url,title:typeof e.title=="string"&&e.title.trim()?e.title:`\u4E3B\u9898 ${e.topicId}`,...typeof e.postNumber=="number"&&Number.isFinite(e.postNumber)?{postNumber:Math.max(1,Math.floor(e.postNumber))}:{},suspended:e.suspended===!0,lastActiveAt:K(e.lastActiveAt,0,Number.MAX_SAFE_INTEGER,0)}}function Ne(n,e){if(n.length<=ze)return n;let t=new Set(n.filter(i=>i.id!==e).sort((i,s)=>i.lastActiveAt-s.lastActiveAt).slice(0,n.length-ze).map(i=>i.id));return n.filter(i=>!t.has(i.id))}function U(n,e,t){return{schemaVersion:$,sessionId:n,listUrl:e,listScrollY:0,layoutMode:"native",paneSizes:{...v.paneSizes},dualPaneSizes:{...v.dualPaneSizes},tabs:[],activeTabId:null,secondaryTabIds:[],secondaryActiveTabId:null,updatedAt:t}}function me(n,e){if(!n||typeof n!="object")return e;let t=n;if(t.schemaVersion!==$||typeof t.sessionId!="string")return e;let i=Array.isArray(t.tabs)?t.tabs.map(ht).filter(c=>c!==null):[],s=Ne(Array.from(new Map(i.map(c=>[c.topicId,c])).values()),typeof t.activeTabId=="string"?t.activeTabId:""),r=new Set(s.map(c=>c.id)),a=Array.isArray(t.secondaryTabIds)?[...new Set(t.secondaryTabIds.filter(c=>typeof c=="string"&&r.has(c)))]:[],o=new Set(a),l=s.filter(c=>!o.has(c.id)),u=l.some(c=>c.id===t.activeTabId)?t.activeTabId:l.at(-1)?.id??null,h=a.includes(t.secondaryActiveTabId??"")?t.secondaryActiveTabId:a.at(-1)??null;return{schemaVersion:$,sessionId:t.sessionId,listUrl:typeof t.listUrl=="string"&&t.listUrl?t.listUrl:e.listUrl,listScrollY:K(t.listScrollY,0,1e7,0),layoutMode:t.layoutMode==="two"||t.layoutMode==="three"?t.layoutMode:"native",paneSizes:_e(t.paneSizes,e.paneSizes),dualPaneSizes:_e(t.dualPaneSizes,e.dualPaneSizes),tabs:s,activeTabId:u,secondaryTabIds:a,secondaryActiveTabId:h,updatedAt:K(t.updatedAt,0,Number.MAX_SAFE_INTEGER,e.updatedAt)}}function he(n,e,t){let i=n.tabs.find(o=>o.topicId===e.topicId),s=i?{...i,...e,suspended:!1,lastActiveAt:t}:{id:`topic-${e.topicId}`,topicId:e.topicId,url:e.url,title:e.title||`\u4E3B\u9898 ${e.topicId}`,...e.postNumber?{postNumber:e.postNumber}:{},suspended:!1,lastActiveAt:t},r=Ne(i?n.tabs.map(o=>o.topicId===e.topicId?s:o):[...n.tabs,s],s.id),a=n.secondaryTabIds.includes(s.id);return{...n,tabs:r,activeTabId:a?n.activeTabId:s.id,secondaryActiveTabId:a?s.id:n.secondaryActiveTabId,updatedAt:t}}function Ue(n,e,t){let i=n.tabs.findIndex(h=>h.id===e);if(i<0)return n;let s=n.tabs.filter(h=>h.id!==e),r=n.secondaryTabIds.filter(h=>h!==e),a=new Set(r),o=s.filter(h=>!a.has(h.id)),l=n.activeTabId===e?o[Math.min(i,o.length-1)]?.id??o.at(-1)?.id??null:n.activeTabId,u=n.secondaryActiveTabId===e?r.at(-1)??null:n.secondaryActiveTabId;return{...n,tabs:s,activeTabId:l,secondaryTabIds:r,secondaryActiveTabId:u,updatedAt:t}}function gt(n,e){if(!n)return e;try{return JSON.parse(n)}catch{return e}}var j=class{backend=typeof GM_getValue=="function"&&typeof GM_setValue=="function"&&typeof GM_deleteValue=="function"?"userscript":"local";get(e,t){if(this.backend==="userscript")try{return GM_getValue(e,t)}catch{return t}try{return gt(window.localStorage.getItem(e),t)}catch{return t}}set(e,t){if(this.backend==="userscript"){try{GM_setValue(e,t)}catch{}return}try{window.localStorage.setItem(e,JSON.stringify(t))}catch{}}remove(e){if(this.backend==="userscript"){try{GM_deleteValue(e)}catch{}return}try{window.localStorage.removeItem(e)}catch{}}};function bt(n=window.sessionStorage){try{let e=n.getItem(G);if(e)return e;let t=globalThis.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`;return n.setItem(G,t),t}catch{return"ephemeral"}}function qe(n=window.performance){try{return n.getEntriesByType("navigation")[0]?.type==="reload"}catch{return!1}}var ft=5*6e4,vt=720*60*6e4,yt=8;function ge(n){let e=n.get(W,null);return Array.isArray(e)?e.filter(i=>!!(i&&typeof i=="object"&&typeof i.closedAt=="number"&&i.session&&typeof i.session.sessionId=="string")):[e,n.get(Y,null)].filter(i=>!!(i&&typeof i=="object"&&typeof i.sessionId=="string")).map(i=>({session:i,closedAt:i.updatedAt||0}))}function Ve(n,e){n.set(W,e),n.remove(Y)}function be(n){let e=n.get(pe,[]);return Array.isArray(e)?e.filter(t=>!!(t&&typeof t=="object"&&typeof t.sessionId=="string"&&typeof t.updatedAt=="number")):[]}function fe(n,e){n.set(pe,e)}function Be(n,e,t){let i=be(n).filter(s=>s.sessionId!==e);i.push({sessionId:e,updatedAt:t}),fe(n,i)}function $e(n,e=window.sessionStorage,t=Date.now(),i=!1){let s=bt(e),r=n.get(`${M}${s}`,null);if(!i&&r&&t>=r.updatedAt&&t-r.updatedAt<ft){s=De();try{e.setItem(G,s)}catch{}}let a={sessionId:s,ownerId:De()};return n.set(`${M}${s}`,{ownerId:a.ownerId,updatedAt:t}),a}function Ge(n,e,t=Date.now()){let i=n.get(`${M}${e.sessionId}`,null);i?.ownerId===e.ownerId&&(n.set(`${M}${e.sessionId}`,{...i,updatedAt:t}),Be(n,e.sessionId,t))}function Ye(n,e){n.get(`${M}${e.sessionId}`,null)?.ownerId===e.ownerId&&n.remove(`${M}${e.sessionId}`)}function De(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`}function We(n){return H(n.get(ue,v))}function ve(n,e){n.set(ue,H(e))}function Ke(n,e,t,i){let s=n.get(`${N}${e}`,null);return s==null?null:me(s,U(e,t,i))}function je(n,e,t,i){let s=ge(n).filter(a=>a.session.sessionId!==e).sort((a,o)=>a.closedAt-o.closedAt).at(-1);if(!s)return null;let r=me(s.session,U(e,t,i));return r.sessionId!==e&&wt(n,r.sessionId),D(n),r.tabs.length===0?null:{...r,sessionId:e}}function I(n,e){n.set(`${N}${e.sessionId}`,e),Be(n,e.sessionId,e.updatedAt)}function Xe(n,e,t=Date.now()){if(e.tabs.length===0)return;let i=ge(n).filter(s=>s.session.sessionId!==e.sessionId);i.push({session:e,closedAt:t}),Ve(n,i.sort((s,r)=>s.closedAt-r.closedAt).slice(-yt))}function Je(n,e){let t=ge(n).filter(i=>i.session.sessionId!==e);t.length>0?Ve(n,t):D(n)}function ye(n,e=Date.now()){let t=[];for(let i of be(n))e-i.updatedAt>=vt?(n.remove(`${N}${i.sessionId}`),n.remove(`${M}${i.sessionId}`)):t.push(i);fe(n,t)}function D(n){n.remove(W),n.remove(Y)}function wt(n,e){n.remove(`${N}${e}`),n.remove(`${M}${e}`),fe(n,be(n).filter(t=>t.sessionId!==e))}var St=new Set(["/","/latest","/new","/unseen","/hot","/top","/read","/posted","/bookmarks","/categories","/tags"]);function Tt(n){return n==="linux.do"||n.endsWith(".linux.do")?!0:globalThis.window?.__LDU_TEST_MODE__===!0&&(n==="localhost"||n==="127.0.0.1")}function f(n,e="https://linux.do/"){let t;try{t=new URL(n,e)}catch{return null}if(!Tt(t.hostname))return null;let i=t.pathname.split("/").filter(Boolean),s=i.findIndex(o=>o==="t"||o==="n");if(s<0)return null;let r=i.findIndex((o,l)=>l>s&&/^\d+$/.test(o));if(r<0)return null;let a=i[r+1]&&/^\d+$/.test(i[r+1])?Number(i[r+1]):void 0;return{url:t,topicId:i[r],...a?{postNumber:a}:{}}}function P(n,e="https://linux.do/"){let t;try{t=new URL(n,e)}catch{return"other"}return f(t.href)?"topic":t.pathname==="/chat"||t.pathname.startsWith("/chat/")?"chat":t.pathname==="/search"||t.pathname.startsWith("/search/")?"search":t.pathname.startsWith("/u/")?"user":St.has(t.pathname)||t.pathname.startsWith("/c/")||t.pathname.startsWith("/tag/")?"list":"other"}function we(n,e="https://linux.do/"){let t=P(n,e);return t==="list"||t==="search"}function Se(n,e){let t=f(n,e),i=f(e,e);return!!(t&&(!i||t.topicId!==i.topicId))}var Ee="linuxdo-ultimate:view:v1:";var Qe=`${Ee}session-id`,X=`${Ee}lock-index`;var xe=class{constructor(e){this.options=e;this.fetcher=e.fetcher??fetch.bind(globalThis),this.now=e.now??Date.now,this.timeoutMs=e.timeoutMs??8e3}fetcher;now;timeoutMs;memoryLocks=new Map;async track(e,t,i,s=!1){if(e.url.origin!=="https://linux.do")return{status:"skipped"};let r=this.claim(e,t,s);if(!r)return{status:"skipped"};if(this.options.beforeClaimConfirmation?.(),!this.owns(e,r))return{status:"skipped"};let a=[];try{let o=await this.sendPageview(e,i);if(a.push(o),o.confirmed)return this.complete(e,r,t,"confirmed"),{status:"confirmed",confirmedBy:"pageview"}}catch{a.push({ok:!1,confirmed:!1})}try{let o=await this.sendTopicJson(e);if(a.push(o),o.confirmed)return this.complete(e,r,t,"confirmed"),{status:"confirmed",confirmedBy:"topic-json"}}catch{a.push({ok:!1,confirmed:!1})}return a.some(o=>o.ok)?(this.complete(e,r,t,"accepted"),{status:"accepted"}):(this.clearIfOwned(e,r),{status:"failed"})}stateKey(e){return`${Ee}${e.url.hostname}:${e.topicId}`}readState(e){let t=this.stateKey(e);try{return JSON.parse(this.options.storage.getItem(t)??"null")??this.memoryLocks.get(t)??null}catch{return this.memoryLocks.get(t)??null}}claim(e,t,i){this.cleanupExpiredLocks();let s=this.readState(e);if(!i&&s?.expiresAt&&s.expiresAt>this.now())return null;let r=globalThis.crypto?.randomUUID?.()??`${this.now()}-${Math.random().toString(36).slice(2)}`;return this.writeState(this.stateKey(e),{status:"pending",token:r,source:t,expiresAt:this.now()+3e4}),this.owns(e,r)?r:null}complete(e,t,i,s){this.writeState(this.stateKey(e),{status:s,token:t,source:i,expiresAt:this.now()+288e5})}clearIfOwned(e,t){this.readState(e)?.token===t&&this.removeState(this.stateKey(e))}owns(e,t){return this.readState(e)?.token===t}writeState(e,t){this.memoryLocks.set(e,t);try{this.options.storage.setItem(e,JSON.stringify(t));let i=this.readLockIndex().filter(s=>s.key!==e);i.push({key:e,expiresAt:t.expiresAt}),this.options.storage.setItem(X,JSON.stringify(i))}catch{}}removeState(e){this.memoryLocks.delete(e);try{this.options.storage.removeItem(e),this.options.storage.setItem(X,JSON.stringify(this.readLockIndex().filter(t=>t.key!==e)))}catch{}}readLockIndex(){try{let e=JSON.parse(this.options.storage.getItem(X)??"[]");return Array.isArray(e)?e.filter(t=>!!(t&&typeof t=="object"&&typeof t.key=="string"&&typeof t.expiresAt=="number")):[]}catch{return[]}}cleanupExpiredLocks(){let e=this.now();for(let[s,r]of this.memoryLocks)r.expiresAt<=e&&this.memoryLocks.delete(s);let t=this.readLockIndex(),i=t.filter(s=>{if(s.expiresAt>e)return!0;try{this.options.storage.removeItem(s.key)}catch{}return!1});if(i.length!==t.length)try{this.options.storage.setItem(X,JSON.stringify(i))}catch{}}commonHeaders(){let e={Accept:"application/json, text/javascript, */*; q=0.01","X-Requested-With":"XMLHttpRequest","Discourse-Present":"true"},t=this.options.csrfToken();return t&&(e["X-CSRF-Token"]=t),e}async sendPageview(e,t){let i={...this.commonHeaders(),"Discourse-Track-View-Deferred":"true","Discourse-Track-View-Topic-Id":e.topicId,"Discourse-Track-View-Url":e.url.href,"Discourse-Track-View-Referrer":t,"Discourse-Track-View-Session-Id":this.options.trackingSessionId()},s=await this.fetchWithTimeout(`${e.url.origin}${this.basePath()}/pageview`,{method:"POST",credentials:"same-origin",cache:"no-store",keepalive:!0,headers:i});return this.readAttempt(s)}async sendTopicJson(e){let t=await this.fetchWithTimeout(`${e.url.origin}${this.basePath()}/t/${e.topicId}.json?track_visit=true&forceLoad=true`,{method:"GET",credentials:"same-origin",cache:"no-store",headers:{...this.commonHeaders(),"Discourse-Track-View":"true","Discourse-Track-View-Topic-Id":e.topicId}});return this.readAttempt(t)}basePath(){let e=this.options.basePath?.()??"";return e?`/${e.replace(/^\/+|\/+$/g,"")}`:""}readAttempt(e){let t=e.headers.get("x-discourse-trackview"),i=e.headers.get("x-discourse-browserpageview");return{ok:e.ok,confirmed:t==="1"||i==="1"}}async fetchWithTimeout(e,t){let i=new AbortController,s=globalThis.setTimeout(()=>i.abort(),this.timeoutMs);try{return await this.fetcher(e,{...t,signal:i.signal})}finally{globalThis.clearTimeout(s)}}};function J(){return new xe({storage:window.localStorage,csrfToken:()=>document.querySelector('meta[name="csrf-token"]')?.content??"",trackingSessionId:()=>xt(window.sessionStorage,document.querySelector('meta[name="discourse-track-view-session-id"]')?.content??""),basePath:()=>document.querySelector('meta[name="discourse-base-uri"]')?.content??""})}var Te="";function xt(n,e="",t=Et){if(e)return e;try{let i=n.getItem(Qe);if(i)return i;let s=t();return n.setItem(Qe,s),s}catch{return Te||(Te=t()),Te}}function Et(){return globalThis.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`}var O={ownerOnlyEnabled:!1,minimalHidePosters:!1,minimalHideNotices:!1,minimalHideCategoryBadges:!1,minimalHideTags:!1,lowEndOptimizationEnabled:!1};function R(n,e){let t=JSON.stringify(e);n.dataset.lduPageTools!==t&&(n.dataset.lduPageTools=t)}function Ze(n,e,t){q(n,"lduHidePosters",t.minimalHidePosters),q(n,"lduHideNotices",t.minimalHideNotices),q(n,"lduHideCategoryBadges",t.minimalHideCategoryBadges),q(n,"lduHideTags",t.minimalHideTags),q(n,"lduLowEnd",t.lowEndOptimizationEnabled&&Lt(e))}function F(n,e){return n.ownerOnlyEnabled===e.ownerOnlyEnabled&&n.minimalHidePosters===e.minimalHidePosters&&n.minimalHideNotices===e.minimalHideNotices&&n.minimalHideCategoryBadges===e.minimalHideCategoryBadges&&n.minimalHideTags===e.minimalHideTags&&n.lowEndOptimizationEnabled===e.lowEndOptimizationEnabled}function q(n,e,t){let i=String(t);n.dataset[e]!==i&&(n.dataset[e]=i)}function Lt(n){let e=n.hardwareConcurrency,t=n.deviceMemory;return Number.isFinite(e)&&e<=4||typeof t=="number"&&Number.isFinite(t)&&t<=4}var V=class{constructor(e,t,i,s){this.container=e;this.maxLiveFrames=t;this.onMessage=i;this.onSuspend=s;this.liveLimit=Math.max(1,t)}frames=new Map;liveLimit;previewConfig={enabled:!1,clickMode:"double"};pageToolsConfig={...O};activeTabId=null;setMaxLiveFrames(e){this.liveLimit=Math.max(1,Math.min(10,Math.floor(e))),this.suspendOverflow("")}setPreviewConfig(e){if(!kt(this.previewConfig,e)){this.previewConfig={...e};for(let t of this.frames.values())this.sendPreviewConfig(t.iframe)}}setPageToolsConfig(e){if(!F(this.pageToolsConfig,e)){this.pageToolsConfig={...e};for(let t of this.frames.values())R(t.iframe,this.pageToolsConfig),this.sendPageToolsConfig(t.iframe)}}activate(e,t){let i=this.activeTabId!==e.id,s=this.ensureRecord(e,t);if(i){for(let[r,a]of this.frames)this.setFrameActive(a,r===e.id);this.activeTabId=e.id}return this.suspendOverflow(e.id),s.iframe}prepare(e,t){let i=this.activeTabId&&this.frames.has(this.activeTabId)?this.activeTabId:"",s=this.ensureRecord(e,t);return e.id!==i&&this.setFrameActive(s,!1),this.suspendOverflow(i),s.iframe}ensureRecord(e,t){let i=this.frames.get(e.id);if(i){i.lastUsedAt=t,i.iframe.title=e.title;let s=new URL(e.url,document.baseURI).href;i.iframe.src!==s&&i.reportedUrl!==s&&(i.reportedUrl=null,i.loaded=!1,i.configSentForDocument=!1,i.iframe.src=s)}else{let s=document.createElement("iframe");s.className="ldu-topic-frame",s.name=`ldu-topic:${e.id}`,s.title=e.title,s.dataset.tabId=e.id,R(s,this.pageToolsConfig);let r=()=>{let a=this.frames.get(e.id);!a||a.iframe!==s||(a.loaded=!0,a.configSentForDocument=!1,this.sendLifecycleState(a),this.sendInitialConfigs(a),this.flushCommands(a),this.onMessage({type:"ldu:frame-ready",tabId:e.id,url:s.src},s))};s.addEventListener("load",r),s.src=e.url,i={iframe:s,lastUsedAt:t,reportedUrl:null,loaded:!1,softFrozen:!0,commands:[],loadListener:r,configSentForDocument:!1},this.frames.set(e.id,i),this.container.append(s)}return i}handleMessage(e){let t=e.data;if(!t||!["ldu:frame-state","ldu:frame-ready","ldu:frame-interaction","ldu:bookmark-result","ldu:preview-open","ldu:preview-dismiss","ldu:topic-open","ldu:list-navigate"].includes(t.type??"")||typeof t.tabId!="string")return;let i=this.frames.get(t.tabId);if(!(!i||e.source!==i.iframe.contentWindow)){if((t.type==="ldu:frame-state"||t.type==="ldu:frame-ready")&&t.url)try{i.reportedUrl=new URL(t.url,document.baseURI).href}catch{i.reportedUrl=null}t.type==="ldu:frame-ready"&&(i.loaded=!0,this.sendLifecycleState(i),this.sendInitialConfigs(i),this.flushCommands(i)),this.onMessage(t,i.iframe)}}remove(e){let t=this.frames.get(e);t&&(t.commands=[],t.iframe.removeEventListener("load",t.loadListener),t.iframe.remove(),this.frames.delete(e),this.activeTabId===e&&(this.activeTabId=null))}sendCommand(e,t){let i=this.frames.get(e);if(i){if(!i.loaded){i.commands.push(t);return}i.iframe.contentWindow?.postMessage(t,location.origin)}}getFrame(e){return this.frames.get(e)?.iframe??null}reload(e){let t=this.frames.get(e);if(!t)return!1;t.loaded=!1,t.reportedUrl=null,t.configSentForDocument=!1;try{t.iframe.contentWindow?.location.reload()}catch{t.iframe.src=t.iframe.src}return!0}detach(e){let t=this.frames.get(e);return t?(t.iframe.removeEventListener("load",t.loadListener),t.iframe.remove(),this.frames.delete(e),this.activeTabId===e&&(this.activeTabId=null),t):null}adopt(e,t,i){let s=t.iframe;s.name=`ldu-topic:${e.id}`,s.dataset.tabId=e.id,s.title=e.title,R(s,this.pageToolsConfig);let r=()=>{let l=this.frames.get(e.id);!l||l.iframe!==s||(l.loaded=!0,l.configSentForDocument=!1,this.sendInitialConfigs(l),this.flushCommands(l),this.onMessage({type:"ldu:frame-ready",tabId:e.id,url:s.src},s))};s.addEventListener("load",r);let a=new URL(e.url,document.baseURI).href;s.src!==a&&t.reportedUrl!==a&&(s.src=a);let o={...t,lastUsedAt:i,reportedUrl:null,loaded:!1,loadListener:r,configSentForDocument:!1};return this.frames.set(e.id,o),this.container.append(s),this.activate(e,i),s}destroy(){for(let e of this.frames.values())e.commands=[],e.iframe.removeEventListener("load",e.loadListener),e.iframe.remove();this.frames.clear(),this.activeTabId=null}sendPreviewConfig(e){e.contentWindow?.postMessage({type:"ldu:preview-config",...this.previewConfig},location.origin)}sendPageToolsConfig(e){e.contentWindow?.postMessage({type:"ldu:page-tools-config",...this.pageToolsConfig},location.origin)}sendInitialConfigs(e){e.configSentForDocument||(e.configSentForDocument=!0,this.sendPreviewConfig(e.iframe),this.sendPageToolsConfig(e.iframe))}setFrameActive(e,t){let i=String(!t);e.iframe.getAttribute("aria-hidden")!==i&&e.iframe.setAttribute("aria-hidden",i);let s=t?0:-1;e.iframe.tabIndex!==s&&(e.iframe.tabIndex=s);let r=!t;e.softFrozen!==r&&(e.softFrozen=r,e.loaded&&this.sendLifecycleState(e))}sendLifecycleState(e){e.iframe.contentWindow?.postMessage({type:"ldu:frame-lifecycle",active:!e.softFrozen},location.origin)}flushCommands(e){let t=e.commands.splice(0);for(let i of t)e.iframe.contentWindow?.postMessage(i,location.origin)}suspendOverflow(e){for(;this.frames.size>this.liveLimit;){let i=[...this.frames.entries()].filter(([a])=>a!==e).sort(([,a],[,o])=>a.lastUsedAt-o.lastUsedAt)[0];if(!i)return;let[s,r]=i;r.commands=[],r.iframe.removeEventListener("load",r.loadListener),r.iframe.remove(),this.frames.delete(s),this.activeTabId===s&&(this.activeTabId=null),this.onSuspend(s)}}};function kt(n,e){return n.enabled===e.enabled&&n.clickMode===e.clickMode}var Q=class{constructor(e,t,i){this.container=e;this.frameId=t;this.onMessage=i}iframe=null;reportedUrl="";frameConfig={enabled:!1,clickMode:"double",pageTools:{...O}};configSentForDocument=!1;restoreScrollY=0;restoreTimer=null;restoreDeadline=0;mount(e){if(!this.iframe){let s=document.createElement("iframe");s.className="ldu-list-frame",s.name=`ldu-list:${this.frameId}`,s.title="\u5E16\u5B50\u5217\u8868\u548C\u7AD9\u5185\u9875\u9762",s.dataset.frameId=this.frameId,R(s,this.frameConfig.pageTools),s.addEventListener("load",()=>{this.configSentForDocument=!1,this.sendInitialConfigs(s),this.onMessage({type:"ldu:list-ready",frameId:this.frameId,url:s.src},s)}),this.iframe=s,this.container.append(s)}let i=(this.resolveSameOrigin(e)??new URL("/",location.href)).href;return this.iframe.src!==i&&this.reportedUrl!==i&&(this.reportedUrl="",this.configSentForDocument=!1,this.iframe.src=i),this.iframe.src||(this.iframe.src=i),this.iframe}navigate(e){let t=this.resolveSameOrigin(e);if(!t)return;if(!this.iframe){this.mount(t.href);return}let i=t.href;this.iframe.src===i||this.reportedUrl===i||(this.reportedUrl="",this.configSentForDocument=!1,this.iframe.src=i)}restoreScroll(e){!this.iframe?.contentWindow||e<=0||(this.restoreScrollY=e,this.restoreDeadline=Date.now()+5e3,this.attemptScrollRestore())}getElement(){return this.iframe}setConfig(e){let t=this.frameConfig.enabled!==e.enabled||this.frameConfig.clickMode!==e.clickMode,i=e.pageTools?{...e.pageTools}:this.frameConfig.pageTools,s=!F(this.frameConfig.pageTools,i);this.frameConfig={...this.frameConfig,...e,pageTools:i},this.iframe&&(t&&this.sendPreviewConfig(this.iframe),s&&(R(this.iframe,this.frameConfig.pageTools),this.sendPageToolsConfig(this.iframe)))}handleMessage(e){let t=e.data;if(!(!t||!["ldu:list-ready","ldu:list-visual-ready","ldu:list-state","ldu:list-interaction","ldu:list-topic-open","ldu:list-navigate","ldu:list-preview-open","ldu:list-preview-dismiss"].includes(t.type??""))&&!(t.frameId!==this.frameId||!this.iframe||e.source!==this.iframe.contentWindow||e.origin!==location.origin)){if((t.type==="ldu:list-ready"||t.type==="ldu:list-visual-ready"||t.type==="ldu:list-state")&&t.url)try{this.reportedUrl=new URL(t.url,document.baseURI).href}catch{this.reportedUrl=""}t.type==="ldu:list-ready"&&this.sendInitialConfigs(this.iframe),this.onMessage(t,this.iframe)}}sendPreviewConfig(e){e.contentWindow?.postMessage({type:"ldu:preview-config",...this.frameConfig},location.origin)}sendPageToolsConfig(e){e.contentWindow?.postMessage({type:"ldu:page-tools-config",...this.frameConfig.pageTools},location.origin)}sendInitialConfigs(e){this.configSentForDocument||(this.configSentForDocument=!0,this.sendPreviewConfig(e),this.sendPageToolsConfig(e))}resolveSameOrigin(e){try{let t=new URL(e,document.baseURI);return t.origin===location.origin&&/^https?:$/.test(t.protocol)?t:null}catch{return null}}attemptScrollRestore(){let e=this.iframe,t=this.restoreScrollY;if(!(!e?.contentWindow||t<=0)){if(this.restoreTimer!==null&&window.clearTimeout(this.restoreTimer),e.contentWindow.scrollTo({top:t,behavior:"instant"}),Math.abs(e.contentWindow.scrollY-t)<=2||Date.now()>=this.restoreDeadline){this.restoreScrollY=0,this.restoreDeadline=0,this.restoreTimer=null;return}this.restoreTimer=window.setTimeout(()=>{this.restoreTimer=null,this.iframe===e&&this.attemptScrollRestore()},100)}}destroy(){this.restoreTimer!==null&&window.clearTimeout(this.restoreTimer),this.restoreTimer=null,this.restoreScrollY=0,this.restoreDeadline=0,this.iframe?.remove(),this.iframe=null,this.reportedUrl="",this.configSentForDocument=!1}};var Z=class{constructor(e,t,i){this.session=e;this.maxTabs=t;this.onChange=i}getSession(){return this.session}getTabs(){return this.session.tabs.map(e=>({...e}))}get(e){let t=this.session.tabs.find(i=>i.id===e);return t?{...t}:null}getPrimaryTabs(){let e=new Set(this.session.secondaryTabIds);return this.session.tabs.filter(t=>!e.has(t.id)).map(t=>({...t}))}getSecondaryTabs(){let e=new Map(this.session.tabs.map(t=>[t.id,t]));return this.session.secondaryTabIds.flatMap(t=>e.has(t)?[{...e.get(t)}]:[])}getActive(){return this.session.tabs.find(e=>e.id===this.session.activeTabId)??null}getSecondaryActive(){return this.session.tabs.find(e=>e.id===this.session.secondaryActiveTabId)??null}setSessionFields(e,t,i=!0){this.session={...this.session,...e,updatedAt:t},i&&this.emit()}open(e,t){if(this.session=he(this.session,e,t),this.session.tabs.length>this.maxTabs){let i=this.session.tabs.filter(a=>a.id!==this.session.activeTabId),s=this.session.tabs.length-this.maxTabs,r=new Set(i.slice(0,s).map(a=>a.id));this.session={...this.session,tabs:this.session.tabs.filter(a=>!r.has(a.id))}}return this.repairPanelOwnership(),this.emit(),this.getActive()}openSecondary(e,t){this.session=he(this.session,e,t);let i=this.session.tabs.find(s=>s.topicId===e.topicId);return this.session.secondaryTabIds.includes(i.id)||(this.session={...this.session,secondaryTabIds:[...this.session.secondaryTabIds,i.id],secondaryActiveTabId:i.id,activeTabId:this.session.activeTabId===i.id?this.getPrimaryTabs().find(s=>s.id!==i.id)?.id??null:this.session.activeTabId}),this.repairPanelOwnership(),this.emit(),{...i}}activate(e,t){return this.getPrimaryTabs().some(i=>i.id===e)?(this.session={...this.session,activeTabId:e,tabs:this.session.tabs.map(i=>i.id===e?{...i,lastActiveAt:t,suspended:!1}:i),updatedAt:t},this.emit(),this.getActive()):null}activateSecondary(e,t){return this.session.secondaryTabIds.includes(e)?(this.session={...this.session,secondaryActiveTabId:e,tabs:this.session.tabs.map(i=>i.id===e?{...i,lastActiveAt:t,suspended:!1}:i),updatedAt:t},this.emit(),this.getSecondaryActive()):null}moveToSecondary(e,t,i=!0){if(!this.session.tabs.some(o=>o.id===e))return null;if(this.session.secondaryTabIds.includes(e))return this.activateSecondary(e,t);let s=this.getPrimaryTabs(),r=s.findIndex(o=>o.id===e),a=s.filter(o=>o.id!==e);return this.session={...this.session,secondaryTabIds:[...this.session.secondaryTabIds,e],secondaryActiveTabId:e,activeTabId:this.session.activeTabId===e?a[Math.min(r,a.length-1)]?.id??null:this.session.activeTabId,tabs:this.session.tabs.map(o=>o.id===e?{...o,lastActiveAt:t,suspended:!1}:o),updatedAt:t},i&&this.emit(),this.getSecondaryActive()}mergeSecondaryIntoPrimary(e,t=!0){if(this.session.secondaryTabIds.length===0)return;let i=this.session.secondaryActiveTabId;this.session={...this.session,activeTabId:this.session.activeTabId??i,secondaryTabIds:[],secondaryActiveTabId:null,updatedAt:e},t&&this.emit()}closeOthersInPane(e,t){let i=this.session.secondaryTabIds.includes(e),r=(i?this.getSecondaryTabs():this.getPrimaryTabs()).filter(o=>o.id!==e).map(o=>o.id);if(r.length===0)return[];let a=new Set(r);return this.session={...this.session,tabs:this.session.tabs.filter(o=>!a.has(o.id)),activeTabId:i?this.session.activeTabId:e,secondaryTabIds:this.session.secondaryTabIds.filter(o=>!a.has(o)),secondaryActiveTabId:i?e:this.session.secondaryActiveTabId,updatedAt:t},this.emit(),r}reorderInPane(e,t,i,s){if(e===t)return!1;let r=this.session.secondaryTabIds.includes(e);if(r!==this.session.secondaryTabIds.includes(t))return!1;let a=(r?this.getSecondaryTabs():this.getPrimaryTabs()).map(m=>m.id),o=[...a],l=a.indexOf(e);if(l<0||!a.includes(t))return!1;a.splice(l,1);let u=a.indexOf(t);if(a.splice(u+(i==="after"?1:0),0,e),a.every((m,b)=>m===o[b]))return!1;let h=new Set(a),c=new Map(this.session.tabs.map(m=>[m.id,m])),d=0;return this.session={...this.session,tabs:this.session.tabs.map(m=>h.has(m.id)?c.get(a[d++]):m),secondaryTabIds:r?a:this.session.secondaryTabIds,updatedAt:s},this.emit(),!0}update(e,t,i,s=!0){this.session={...this.session,tabs:this.session.tabs.map(r=>r.id===e?{...r,...t,lastActiveAt:i}:r),updatedAt:i},s&&this.emit()}suspend(e,t){this.update(e,{suspended:!0},t)}close(e,t,i=!0){this.session=Ue(this.session,e,t),i&&this.emit()}clear(e){this.session.tabs.length!==0&&(this.session={...this.session,tabs:[],activeTabId:null,secondaryTabIds:[],secondaryActiveTabId:null,updatedAt:e},this.emit())}emit(){this.onChange?.(this.session)}repairPanelOwnership(){let e=new Set(this.session.tabs.map(r=>r.id)),t=this.session.secondaryTabIds.filter(r=>e.has(r)),i=new Set(t),s=this.session.tabs.filter(r=>!i.has(r.id));this.session={...this.session,secondaryTabIds:t,activeTabId:this.session.activeTabId&&s.some(r=>r.id===this.session.activeTabId)?this.session.activeTabId:s.at(-1)?.id??null,secondaryActiveTabId:this.session.secondaryActiveTabId&&t.includes(this.session.secondaryActiveTabId)?this.session.secondaryActiveTabId:t.at(-1)??null}}};var et=[["\u5F00\u53D1\u8C03\u4F18","rgb(50, 195, 195)"],["\u56FD\u4EA7\u66FF\u4EE3","rgb(209, 44, 37)"],["\u8D44\u6E90\u835F\u8403","rgb(18, 168, 157)"],["\u6587\u6863\u5171\u5EFA","rgb(156, 182, 196)"],["\u8DF3\u86A4\u5E02\u573A","rgb(237, 32, 123)"],["\u79EF\u5206\u4E50\u56ED","rgb(252, 202, 68)"],["\u975E\u6211\u83AB\u5C5E","rgb(168, 198, 254)"],["\u8BFB\u4E66\u6210\u8BD7","rgb(224, 217, 0)"],["\u626C\u5E06\u8D77\u822A","rgb(255, 152, 56)"],["\u524D\u6CBF\u5FEB\u8BAF","rgb(187, 143, 206)"],["\u7F51\u7EDC\u8BB0\u5FC6","rgb(247, 148, 29)"],["\u798F\u5229\u7F8A\u6BDB","rgb(228, 87, 53)"],["\u641E\u4E03\u637B\u4E09","rgb(58, 181, 74)"],["\u793E\u533A\u5B75\u5316","rgb(255, 187, 0)"],["\u866B\u6D1E\u5E7F\u573A","rgb(255, 0, 247)"],["\u8FD0\u8425\u53CD\u9988","rgb(128, 130, 129)"],["\u6DF1\u6D77\u5E7D\u57DF","rgb(69, 183, 209)"]];function Le(n){let e=n.replace(/\s+-\s+LINUX DO(?:\s.*)?$/i,""),t=e.lastIndexOf(" - "),i=e.slice(t<0?0:t+3).trim(),s=et.find(([r])=>i===r||i.startsWith(`${r} /`)||i.startsWith(`${r},`));return s?{name:s[0],color:s[1]}:null}var Mt={settings:'<path d="M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z"/><path d="M19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06-2.83 2.83-.06-.06a1.7 1.7 0 0 0-1.88-.34 1.7 1.7 0 0 0-1.03 1.56V21h-4v-.08A1.7 1.7 0 0 0 8.95 19.4a1.7 1.7 0 0 0-1.88.34l-.06.06-2.83-2.83.06-.06A1.7 1.7 0 0 0 4.6 15a1.7 1.7 0 0 0-1.56-1.03H3v-4h.08A1.7 1.7 0 0 0 4.6 8.95a1.7 1.7 0 0 0-.34-1.88l-.06-.06 2.83-2.83.06.06A1.7 1.7 0 0 0 8.95 4.6 1.7 1.7 0 0 0 9.98 3.04V3h4v.08A1.7 1.7 0 0 0 15 4.6a1.7 1.7 0 0 0 1.88-.34l.06-.06 2.83 2.83-.06.06a1.7 1.7 0 0 0-.34 1.88 1.7 1.7 0 0 0 1.56 1.03H21v4h-.08A1.7 1.7 0 0 0 19.4 15Z"/>',close:'<path d="M18 6 6 18M6 6l12 12"/>',split:'<rect x="3" y="4" width="7" height="16" rx="1.5"/><rect x="14" y="4" width="7" height="16" rx="1.5"/><path d="M12 9v6m-3-3h6"/>',external:'<path d="M15 4h5v5M20 4l-9 9"/><path d="M18 13v5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h5"/>',refresh:'<path d="M20 6v5h-5"/><path d="M19 11a7 7 0 1 0 1 5"/>',copy:'<rect x="8" y="8" width="11" height="11" rx="2"/><path d="M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"/>',bookmark:'<path d="M6 4.8A1.8 1.8 0 0 1 7.8 3h8.4A1.8 1.8 0 0 1 18 4.8V21l-6-4-6 4V4.8Z"/>',"bookmark-filled":'<path class="ldu-symbol-fill" d="M6 4.8A1.8 1.8 0 0 1 7.8 3h8.4A1.8 1.8 0 0 1 18 4.8V21l-6-4-6 4V4.8Z"/>',"close-others":'<rect x="3" y="5" width="13" height="12" rx="2"/><path d="M8 3h10a3 3 0 0 1 3 3v8"/><path d="m18 16 4 4m0-4-4 4"/>',list:'<path d="M9 6h11M9 12h11M9 18h11"/><path d="M4 6h.01M4 12h.01M4 18h.01"/>',"tab-list":'<path d="m4 6 5 6-5 6M11 6h9M11 12h9M11 18h9"/>',check:'<path d="m5 12 4 4L19 6"/>',maximize:'<path d="M8 3H3v5M16 3h5v5M8 21H3v-5M16 21h5v-5"/>',restore:'<path d="M9 9H4V4M15 9h5V4M9 15H4v5M15 15h5v5"/>',trash:'<path d="M4 7h16M9 7V4h6v3M7 7l1 14h8l1-14M10 11v6M14 11v6"/>',"thumbs-up":'<path d="M7 10v11M15 5.9 14 10h5.8a2 2 0 0 1 1.9 2.6l-2.3 7A2 2 0 0 1 17.5 21H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h2.8a2 2 0 0 0 1.8-1.1L12 2a3.1 3.1 0 0 1 3 3.9Z"/>',"thumbs-down":'<path d="M17 14V3M9 18.1 10 14H4.2a2 2 0 0 1-1.9-2.6l2.3-7A2 2 0 0 1 6.5 3H20a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-2.8a2 2 0 0 0-1.8 1.1L12 22a3.1 3.1 0 0 1-3-3.9Z"/>',github:'<path d="M15 22v-3.9c.04-1-.35-1.76-.8-2.2 2.6-.3 5.3-1.27 5.3-5.75A4.5 4.5 0 0 0 18.3 7c.12-.3.52-1.53-.12-3.18 0 0-.98-.31-3.2 1.2a11.1 11.1 0 0 0-5.83 0c-2.22-1.51-3.2-1.2-3.2-1.2C5.3 5.47 5.7 6.7 5.82 7a4.5 4.5 0 0 0-1.2 3.15c0 4.47 2.72 5.46 5.32 5.75-.34.3-.64.82-.75 1.59-.67.3-2.37.82-3.42-.98 0 0-.62-1.13-1.8-1.21M9 19c-2.25 1-2.5-1-3.5-1.5"/>',gift:'<rect x="3" y="8" width="18" height="4" rx="1"/><path d="M12 8v13M5 12v9h14v-9M7.5 8C6.1 8 5 7 5 5.7S6.1 3.5 7.5 3.5C9.6 3.5 12 8 12 8s2.4-4.5 4.5-4.5C17.9 3.5 19 4.4 19 5.7S17.9 8 16.5 8"/>'};function E(n,e=20){return`<svg class="ldu-symbol ldu-symbol-${n}" viewBox="0 0 24 24" width="${e}" height="${e}" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${Mt[n]}</svg>`}function C(n,e,t=20){n.innerHTML=E(e,t)}function tt(n,e,t=18){let i=n.createElement("span");return i.className="ldu-context-icon",i.innerHTML=E(e,t),i}var z=new WeakMap;function it(n){n.querySelectorAll(":scope > .ldu-tab-item[data-tab-id]").forEach(e=>{e.classList.remove("is-dragging","is-drop-before","is-drop-after"),e.setAttribute("aria-grabbed","false"),e.style.transform=""}),n.classList.remove("is-reordering")}function It(n){let e=document.createElement("div");e.className="ldu-tab-item",e.setAttribute("role","presentation"),e.setAttribute("aria-grabbed","false"),e.addEventListener("contextmenu",a=>{let o=e.dataset.tabId,l=z.get(n);!o||!l||(a.preventDefault(),a.stopPropagation(),l.callbacks.onContextMenu?.(o,a.clientX,a.clientY))}),e.addEventListener("auxclick",a=>{if(a.button!==1)return;let o=e.dataset.tabId,l=z.get(n);!o||!l||(a.preventDefault(),a.stopPropagation(),l.callbacks.onClose(o))});let t=document.createElement("button");t.type="button",t.className="ldu-tab-button",t.setAttribute("role","tab");let i=document.createElement("span");i.className="ldu-tab-glyph",C(i,"list",15);let s=document.createElement("span");s.className="ldu-tab-title",t.append(i,s),t.addEventListener("click",()=>{let a=e.dataset.tabId,o=z.get(n);a&&o&&o.callbacks.onActivate(a)}),t.addEventListener("keydown",a=>{let o=e.dataset.tabId,l=z.get(n);if(!o||!l)return;let u=[...n.querySelectorAll(":scope > .ldu-tab-item[data-tab-id]")],h=u.findIndex(_=>_.dataset.tabId===o);if(h<0)return;let c=n.classList.contains("is-vertical"),d=c?"ArrowUp":"ArrowLeft",m=c?"ArrowDown":"ArrowRight",b=h;if(a.key===d||a.key===m)a.preventDefault(),b=(h+(a.key===m?1:-1)+u.length)%u.length;else if(a.key==="Home"||a.key==="End")a.preventDefault(),b=a.key==="Home"?0:u.length-1;else if(a.key==="Delete"){a.preventDefault(),l.callbacks.onClose(o);return}else return;let L=u[b];L?.dataset.tabId&&(l.callbacks.onActivate(L.dataset.tabId),L.querySelector(".ldu-tab-button")?.focus())});let r=document.createElement("button");return r.type="button",r.className="ldu-tab-close",r.draggable=!1,C(r,"close",16),r.title="\u5173\u95ED\u5E16\u5B50\u6807\u7B7E",r.addEventListener("click",a=>{a.stopPropagation();let o=e.dataset.tabId,l=z.get(n);o&&l&&l.callbacks.onClose(o)}),e.append(t,r),e}function Pt(n,e,t,i){let s=e.id===t,r=e.title||`\u4E3B\u9898 ${e.topicId}`;n.dataset.tabId=e.id,n.draggable=!!i.onReorder,n.classList.toggle("is-active",s),n.title=`${e.title}
${e.url}`;let a=Le(e.title);n.dataset.categoryGroup=a?.name??"other",a?n.style.setProperty("--ldu-tab-category-color",a.color):n.style.removeProperty("--ldu-tab-category-color");let o=n.querySelector(".ldu-tab-button");o.querySelector(".ldu-tab-title").textContent=r,o.id=`ldu-tab-${e.id}`,o.setAttribute("aria-selected",String(s)),o.tabIndex=s?0:-1,o.setAttribute("aria-label",`\u6253\u5F00 ${r}`),n.querySelector(".ldu-tab-close")?.setAttribute("aria-label",`\u5173\u95ED ${r}`)}function Ct(n){let e=document.createElement("div");e.className="ldu-tab-group-header",e.dataset.groupKey=n,e.setAttribute("role","presentation");let t=document.createElement("span");t.className="ldu-tab-group-marker";let i=document.createElement("span");return i.className="ldu-tab-group-label",e.append(t,i),e}function ke(n,e,t,i,s={}){z.set(n,{tabs:e,callbacks:i}),it(n);let r=s.orientation==="vertical"?"vertical":"horizontal",a=r==="vertical"&&s.groupByCategory===!0;n.classList.toggle("is-vertical",r==="vertical"),n.classList.toggle("is-grouped",a),n.setAttribute("aria-orientation",r),n.classList.toggle("is-category-colors-enabled",s.colorizeTabs!==!1);let o=null,l=null,u=null,h=null,c=()=>{it(n),o=null,l=null,u=null,h=null},d=p=>{if(!o||!u)return;let g=u.find(y=>y.tabId===o);if(!g)return;let T=u.filter(y=>y.tabId!==o),w=T.filter(y=>p>=y.center).length;if(w===h)return;h=w;let x=w;for(let y of u){let k=0;x>g.index&&y.index>g.index&&y.index<=x?k=-g.shift:x<g.index&&y.index>=x&&y.index<g.index&&(k=g.shift),y.item.style.transform=k?r==="vertical"?`translate3d(0, ${k}px, 0)`:`translate3d(${k}px, 0, 0)`:"",y.item.classList.remove("is-drop-before","is-drop-after")}let S=x===0?T[0]:T[x-1];if(!S){l=null;return}let A=x===0?"before":"after";S.item.classList.add(A==="before"?"is-drop-before":"is-drop-after"),l={tabId:S.tabId,position:A}};n.ondragstart=p=>{if(!i.onReorder||!(p.target instanceof Element)||p.target.closest(".ldu-tab-close")){p.preventDefault();return}let g=p.target.closest(".ldu-tab-item[data-tab-id]");if(!g?.dataset.tabId)return;o=g.dataset.tabId;let T=g.dataset.categoryGroup,w=[...n.querySelectorAll(".ldu-tab-item[data-tab-id]")].filter(S=>!a||S.dataset.categoryGroup===T),x=w.map(S=>S.getBoundingClientRect());if(u=w.map((S,A)=>{let y=x[A],k=x[A+1],ce=x[A-1],Ae=r==="vertical"?y.top:y.left,ut=r==="vertical"?y.bottom:y.right,He=r==="vertical"?y.height:y.width,Re=k?r==="vertical"?k.top:k.left:null,Oe=ce?r==="vertical"?ce.bottom:ce.right:null,pt=Re!==null?Math.max(0,Re-ut):Oe!==null?Math.max(0,Ae-Oe):0;return{tabId:S.dataset.tabId,item:S,index:A,center:Ae+He/2,shift:He+pt}}),n.classList.add("is-reordering"),g.classList.add("is-dragging"),g.setAttribute("aria-grabbed","true"),p.dataTransfer?.setData("text/plain",o),p.dataTransfer){p.dataTransfer.effectAllowed="move";let S=g.getBoundingClientRect();p.dataTransfer.setDragImage(g,Math.max(0,p.clientX-S.left),Math.max(0,p.clientY-S.top))}},n.ondragover=p=>{if(!o||!u)return;p.preventDefault(),p.dataTransfer&&(p.dataTransfer.dropEffect="move");let g=r==="vertical"?p.clientY:p.clientX;Number.isFinite(g)&&d(g)},n.ondrop=p=>{if(!o||!u)return;p.preventDefault();let g=r==="vertical"?p.clientY:p.clientX;if(Number.isFinite(g)&&d(g),!l){c();return}let T=o,w=l;c(),i.onReorder?.(T,w.tabId,w.position)},n.ondragend=c;let m=new Set(e.map(p=>p.id)),b=new Map([...n.querySelectorAll(":scope > .ldu-tab-item[data-tab-id]")].map(p=>[p.dataset.tabId,p]));for(let[p,g]of b)m.has(p)||(g.remove(),b.delete(p));let L=e.map(p=>{let g=b.get(p.id)??It(n);return Pt(g,p,t,i),g}),_=new Map([...n.querySelectorAll(":scope > .ldu-tab-group-header[data-group-key]")].map(p=>[p.dataset.groupKey,p])),le=[];if(a){let p=new Map;e.forEach((g,T)=>{let w=Le(g.title),x=w?.name??"other",S=p.get(x)??{label:w?.name??"\u5176\u4ED6",color:w?.color??null,items:[]};S.items.push(L[T]),p.set(x,S)});for(let[g,T]of p){let w=_.get(g)??Ct(g);w.querySelector(".ldu-tab-group-label").textContent=`${T.label} ${T.items.length}`,T.color?w.style.setProperty("--ldu-tab-category-color",T.color):w.style.removeProperty("--ldu-tab-category-color"),le.push(w,...T.items),_.delete(g)}}else le.push(...L);_.forEach(p=>p.remove());let de=n.firstElementChild;for(let p of le)p!==de&&n.insertBefore(p,de),de=p.nextElementSibling}var st="linuxdo-ultimate-styles";var At=`
:root {
...
`;function ee(n=document){let e=n.getElementById(st);if(e instanceof HTMLStyleElement)return e;let t=n.createElement("style");return t.id=st,t.textContent=At,(n.head??n.documentElement).append(t),t}var Ht=1100,Rt=1680;function Ot(n,e){return e<Ht?"native":n==="two"||n==="three"?n:e>=Rt?"three":"two"}var te=class{constructor(e){this.options=e;this.preference=e.preference,this.paneSizes={...e.paneSizes},this.dualPaneSizes={...e.dualPaneSizes??e.paneSizes},this.tabPresentation=e.tabPresentation??"horizontal",this.verticalTabsAutoCollapse=e.verticalTabsAutoCollapse!==!1}shell=null;panel=null;content=null;secondaryPanel=null;secondaryContent=null;listContent=null;preference;paneSizes;dualPaneSizes;tabPresentation;verticalTabsAutoCollapse;open=!1;secondaryOpen=!1;listHandoff=null;headerResizeObserver=null;resizeListener=()=>this.apply();mount(){ee();let e=document.querySelector("#main-outlet-wrapper"),t=document.querySelector("#main-outlet");if(!e||!t)return!1;if(this.shell)this.shell.parentElement!==document.body&&document.body.append(this.shell);else if(this.shell=this.createShell(),document.body.append(this.shell),this.panel=this.shell.querySelector("#ldu-topic-panel"),this.content=this.panel?.querySelector(".ldu-topic-content")??null,this.secondaryPanel=this.shell.querySelector("#ldu-secondary-topic-panel"),this.secondaryContent=this.secondaryPanel?.querySelector(".ldu-topic-content")??null,this.listContent=this.shell.querySelector(".ldu-list-content"),window.addEventListener("resize",this.resizeListener,{passive:!0}),typeof ResizeObserver<"u"){let i=document.querySelector(".d-header");i&&(this.headerResizeObserver=new ResizeObserver(()=>this.apply()),this.headerResizeObserver.observe(i))}return this.apply(),!0}destroy(){this.finishListHandoff(),window.removeEventListener("resize",this.resizeListener),this.headerResizeObserver?.disconnect(),this.headerResizeObserver=null,this.shell?.remove(),this.shell=null,this.panel=null,this.content=null,this.secondaryPanel=null,this.secondaryContent=null,this.listContent=null,this.open=!1,this.secondaryOpen=!1,document.body.classList.remove("ldu-layout-active","ldu-layout-two","ldu-layout-three","ldu-secondary-open","ldu-tabs-vertical","ldu-vertical-tabs-static"),document.documentElement.classList.remove("ldu-layout-two-root")}setOpen(e){this.open=e,this.apply()}setSecondaryOpen(e){this.secondaryOpen=e,this.apply()}setPreference(e){this.preference=e,this.apply()}setTabPresentation(e,t=this.verticalTabsAutoCollapse){this.tabPresentation=e,this.verticalTabsAutoCollapse=t,this.apply()}setTabInteractionLocked(e,t){(t==="secondary"?this.secondaryPanel:this.panel)?.querySelector(".ldu-topic-toolbar")?.classList.toggle("is-interaction-locked",e)}setPaneSizes(e,t=this.dualPaneSizes){this.paneSizes={...e},this.dualPaneSizes={...t},this.apply()}getContentElement(){return this.content}getSecondaryContentElement(){return this.secondaryContent}getListContentElement(){return this.listContent}getShellElement(){return this.shell}beginListHandoff(e){if(this.listHandoff||!this.listContent)return!1;let t=document.querySelector("#main-outlet"),i=t?.parentElement;return!t||!i||i===this.listContent?!1:(this.listHandoff={outlet:t,parent:i,nextSibling:t.nextSibling,scrollY:Math.max(0,e)},this.listContent.classList.add("is-native-handoff"),this.listContent.prepend(t),this.listContent.scrollTop=this.listHandoff.scrollY,!0)}finishListHandoff(){let e=this.listHandoff;return e?(this.listHandoff=null,e.nextSibling?.parentNode===e.parent?e.parent.insertBefore(e.outlet,e.nextSibling):e.parent.append(e.outlet),this.listContent?.classList.remove("is-native-handoff"),this.listContent&&(this.listContent.scrollTop=0),e.scrollY):null}getTabStripElement(){return this.panel?.querySelector(".ldu-tab-strip")??null}getSecondaryTabStripElement(){return this.secondaryPanel?.querySelector(".ldu-tab-strip")??null}getActionsElement(){return this.panel?.querySelector(".ldu-topic-actions")??null}getSecondaryActionsElement(){return this.secondaryPanel?.querySelector(".ldu-topic-actions")??null}getPanelElement(){return this.panel}getSecondaryPanelElement(){return this.secondaryPanel}getMode(){return this.open?Ot(this.preference,window.innerWidth):"native"}apply(){if(!this.panel||!this.secondaryPanel||!this.shell)return;this.syncHeaderHeight();let e=this.getMode(),t=e!=="native";this.panel.hidden=!t,this.secondaryPanel.hidden=!t||!this.secondaryOpen,this.shell.hidden=!t,document.body.classList.toggle("ldu-layout-active",t),document.body.classList.toggle("ldu-layout-two",e==="two"),document.body.classList.toggle("ldu-layout-three",e==="three"),document.documentElement.classList.toggle("ldu-layout-two-root",e==="two"),document.body.classList.toggle("ldu-secondary-open",t&&this.secondaryOpen);let i=t&&this.tabPresentation==="vertical";document.body.classList.toggle("ldu-tabs-vertical",i),document.body.classList.toggle("ldu-vertical-tabs-static",i&&!this.verticalTabsAutoCollapse);let s=this.getActivePaneSizes();document.documentElement.style.setProperty("--ldu-sidebar-width",`${s.sidebar}px`),document.documentElement.style.setProperty("--ldu-topic-track",`${1-s.listRatio}fr`),document.documentElement.style.setProperty("--ldu-topic-split-track",`${(1-s.listRatio)/2}fr`),document.documentElement.style.setProperty("--ldu-list-track",`${s.listRatio}fr`),this.updateSeparatorValues()}createPanel(e=!1){let t=document.createElement("section");return t.id=e?"ldu-secondary-topic-panel":"ldu-topic-panel",t.className=e?"ldu-secondary-topic-panel":"",t.hidden=!0,t.setAttribute("aria-label",e?"\u7B2C\u4E8C\u5E16\u5B50\u9605\u8BFB\u533A":"\u5E16\u5B50\u9605\u8BFB\u533A"),t.innerHTML=`
    ...
    `,e||(this.bindResizeHandle(t.querySelector(".ldu-resize-before"),"before"),this.bindResizeHandle(t.querySelector(".ldu-resize-after"),"after")),t}createShell(){let e=document.createElement("div");e.id="ldu-layout-shell",e.hidden=!0,e.setAttribute("aria-label","Linux Do \u5206\u5C4F\u5DE5\u4F5C\u533A");let t=document.createElement("div");return t.className="ldu-list-content",t.setAttribute("aria-label","\u975E\u9605\u8BFB\u9875\u533A\u57DF"),e.append(t,this.createPanel(),this.createPanel(!0)),e}bindResizeHandle(e,t){e instanceof HTMLElement&&(e.setAttribute("role","separator"),e.setAttribute("aria-orientation","vertical"),e.tabIndex=0,e.addEventListener("keydown",i=>{if(!(i instanceof KeyboardEvent)||!["ArrowLeft","ArrowRight","Home","End"].includes(i.key))return;i.preventDefault();let s=i.key==="ArrowLeft"?-1:i.key==="ArrowRight"?1:0,r=this.getMode(),a=this.secondaryOpen?"dual":"single",o=this.getActivePaneSizes();if(t==="before"&&r==="three"&&document.body.classList.contains("has-sidebar-page"))o.sidebar=i.key==="Home"?160:i.key==="End"?360:Math.min(360,Math.max(160,o.sidebar+s*12));else if(t==="after"&&r==="three"||t==="before"&&r==="two"){let l=r==="three"?-s:s;o.listRatio=i.key==="Home"?.3:i.key==="End"?.7:Me(o.listRatio+l*.02)}else return;this.apply(),this.options.onPaneSizesChange?.({...o},a)}),e.addEventListener("pointerdown",i=>{if(!(i instanceof PointerEvent)||i.button!==0)return;let s=i.clientX,r=this.secondaryOpen?"dual":"single",a=this.getActivePaneSizes(),o={...a};e.setPointerCapture(i.pointerId);let l=h=>{let c=h.clientX-s,d=this.getMode(),m=this.panel?.parentElement,b=Math.max(1,(m?.clientWidth??window.innerWidth)-a.sidebar);t==="after"&&d==="three"?a.listRatio=Me(o.listRatio-c/b):t==="before"&&d==="two"?a.listRatio=Me(o.listRatio+c/b):t==="before"&&d==="three"&&document.body.classList.contains("has-sidebar-page")&&(a.sidebar=Math.round(Math.min(360,Math.max(160,o.sidebar+c)))),this.apply()},u=()=>{e.removeEventListener("pointermove",l),e.removeEventListener("pointerup",u),e.removeEventListener("pointercancel",u),this.options.onPaneSizesChange?.({...a},r)};e.addEventListener("pointermove",l),e.addEventListener("pointerup",u),e.addEventListener("pointercancel",u)}))}updateSeparatorValues(){if(!this.panel)return;let e=this.getMode(),t=this.getActivePaneSizes(),i=this.panel.querySelector(".ldu-resize-before"),s=this.panel.querySelector(".ldu-resize-after"),r=(a,o,l,u)=>{a&&(a.setAttribute("aria-valuemin",String(l)),a.setAttribute("aria-valuemax",String(u)),a.setAttribute("aria-valuenow",String(o)))};e==="three"&&document.body.classList.contains("has-sidebar-page")?r(i,t.sidebar,160,360):r(i,Math.round(t.listRatio*100),30,70),r(s,Math.round(t.listRatio*100),30,70)}syncHeaderHeight(){let e=document.querySelector(".d-header");if(!e)return;let t=Math.ceil(e.getBoundingClientRect().height);t>0&&document.documentElement.style.setProperty("--ldu-header-height",`${t}px`)}getActivePaneSizes(){return this.secondaryOpen?this.dualPaneSizes:this.paneSizes}};function Me(n){return Math.round(Math.min(.7,Math.max(.3,n))*1e3)/1e3}var nt="https://raw.githubusercontent.com/jzcangshu/linuxdo-ultimate/main/updates/latest.json",rt="linuxdo-ultimate:update-cache",at="linuxdo-ultimate:update-attempt";function Ft(n,e){let t=r=>{let a=r.trim().replace(/^v/i,"").match(/^(\d+)\.(\d+)\.(\d+)(?:[-+].*)?$/);return a?[Number(a[1]),Number(a[2]),Number(a[3])]:null},i=t(n),s=t(e);if(!i||!s)return 0;for(let r=0;r<i.length;r+=1){let a=i[r]??0,o=s[r]??0;if(a!==o)return a>o?1:-1}return 0}function zt(n){if(!n||typeof n!="object")throw new Error("\u66F4\u65B0\u6E05\u5355\u683C\u5F0F\u65E0\u6548");let e=n,t=typeof e.version=="string"?e.version:"",i=typeof e.publishedAt=="string"?e.publishedAt:"",s=typeof e.releaseUrl=="string"?e.releaseUrl:"",r=Array.isArray(e.changelog)?e.changelog.filter(o=>typeof o=="string").slice(0,8):[];if(e.schemaVersion!==1||!/^\d+\.\d+\.\d+(?:[-+].*)?$/.test(t)||!i||r.length===0)throw new Error("\u66F4\u65B0\u6E05\u5355\u5185\u5BB9\u4E0D\u5B8C\u6574");let a=new URL(s);if(a.protocol!=="https:"||a.hostname!=="github.com"||a.pathname!=="/jzcangshu/linuxdo-ultimate/releases/tag/v"+t.replace(/^v/i,""))throw new Error("\u66F4\u65B0\u6E05\u5355\u53D1\u5E03\u5730\u5740\u65E0\u6548");return{schemaVersion:1,version:t,publishedAt:i,releaseUrl:s,changelog:r}}function _t(n){if(typeof GM_xmlhttpRequest=="function")return GM_xmlhttpRequest(n);let e=!1;return fetch(n.url,{headers:n.headers,signal:AbortSignal.timeout(n.timeout)}).then(async t=>{e||n.onload({status:t.status,responseText:await t.text()})}).catch(t=>{e||n.onerror(t)}),{abort:()=>{e=!0}}}function Ie(){try{if(typeof chrome<"u"){let n=chrome.runtime?.getManifest?.().version;if(n)return n}}catch{}try{if(typeof GM_info<"u"&&GM_info.script.version)return GM_info.script.version}catch{}return"0.0.0"}var ie=class{constructor(e,t=_t,i=Ie()){this.storage=e;this.request=t;this.currentVersion=i}async check(e=!1){let t=Date.now(),i=await Promise.resolve(this.storage.get(rt,null));if(!e&&i?.checkedByVersion===this.currentVersion&&t-i.checkedAt<864e5)return this.compare(i.manifest);let s=await Promise.resolve(this.storage.get(at,0));return!e&&s>0&&t-s<36e5?i?this.compare(i.manifest):{status:"current",version:this.currentVersion}:(this.storage.set(at,t),new Promise(r=>{let a=o=>r({status:"error",message:o});this.request({method:"GET",url:e?`${nt}?t=${t}`:nt,headers:{Accept:"application/json"},timeout:1e4,onload:o=>{if(o.status<200||o.status>=300){a(`HTTP ${o.status}`);return}try{let l=zt(JSON.parse(o.responseText));this.storage.set(rt,{checkedAt:t,checkedByVersion:this.currentVersion,manifest:l}),r(this.compare(l))}catch(l){a(l instanceof Error?l.message:"\u66F4\u65B0\u6E05\u5355\u89E3\u6790\u5931\u8D25")}},onerror:()=>a("\u7F51\u7EDC\u8FDE\u63A5\u5931\u8D25"),ontimeout:()=>a("\u8BF7\u6C42\u8D85\u65F6")})}))}compare(e){return Ft(e.version,this.currentVersion)>0?{status:"available",manifest:e}:{status:"current",version:this.currentVersion}}};var se=class{constructor(e,t,i){this.host=e;this.settings=t;this.callbacks=i}panel=null;toggleButton=null;updateStatusTimer=null;mount(){if(this.panel)return;let e=document.createElement("button");e.type="button",e.className="ldu-icon-button btn-flat no-text",C(e,"settings",20),e.title="\u5E03\u5C40\u4E0E\u529F\u80FD\u8BBE\u7F6E",e.setAttribute("aria-label","\u5E03\u5C40\u4E0E\u529F\u80FD\u8BBE\u7F6E"),e.setAttribute("aria-controls","ldu-settings-panel"),e.setAttribute("aria-expanded","false"),e.addEventListener("click",()=>{this.panel&&this.setPanelOpen(this.panel.hidden)}),this.toggleButton=e,this.host.append(e);let t=document.createElement("div");t.id="ldu-settings-panel",t.className="ldu-settings-panel",t.hidden=!0,t.setAttribute("role","dialog"),t.setAttribute("aria-label","\u5E03\u5C40\u4E0E\u529F\u80FD\u8BBE\u7F6E"),t.innerHTML=`
      <div class="dc-modal">
